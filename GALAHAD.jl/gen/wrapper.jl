...
function main(name::String="all"; optimized::Bool=true)
  ...
  (name == "all" || name == "expo")     && wrapper("expo", ["$galahad/galahad_expo.h"], optimized, run_sif=true, run_qplib=false, forthcoming=true)
  ...
  (name == "all" || name == "nrek")     && wrapper("nrek", ["$galahad/galahad_nrek.h"], optimized, run_sif=true, run_qplib=false)
  ...
  (name == "all" || name == "slblt")    && wrapper("slblt", ["$galahad/galahad_slblt.h"], optimized, run_sif=false, run_qplib=false)
  ...
  (name == "all" || name == "trek")     && wrapper("trek", ["$galahad/galahad_trek.h"], optimized, run_sif=true, run_qplib=false)
