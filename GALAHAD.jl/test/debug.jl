...
# Derived types
global data = Ref{Ptr{Cvoid}}()
global control = Ref{ccqp_control_type{T,INT}}()
global inform = Ref{ccqp_inform_type{T,INT}}()
...
for d in 1:7
  ...
  global control = @reset control[].print_level = INT(1)
