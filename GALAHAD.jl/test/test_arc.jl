...
function test_arc(::Type{T}, ::Type{INT}; mode::String="reverse", sls::String="sytr", dls::String="potr") where {T,INT}
  ...
  # Set user data
  userdata = userdata_arc{T}(4, fun, grad, hess, hessprod, prec)
  userdata_diag = userdata_arc{T}(4, fun_diag, grad_diag, hess_diag, hessprod, prec)
  userdata_dense = userdata_arc{T}(4, fun, grad, hess_dense, hessprod, prec)
  ...
  if mode == "direct"
    ...
    for d in 1:5
      ...
      if d == 1
        ...
        arc_solve_with_mat(T, INT, data, userdata, status, n, x, g, ne, callback_f, callback_g, callback_h, callback_prec)
      end
      ...
      if d == 3
        ...
        arc_solve_with_mat(T, INT, data, userdata_dense, status, n, x, g, ne_dense, callback_f, callback_g, callback_h, callback_prec)
      end
      ...
      if d == 4
        ...
        arc_solve_with_mat(T, INT, data, userdata_diag, status, n, x, g, n, callback_f, callback_g, callback_h, callback_prec)
      end
      ...
      if d == 5
        ...
        arc_solve_without_mat(T, INT, data, userdata, status, n, x, g, callback_f, callback_g, callback_hprod, callback_prec)
      end
