...
function test_trb(::Type{T}, ::Type{INT}; mode::String="reverse", sls::String="sytr", dls::String="potr") where {T,INT}
  ...
  # Set user data
  userdata = userdata_trb{T}(4, fun, grad, hess, hessprod, shessprod, prec)
  userdata_diag = userdata_trb{T}(4, fun_diag, grad_diag, hess_diag, hessprod, shessprod, prec)
  userdata_dense = userdata_trb{T}(4, fun, grad, hess_dense, hessprod, shessprod, prec)
  ...
  if mode == "direct"
    ...
    for d in 1:5
      ...
      if d == 1
        ...
        trb_solve_with_mat(T, INT, data, userdata, status, n, x_l, x_u, x, g, ne, callback_f, callback_g, callback_h, callback_prec)
      end
      ...
      if d == 3
        ...
        trb_solve_with_mat(T, INT, data, userdata_dense, status, n, x_l, x_u, x, g, ne_dense, callback_f, callback_g, callback_h, callback_prec)
      end
      ...
      if d == 4
        ...
        trb_solve_with_mat(T, INT, data, userdata_diag, status, n, x_l, x_u, x, g, n, callback_f, callback_g, callback_h, callback_prec)
      end
      ...
      if d == 5
        ...
        trb_solve_without_mat(T, INT, data, userdata, status, n, x_l, x_u, x, g, callback_f, callback_g, callback_hprod, callback_shprod, callback_prec)
      end
