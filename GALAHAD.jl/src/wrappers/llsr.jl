...
function llsr_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.llsr_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                   control::Ptr{llsr_control_type{Float32,
                                                                                  Int64}},
...
function llsr_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.llsr_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{llsr_control_type{Float64,
                                                                                Int64}},
                                                 status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function llsr_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.llsr_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                      control::Ptr{llsr_control_type{Float128,
                                                                                     Int64}},
                                                      status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function llsr_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.llsr_read_specfile_s_64(control::Ptr{llsr_control_type{Float32,
                                                                                     Int64}},
                                                      specfile::Ptr{Cchar})::Cvoid
end
...
function llsr_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.llsr_read_specfile_64(control::Ptr{llsr_control_type{Float64,
                                                                                   Int64}},
                                                    specfile::Ptr{Cchar})::Cvoid
end
...
function llsr_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.llsr_read_specfile_q_64(control::Ptr{llsr_control_type{Float128,
                                                                                        Int64}},
                                                         specfile::Ptr{Cchar})::Cvoid
end
...
function llsr_import(::Type{Float32}, ::Type{Int32}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
...
function llsr_import(::Type{Float32}, ::Type{Int64}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_single_64.llsr_import_s_64(control::Ptr{llsr_control_type{Float32,
                                                                              Int64}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int64}, m::Int64,
                                               n::Int64, A_type::Ptr{Cchar},
                                               A_ne::Int64, A_row::Ptr{Int64},
                                               A_col::Ptr{Int64},
                                               A_ptr::Ptr{Int64})::Cvoid
end

function llsr_import(::Type{Float64}, ::Type{Int32}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
...
function llsr_import(::Type{Float64}, ::Type{Int64}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_double_64.llsr_import_64(control::Ptr{llsr_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64}, m::Int64,
                                             n::Int64, A_type::Ptr{Cchar},
...
function llsr_import(::Type{Float128}, ::Type{Int32}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_quadruple.llsr_import_q(control::Ptr{llsr_control_type{Float128,
                                                                           Int32}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int32}, m::Int32,
                                            n::Int32, A_type::Ptr{Cchar},
                                            A_ne::Int32, A_row::Ptr{Int32},
                                            A_col::Ptr{Int32},
                                            A_ptr::Ptr{Int32})::Cvoid
end

function llsr_import(::Type{Float128}, ::Type{Int64}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_quadruple_64.llsr_import_q_64(control::Ptr{llsr_control_type{Float128,
                                                                                 Int64}},
                                                  data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64}, m::Int64,
                                                  n::Int64, A_type::Ptr{Cchar},
...
function llsr_import_scaling(::Type{Float32}, ::Type{Int32}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
...
function llsr_import_scaling(::Type{Float32}, ::Type{Int64}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_single_64.llsr_import_scaling_s_64(control::Ptr{llsr_control_type{Float32,
                                                                                      Int64}},
                                                       data::Ptr{Ptr{Cvoid}},
                                                       status::Ptr{Int64},
                                                       n::Int64,
...
function llsr_import_scaling(::Type{Float64}, ::Type{Int32}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_double.llsr_import_scaling(control::Ptr{llsr_control_type{Float64,
                                                                              Int32}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32}, n::Int32,
                                               S_type::Ptr{Cchar}, S_ne::Int32,
                                               S_row::Ptr{Int32},
                                               S_col::Ptr{Int32},
                                               S_ptr::Ptr{Int32})::Cvoid
end

function llsr_import_scaling(::Type{Float64}, ::Type{Int64}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_double_64.llsr_import_scaling_64(control::Ptr{llsr_control_type{Float64,
                                                                                    Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64},
                                                     n::Int64,
...
function llsr_import_scaling(::Type{Float128}, ::Type{Int32}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
...
function llsr_import_scaling(::Type{Float128}, ::Type{Int64}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_quadruple_64.llsr_import_scaling_q_64(control::Ptr{llsr_control_type{Float128,
                                                                                         Int64}},
                                                          data::Ptr{Ptr{Cvoid}},
                                                          status::Ptr{Int64},
                                                          n::Int64,
...
function llsr_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function llsr_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_single_64.llsr_reset_control_s_64(control::Ptr{llsr_control_type{Float32,
                                                                                     Int64}},
                                                      data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64})::Cvoid
end

function llsr_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
...
function llsr_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_double_64.llsr_reset_control_64(control::Ptr{llsr_control_type{Float64,
                                                                                   Int64}},
                                                    data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64})::Cvoid
end

function llsr_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function llsr_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_quadruple_64.llsr_reset_control_q_64(control::Ptr{llsr_control_type{Float128,
                                                                                        Int64}},
                                                         data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64})::Cvoid
end
...
function llsr_solve_problem(::Type{Float32}, ::Type{Int32}, data, status, m, n,
                            power, weight, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_single.llsr_solve_problem_s(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int32}, m::Int32,
                                                n::Int32, power::Float32,
...
function llsr_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, m, n,
                            power, weight, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_single_64.llsr_solve_problem_s_64(data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64},
                                                      m::Int64, n::Int64,
                                                      power::Float32,
                                                      weight::Float32,
...
function llsr_solve_problem(::Type{Float64}, ::Type{Int32}, data, status, m, n,
                            power, weight, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_double.llsr_solve_problem(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, m::Int32,
                                              n::Int32, power::Float64,
...
function llsr_solve_problem(::Type{Float64}, ::Type{Int64}, data, status, m, n,
                            power, weight, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_double_64.llsr_solve_problem_64(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    m::Int64, n::Int64,
                                                    power::Float64,
                                                    weight::Float64,
...
function llsr_solve_problem(::Type{Float128}, ::Type{Int32}, data, status, m, n,
                            power, weight, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_quadruple.llsr_solve_problem_q(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int32}, m::Int32,
...
function llsr_solve_problem(::Type{Float128}, ::Type{Int64}, data, status, m, n,
                            power, weight, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_quadruple_64.llsr_solve_problem_q_64(data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64},
                                                         m::Int64, n::Int64,
                                                         power::Cfloat128,
                                                         weight::Cfloat128,
...
function llsr_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.llsr_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                    inform::Ptr{llsr_inform_type{Float32,
                                                                                 Int64}},
                                                    status::Ptr{Int64})::Cvoid
end
...
function llsr_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.llsr_information_64(data::Ptr{Ptr{Cvoid}},
                                                  inform::Ptr{llsr_inform_type{Float64,
                                                                               Int64}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function llsr_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.llsr_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                       inform::Ptr{llsr_inform_type{Float128,
                                                                                    Int64}},
                                                       status::Ptr{Int64})::Cvoid
end
...
function llsr_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.llsr_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{llsr_control_type{Float32,
                                                                                 Int64}},
                                                  inform::Ptr{llsr_inform_type{Float32,
                                                                               Int64}})::Cvoid
...
function llsr_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.llsr_terminate_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{llsr_control_type{Float64,
                                                                               Int64}},
                                                inform::Ptr{llsr_inform_type{Float64,
                                                                             Int64}})::Cvoid
...
function llsr_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.llsr_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{llsr_control_type{Float128,
                                                                                    Int64}},
                                                     inform::Ptr{llsr_inform_type{Float128,
                                                                                  Int64}})::Cvoid
