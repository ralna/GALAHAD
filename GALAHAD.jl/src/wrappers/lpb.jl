...
function lpb_read_specfile(::Type{Float32}, ::Type{Int32}, control, specfile)
  @ccall libgalahad_single.lpb_read_specfile_s(control::Ptr{lpb_control_type{Float32,Int32}},
...
function lpb_import(::Type{Float32}, ::Type{Int32}, control, data, status, n, m, A_type,
  ...
  @ccall libgalahad_single.lpb_import_s(control::Ptr{lpb_control_type{Float32,Int32}},
...
function lpb_import(::Type{Float32}, ::Type{Int64}, control, data, status, n, m, A_type,
                    A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_single_64.lpb_import_s_64(control::Ptr{lpb_control_type{Float32,Int64}},
...
function lpb_import(::Type{Float64}, ::Type{Int64}, control, data, status, n, m, A_type,
                    A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_double_64.lpb_import_64(control::Ptr{lpb_control_type{Float64,Int64}},
                                            data::Ptr{Ptr{Cvoid}}, status::Ptr{Int64},
                                            n::Int64, m::Int64, A_type::Ptr{Cchar},
                                            A_ne::Int64, A_row::Ptr{Int64},
                                            A_col::Ptr{Int64}, A_ptr::Ptr{Int64})::Cvoid
...
function lpb_import(::Type{Float128}, ::Type{Int32}, control, data, status, n, m, A_type,
                    A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_quadruple.lpb_import_q(control::Ptr{lpb_control_type{Float128,Int32}},
...
function lpb_reset_control(::Type{Float32}, ::Type{Int32}, control, data, status)
  @ccall libgalahad_single.lpb_reset_control_s(control::Ptr{lpb_control_type{Float32,Int32}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32})::Cvoid
end
...
function lpb_solve_lp(::Type{Float32}, ::Type{Int32}, data, status, n, m, g, f, a_ne, A_val,
  ...
  @ccall libgalahad_single.lpb_solve_lp_s(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
...
function lpb_solve_lp(::Type{Float32}, ::Type{Int64}, data, status, n, m, g, f, a_ne, A_val,
                      c_l, c_u, x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_single_64.lpb_solve_lp_s_64(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int64},
...
function lpb_solve_lp(::Type{Float64}, ::Type{Int64}, data, status, n, m, g, f, a_ne, A_val,
                      c_l, c_u, x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_double_64.lpb_solve_lp_64(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int64},
...
function lpb_solve_lp(::Type{Float128}, ::Type{Int32}, data, status, n, m, g, f, a_ne,
  ...
  @ccall libgalahad_quadruple.lpb_solve_lp_q(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
...
function run_sif(::Val{:lpb}, ::Val{:single}, path_libsif::String, path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runlpb_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:lpb}, ::Val{:double}, path_libsif::String, path_outsdif::String)
