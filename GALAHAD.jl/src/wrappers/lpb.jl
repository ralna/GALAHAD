...
function lpb_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.lpb_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{lpb_control_type{Float32,
                                                                                Int64}},
...
function lpb_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.lpb_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{lpb_control_type{Float64,
                                                                              Int64}},
                                                status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function lpb_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.lpb_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{lpb_control_type{Float128,
                                                                                   Int64}},
                                                     status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function lpb_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.lpb_read_specfile_s_64(control::Ptr{lpb_control_type{Float32,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function lpb_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.lpb_read_specfile_64(control::Ptr{lpb_control_type{Float64,
                                                                                 Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function lpb_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.lpb_read_specfile_q_64(control::Ptr{lpb_control_type{Float128,
                                                                                      Int64}},
                                                        specfile::Ptr{Cchar})::Cvoid
end
...
function lpb_import(::Type{Float32}, ::Type{Int32}, control, data, status, n, m,
...
function lpb_import(::Type{Float32}, ::Type{Int64}, control, data, status, n, m,
                    A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_single_64.lpb_import_s_64(control::Ptr{lpb_control_type{Float32,
                                                                            Int64}},
                                              data::Ptr{Ptr{Cvoid}},
...
function lpb_import(::Type{Float64}, ::Type{Int32}, control, data, status, n, m,
                    A_type, A_ne, A_row, A_col, A_ptr)
...
function lpb_import(::Type{Float64}, ::Type{Int64}, control, data, status, n, m,
                    A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_double_64.lpb_import_64(control::Ptr{lpb_control_type{Float64,
                                                                          Int64}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int64}, n::Int64,
                                            m::Int64, A_type::Ptr{Cchar},
...
function lpb_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
...
function lpb_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                    m, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_quadruple_64.lpb_import_q_64(control::Ptr{lpb_control_type{Float128,
                                                                               Int64}},
                                                 data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64}, n::Int64,
                                                 m::Int64, A_type::Ptr{Cchar},
...
function lpb_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function lpb_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_single_64.lpb_reset_control_s_64(control::Ptr{lpb_control_type{Float32,
                                                                                   Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end

function lpb_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function lpb_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_double_64.lpb_reset_control_64(control::Ptr{lpb_control_type{Float64,
                                                                                 Int64}},
                                                   data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64})::Cvoid
end

function lpb_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function lpb_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_quadruple_64.lpb_reset_control_q_64(control::Ptr{lpb_control_type{Float128,
                                                                                      Int64}},
                                                        data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64})::Cvoid
end
...
function lpb_solve_lp(::Type{Float32}, ::Type{Int32}, data, status, n, m, g, f,
                      a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z, x_stat,
                      c_stat)
  @ccall libgalahad_single.lpb_solve_lp_s(data::Ptr{Ptr{Cvoid}},
                                          status::Ptr{Int32}, n::Int32,
                                          m::Int32, g::Ptr{Float32}, f::Float32,
...
function lpb_solve_lp(::Type{Float32}, ::Type{Int64}, data, status, n, m, g, f,
                      a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z, x_stat,
                      c_stat)
  @ccall libgalahad_single_64.lpb_solve_lp_s_64(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int64}, n::Int64,
...
function lpb_solve_lp(::Type{Float64}, ::Type{Int32}, data, status, n, m, g, f,
                      a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z, x_stat,
                      c_stat)
  @ccall libgalahad_double.lpb_solve_lp(data::Ptr{Ptr{Cvoid}},
                                        status::Ptr{Int32}, n::Int32, m::Int32,
...
function lpb_solve_lp(::Type{Float64}, ::Type{Int64}, data, status, n, m, g, f,
                      a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z, x_stat,
                      c_stat)
  @ccall libgalahad_double_64.lpb_solve_lp_64(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int64}, n::Int64,
                                              m::Int64, g::Ptr{Float64},
                                              f::Float64, a_ne::Int64,
                                              A_val::Ptr{Float64},
                                              c_l::Ptr{Float64},
                                              c_u::Ptr{Float64},
                                              x_l::Ptr{Float64},
...
function lpb_solve_lp(::Type{Float128}, ::Type{Int32}, data, status, n, m, g, f,
                      a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z, x_stat,
                      c_stat)
  @ccall libgalahad_quadruple.lpb_solve_lp_q(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32}, n::Int32,
...
function lpb_solve_lp(::Type{Float128}, ::Type{Int64}, data, status, n, m, g, f,
                      a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z, x_stat,
                      c_stat)
  @ccall libgalahad_quadruple_64.lpb_solve_lp_q_64(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64}, n::Int64,
...
function lpb_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.lpb_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                   inform::Ptr{lpb_inform_type{Float32,
                                                                               Int64}},
                                                   status::Ptr{Int64})::Cvoid
end
...
function lpb_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.lpb_information_64(data::Ptr{Ptr{Cvoid}},
                                                 inform::Ptr{lpb_inform_type{Float64,
                                                                             Int64}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function lpb_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.lpb_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                      inform::Ptr{lpb_inform_type{Float128,
                                                                                  Int64}},
                                                      status::Ptr{Int64})::Cvoid
end
...
function lpb_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.lpb_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{lpb_control_type{Float32,
                                                                               Int64}},
                                                 inform::Ptr{lpb_inform_type{Float32,
                                                                             Int64}})::Cvoid
...
function lpb_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.lpb_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{lpb_control_type{Float64,
                                                                             Int64}},
                                               inform::Ptr{lpb_inform_type{Float64,
                                                                           Int64}})::Cvoid
...
function lpb_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.lpb_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{lpb_control_type{Float128,
                                                                                  Int64}},
                                                    inform::Ptr{lpb_inform_type{Float128,
                                                                                Int64}})::Cvoid
...
function run_sif(::Val{:lpb}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runlpb_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:lpb}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runlpb_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_qplib(::Val{:lpb}, ::Val{:single}, path_qplib::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runlpb_qplib_single())`)
...
function run_qplib(::Val{:lpb}, ::Val{:double}, path_qplib::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runlpb_qplib_double())`)
  open(path_qplib, "r") do io
    process = pipeline(cmd; stdin=io)
    return run(process)
  end
