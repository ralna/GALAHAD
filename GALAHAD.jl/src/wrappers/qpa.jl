...
function qpa_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.qpa_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{qpa_control_type{Float32,
                                                                                Int64}},
...
function qpa_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.qpa_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{qpa_control_type{Float64,
                                                                              Int64}},
                                                status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function qpa_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.qpa_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{qpa_control_type{Float128,
                                                                                   Int64}},
                                                     status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function qpa_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.qpa_read_specfile_s_64(control::Ptr{qpa_control_type{Float32,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function qpa_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.qpa_read_specfile_64(control::Ptr{qpa_control_type{Float64,
                                                                                 Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function qpa_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.qpa_read_specfile_q_64(control::Ptr{qpa_control_type{Float128,
                                                                                      Int64}},
                                                        specfile::Ptr{Cchar})::Cvoid
end
...
function qpa_import(::Type{Float32}, ::Type{Int32}, control, data, status, n, m,
                    H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                    A_col, A_ptr)
...
function qpa_import(::Type{Float32}, ::Type{Int64}, control, data, status, n, m,
                    H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                    A_col, A_ptr)
  @ccall libgalahad_single_64.qpa_import_s_64(control::Ptr{qpa_control_type{Float32,
                                                                            Int64}},
                                              data::Ptr{Ptr{Cvoid}},
...
function qpa_import(::Type{Float64}, ::Type{Int32}, control, data, status, n, m,
                    H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                    A_col, A_ptr)
...
function qpa_import(::Type{Float64}, ::Type{Int64}, control, data, status, n, m,
                    H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                    A_col, A_ptr)
  @ccall libgalahad_double_64.qpa_import_64(control::Ptr{qpa_control_type{Float64,
                                                                          Int64}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int64}, n::Int64,
                                            m::Int64, H_type::Ptr{Cchar},
...
function qpa_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                    m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                    A_col, A_ptr)
...
function qpa_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                    m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                    A_col, A_ptr)
  @ccall libgalahad_quadruple_64.qpa_import_q_64(control::Ptr{qpa_control_type{Float128,
                                                                               Int64}},
                                                 data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64}, n::Int64,
                                                 m::Int64, H_type::Ptr{Cchar},
...
function qpa_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function qpa_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_single_64.qpa_reset_control_s_64(control::Ptr{qpa_control_type{Float32,
                                                                                   Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end

function qpa_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function qpa_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_double_64.qpa_reset_control_64(control::Ptr{qpa_control_type{Float64,
                                                                                 Int64}},
                                                   data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64})::Cvoid
end

function qpa_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function qpa_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_quadruple_64.qpa_reset_control_q_64(control::Ptr{qpa_control_type{Float128,
                                                                                      Int64}},
                                                        data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64})::Cvoid
end
...
function qpa_solve_qp(::Type{Float32}, ::Type{Int32}, data, status, n, m, h_ne,
                      H_val, g, f, a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z,
                      x_stat, c_stat)
  @ccall libgalahad_single.qpa_solve_qp_s(data::Ptr{Ptr{Cvoid}},
                                          status::Ptr{Int32}, n::Int32,
                                          m::Int32, h_ne::Int32,
                                          H_val::Ptr{Float32}, g::Ptr{Float32},
                                          f::Float32, a_ne::Int32,
                                          A_val::Ptr{Float32},
...
function qpa_solve_qp(::Type{Float32}, ::Type{Int64}, data, status, n, m, h_ne,
                      H_val, g, f, a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z,
                      x_stat, c_stat)
  @ccall libgalahad_single_64.qpa_solve_qp_s_64(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int64}, n::Int64,
                                                m::Int64, h_ne::Int64,
                                                H_val::Ptr{Float32},
...
function qpa_solve_qp(::Type{Float64}, ::Type{Int32}, data, status, n, m, h_ne,
                      H_val, g, f, a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z,
                      x_stat, c_stat)
  @ccall libgalahad_double.qpa_solve_qp(data::Ptr{Ptr{Cvoid}},
                                        status::Ptr{Int32}, n::Int32, m::Int32,
...
function qpa_solve_qp(::Type{Float64}, ::Type{Int64}, data, status, n, m, h_ne,
                      H_val, g, f, a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z,
                      x_stat, c_stat)
  @ccall libgalahad_double_64.qpa_solve_qp_64(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int64}, n::Int64,
                                              m::Int64, h_ne::Int64,
                                              H_val::Ptr{Float64},
                                              g::Ptr{Float64}, f::Float64,
...
function qpa_solve_qp(::Type{Float128}, ::Type{Int32}, data, status, n, m, h_ne,
                      H_val, g, f, a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z,
                      x_stat, c_stat)
  @ccall libgalahad_quadruple.qpa_solve_qp_q(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32}, n::Int32,
                                             m::Int32, h_ne::Int32,
                                             H_val::Ptr{Float128},
...
function qpa_solve_qp(::Type{Float128}, ::Type{Int64}, data, status, n, m, h_ne,
                      H_val, g, f, a_ne, A_val, c_l, c_u, x_l, x_u, x, c, y, z,
                      x_stat, c_stat)
  @ccall libgalahad_quadruple_64.qpa_solve_qp_q_64(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64}, n::Int64,
                                                   m::Int64, h_ne::Int64,
                                                   H_val::Ptr{Float128},
                                                   g::Ptr{Float128},
...
function qpa_solve_l1qp(::Type{Float32}, ::Type{Int32}, data, status, n, m,
                        h_ne, H_val, g, f, rho_g, rho_b, a_ne, A_val, c_l, c_u,
                        x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_single.qpa_solve_l1qp_s(data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int32}, n::Int32,
                                            m::Int32, h_ne::Int32,
                                            H_val::Ptr{Float32},
                                            g::Ptr{Float32}, f::Float32,
                                            rho_g::Float32, rho_b::Float32,
...
function qpa_solve_l1qp(::Type{Float32}, ::Type{Int64}, data, status, n, m,
                        h_ne, H_val, g, f, rho_g, rho_b, a_ne, A_val, c_l, c_u,
                        x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_single_64.qpa_solve_l1qp_s_64(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64}, n::Int64,
                                                  m::Int64, h_ne::Int64,
                                                  H_val::Ptr{Float32},
                                                  g::Ptr{Float32}, f::Float32,
                                                  rho_g::Float32,
                                                  rho_b::Float32, a_ne::Int64,
                                                  A_val::Ptr{Float32},
                                                  c_l::Ptr{Float32},
                                                  c_u::Ptr{Float32},
                                                  x_l::Ptr{Float32},
...
function qpa_solve_l1qp(::Type{Float64}, ::Type{Int32}, data, status, n, m,
                        h_ne, H_val, g, f, rho_g, rho_b, a_ne, A_val, c_l, c_u,
                        x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_double.qpa_solve_l1qp(data::Ptr{Ptr{Cvoid}},
                                          status::Ptr{Int32}, n::Int32,
                                          m::Int32, h_ne::Int32,
                                          H_val::Ptr{Float64}, g::Ptr{Float64},
                                          f::Float64, rho_g::Float64,
                                          rho_b::Float64, a_ne::Int32,
                                          A_val::Ptr{Float64},
                                          c_l::Ptr{Float64}, c_u::Ptr{Float64},
                                          x_l::Ptr{Float64}, x_u::Ptr{Float64},
                                          x::Ptr{Float64}, c::Ptr{Float64},
...
function qpa_solve_l1qp(::Type{Float64}, ::Type{Int64}, data, status, n, m,
                        h_ne, H_val, g, f, rho_g, rho_b, a_ne, A_val, c_l, c_u,
                        x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_double_64.qpa_solve_l1qp_64(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int64}, n::Int64,
                                                m::Int64, h_ne::Int64,
                                                H_val::Ptr{Float64},
                                                g::Ptr{Float64}, f::Float64,
                                                rho_g::Float64, rho_b::Float64,
                                                a_ne::Int64,
                                                A_val::Ptr{Float64},
                                                c_l::Ptr{Float64},
                                                c_u::Ptr{Float64},
...
function qpa_solve_l1qp(::Type{Float128}, ::Type{Int32}, data, status, n, m,
                        h_ne, H_val, g, f, rho_g, rho_b, a_ne, A_val, c_l, c_u,
                        x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_quadruple.qpa_solve_l1qp_q(data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32}, n::Int32,
                                               m::Int32, h_ne::Int32,
                                               H_val::Ptr{Float128},
                                               g::Ptr{Float128}, f::Cfloat128,
...
function qpa_solve_l1qp(::Type{Float128}, ::Type{Int64}, data, status, n, m,
                        h_ne, H_val, g, f, rho_g, rho_b, a_ne, A_val, c_l, c_u,
                        x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_quadruple_64.qpa_solve_l1qp_q_64(data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64},
                                                     n::Int64, m::Int64,
                                                     h_ne::Int64,
                                                     H_val::Ptr{Float128},
...
function qpa_solve_bcl1qp(::Type{Float32}, ::Type{Int32}, data, status, n, m,
                          h_ne, H_val, g, f, rho_g, a_ne, A_val, c_l, c_u, x_l,
                          x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_single.qpa_solve_bcl1qp_s(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, n::Int32,
                                              m::Int32, h_ne::Int32,
                                              H_val::Ptr{Float32},
                                              g::Ptr{Float32}, f::Float32,
                                              rho_g::Float32, a_ne::Int32,
                                              A_val::Ptr{Float32},
                                              c_l::Ptr{Float32},
                                              c_u::Ptr{Float32},
                                              x_l::Ptr{Float32},
...
function qpa_solve_bcl1qp(::Type{Float32}, ::Type{Int64}, data, status, n, m,
                          h_ne, H_val, g, f, rho_g, a_ne, A_val, c_l, c_u, x_l,
                          x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_single_64.qpa_solve_bcl1qp_s_64(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    n::Int64, m::Int64,
                                                    h_ne::Int64,
                                                    H_val::Ptr{Float32},
                                                    g::Ptr{Float32}, f::Float32,
                                                    rho_g::Float32, a_ne::Int64,
                                                    A_val::Ptr{Float32},
                                                    c_l::Ptr{Float32},
                                                    c_u::Ptr{Float32},
                                                    x_l::Ptr{Float32},
...
function qpa_solve_bcl1qp(::Type{Float64}, ::Type{Int32}, data, status, n, m,
                          h_ne, H_val, g, f, rho_g, a_ne, A_val, c_l, c_u, x_l,
                          x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_double.qpa_solve_bcl1qp(data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int32}, n::Int32,
                                            m::Int32, h_ne::Int32,
                                            H_val::Ptr{Float64},
                                            g::Ptr{Float64}, f::Float64,
                                            rho_g::Float64, a_ne::Int32,
                                            A_val::Ptr{Float64},
                                            c_l::Ptr{Float64},
                                            c_u::Ptr{Float64},
                                            x_l::Ptr{Float64},
...
function qpa_solve_bcl1qp(::Type{Float64}, ::Type{Int64}, data, status, n, m,
                          h_ne, H_val, g, f, rho_g, a_ne, A_val, c_l, c_u, x_l,
                          x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_double_64.qpa_solve_bcl1qp_64(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64}, n::Int64,
                                                  m::Int64, h_ne::Int64,
                                                  H_val::Ptr{Float64},
                                                  g::Ptr{Float64}, f::Float64,
                                                  rho_g::Float64, a_ne::Int64,
                                                  A_val::Ptr{Float64},
                                                  c_l::Ptr{Float64},
                                                  c_u::Ptr{Float64},
                                                  x_l::Ptr{Float64},
...
function qpa_solve_bcl1qp(::Type{Float128}, ::Type{Int32}, data, status, n, m,
                          h_ne, H_val, g, f, rho_g, a_ne, A_val, c_l, c_u, x_l,
                          x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_quadruple.qpa_solve_bcl1qp_q(data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int32}, n::Int32,
                                                 m::Int32, h_ne::Int32,
                                                 H_val::Ptr{Float128},
                                                 g::Ptr{Float128}, f::Cfloat128,
                                                 rho_g::Cfloat128, a_ne::Int32,
                                                 A_val::Ptr{Float128},
                                                 c_l::Ptr{Float128},
                                                 c_u::Ptr{Float128},
                                                 x_l::Ptr{Float128},
...
function qpa_solve_bcl1qp(::Type{Float128}, ::Type{Int64}, data, status, n, m,
                          h_ne, H_val, g, f, rho_g, a_ne, A_val, c_l, c_u, x_l,
                          x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_quadruple_64.qpa_solve_bcl1qp_q_64(data::Ptr{Ptr{Cvoid}},
                                                       status::Ptr{Int64},
                                                       n::Int64, m::Int64,
                                                       h_ne::Int64,
                                                       H_val::Ptr{Float128},
...
function qpa_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.qpa_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                   inform::Ptr{qpa_inform_type{Float32,
                                                                               Int64}},
                                                   status::Ptr{Int64})::Cvoid
end
...
function qpa_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.qpa_information_64(data::Ptr{Ptr{Cvoid}},
                                                 inform::Ptr{qpa_inform_type{Float64,
                                                                             Int64}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function qpa_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.qpa_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                      inform::Ptr{qpa_inform_type{Float128,
                                                                                  Int64}},
                                                      status::Ptr{Int64})::Cvoid
end
...
function qpa_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.qpa_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{qpa_control_type{Float32,
                                                                               Int64}},
                                                 inform::Ptr{qpa_inform_type{Float32,
                                                                             Int64}})::Cvoid
...
function qpa_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.qpa_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{qpa_control_type{Float64,
                                                                             Int64}},
                                               inform::Ptr{qpa_inform_type{Float64,
                                                                           Int64}})::Cvoid
...
function qpa_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.qpa_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{qpa_control_type{Float128,
                                                                                  Int64}},
                                                    inform::Ptr{qpa_inform_type{Float128,
                                                                                Int64}})::Cvoid
...
function run_sif(::Val{:qpa}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runqpa_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:qpa}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runqpa_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_qplib(::Val{:qpa}, ::Val{:single}, path_qplib::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runqpa_qplib_single())`)
...
function run_qplib(::Val{:qpa}, ::Val{:double}, path_qplib::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runqpa_qplib_double())`)
  open(path_qplib, "r") do io
    process = pipeline(cmd; stdin=io)
    return run(process)
  end
