...
function ugo_read_specfile(::Type{Float32}, ::Type{Int32}, control, specfile)
  @ccall libgalahad_single.ugo_read_specfile_s(control::Ptr{ugo_control_type{Float32,Int32}},
...
function ugo_import(::Type{Float32}, ::Type{Int32}, control, data, status, x_l, x_u)
  @ccall libgalahad_single.ugo_import_s(control::Ptr{ugo_control_type{Float32,Int32}},
...
function ugo_import(::Type{Float32}, ::Type{Int64}, control, data, status, x_l, x_u)
  @ccall libgalahad_single_64.ugo_import_s_64(control::Ptr{ugo_control_type{Float32,Int64}},
...
function ugo_import(::Type{Float64}, ::Type{Int64}, control, data, status, x_l, x_u)
  @ccall libgalahad_double_64.ugo_import_64(control::Ptr{ugo_control_type{Float64,Int64}},
                                            data::Ptr{Ptr{Cvoid}}, status::Ptr{Int64},
                                            x_l::Ptr{Float64}, x_u::Ptr{Float64})::Cvoid
end

function ugo_import(::Type{Float128}, ::Type{Int32}, control, data, status, x_l, x_u)
  @ccall libgalahad_quadruple.ugo_import_q(control::Ptr{ugo_control_type{Float128,Int32}},
                                           data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
...
function ugo_reset_control(::Type{Float32}, ::Type{Int32}, control, data, status)
  @ccall libgalahad_single.ugo_reset_control_s(control::Ptr{ugo_control_type{Float32,Int32}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32})::Cvoid
end
...
function ugo_solve_direct(::Type{Float128}, ::Type{Int64}, data, userdata, status, x, f, g,
  ...
  @ccall libgalahad_quadruple_64.ugo_solve_direct_q_64(data::Ptr{Ptr{Cvoid}},
                                                       userdata::Ptr{Cvoid},
                                                       status::Ptr{Int64}, x::Ptr{Float128},
...
function ugo_solve_reverse(::Type{Float32}, ::Type{Int32}, data, status, eval_status, x, f,
                           g, h)
  @ccall libgalahad_single.ugo_solve_reverse_s(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
...
function ugo_solve_reverse(::Type{Float128}, ::Type{Int32}, data, status, eval_status, x, f,
                           g, h)
  @ccall libgalahad_quadruple.ugo_solve_reverse_q(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
...
function run_sif(::Val{:ugo}, ::Val{:single}, path_libsif::String, path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runugo_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:ugo}, ::Val{:double}, path_libsif::String, path_outsdif::String)
