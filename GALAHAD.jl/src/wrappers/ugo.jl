...
function ugo_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.ugo_read_specfile_s_64(control::Ptr{ugo_control_type{Float32,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function ugo_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.ugo_read_specfile_64(control::Ptr{ugo_control_type{Float64,
                                                                                 Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function ugo_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.ugo_read_specfile_q_64(control::Ptr{ugo_control_type{Float128,
                                                                                      Int64}},
                                                        specfile::Ptr{Cchar})::Cvoid
end
...
function ugo_import(::Type{Float32}, ::Type{Int32}, control, data, status, x_l,
                    x_u)
  @ccall libgalahad_single.ugo_import_s(control::Ptr{ugo_control_type{Float32,
                                                                      Int32}},
                                        data::Ptr{Ptr{Cvoid}},
                                        status::Ptr{Int32}, x_l::Ptr{Float32},
                                        x_u::Ptr{Float32})::Cvoid
end

function ugo_import(::Type{Float32}, ::Type{Int64}, control, data, status, x_l,
                    x_u)
  @ccall libgalahad_single_64.ugo_import_s_64(control::Ptr{ugo_control_type{Float32,
                                                                            Int64}},
                                              data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int64},
                                              x_l::Ptr{Float32},
...
function ugo_import(::Type{Float64}, ::Type{Int32}, control, data, status, x_l,
                    x_u)
...
function ugo_import(::Type{Float64}, ::Type{Int64}, control, data, status, x_l,
                    x_u)
  @ccall libgalahad_double_64.ugo_import_64(control::Ptr{ugo_control_type{Float64,
                                                                          Int64}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int64},
                                            x_l::Ptr{Float64},
...
function ugo_import(::Type{Float128}, ::Type{Int32}, control, data, status, x_l,
                    x_u)
...
function ugo_import(::Type{Float128}, ::Type{Int64}, control, data, status, x_l,
                    x_u)
  @ccall libgalahad_quadruple_64.ugo_import_q_64(control::Ptr{ugo_control_type{Float128,
                                                                               Int64}},
                                                 data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64},
                                                 x_l::Ptr{Float128},
...
function ugo_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function ugo_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_single_64.ugo_reset_control_s_64(control::Ptr{ugo_control_type{Float32,
                                                                                   Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end

function ugo_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function ugo_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_double_64.ugo_reset_control_64(control::Ptr{ugo_control_type{Float64,
                                                                                 Int64}},
                                                   data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64})::Cvoid
end

function ugo_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function ugo_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_quadruple_64.ugo_reset_control_q_64(control::Ptr{ugo_control_type{Float128,
                                                                                      Int64}},
                                                        data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64})::Cvoid
end
...
function ugo_solve_direct(::Type{Float32}, ::Type{Int32}, data, userdata,
                          status, x, f, g, h, eval_fgh)
  @ccall libgalahad_single.ugo_solve_direct_s(data::Ptr{Ptr{Cvoid}},
                                              userdata::Ptr{Cvoid},
                                              status::Ptr{Int32},
                                              x::Ptr{Float32}, f::Ptr{Float32},
                                              g::Ptr{Float32}, h::Ptr{Float32},
                                              eval_fgh::Ptr{Cvoid})::Cvoid
end

function ugo_solve_direct(::Type{Float32}, ::Type{Int64}, data, userdata,
                          status, x, f, g, h, eval_fgh)
  @ccall libgalahad_single_64.ugo_solve_direct_s_64(data::Ptr{Ptr{Cvoid}},
                                                    userdata::Ptr{Cvoid},
                                                    status::Ptr{Int64},
                                                    x::Ptr{Float32},
                                                    f::Ptr{Float32},
...
function ugo_solve_direct(::Type{Float64}, ::Type{Int32}, data, userdata,
                          status, x, f, g, h, eval_fgh)
  @ccall libgalahad_double.ugo_solve_direct(data::Ptr{Ptr{Cvoid}},
                                            userdata::Ptr{Cvoid},
...
function ugo_solve_direct(::Type{Float64}, ::Type{Int64}, data, userdata,
                          status, x, f, g, h, eval_fgh)
  @ccall libgalahad_double_64.ugo_solve_direct_64(data::Ptr{Ptr{Cvoid}},
                                                  userdata::Ptr{Cvoid},
                                                  status::Ptr{Int64},
                                                  x::Ptr{Float64},
                                                  f::Ptr{Float64},
...
function ugo_solve_direct(::Type{Float128}, ::Type{Int32}, data, userdata,
                          status, x, f, g, h, eval_fgh)
...
function ugo_solve_direct(::Type{Float128}, ::Type{Int64}, data, userdata,
                          status, x, f, g, h, eval_fgh)
  @ccall libgalahad_quadruple_64.ugo_solve_direct_q_64(data::Ptr{Ptr{Cvoid}},
                                                       userdata::Ptr{Cvoid},
                                                       status::Ptr{Int64},
                                                       x::Ptr{Float128},
                                                       f::Ptr{Float128},
...
function ugo_solve_reverse(::Type{Float32}, ::Type{Int32}, data, status,
                           eval_status, x, f, g, h)
  @ccall libgalahad_single.ugo_solve_reverse_s(data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32},
...
function ugo_solve_reverse(::Type{Float32}, ::Type{Int64}, data, status,
                           eval_status, x, f, g, h)
  @ccall libgalahad_single_64.ugo_solve_reverse_s_64(data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64},
...
function ugo_solve_reverse(::Type{Float64}, ::Type{Int32}, data, status,
                           eval_status, x, f, g, h)
  @ccall libgalahad_double.ugo_solve_reverse(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32},
                                             eval_status::Ptr{Int32},
                                             x::Ptr{Float64}, f::Ptr{Float64},
                                             g::Ptr{Float64},
                                             h::Ptr{Float64})::Cvoid
end

function ugo_solve_reverse(::Type{Float64}, ::Type{Int64}, data, status,
                           eval_status, x, f, g, h)
  @ccall libgalahad_double_64.ugo_solve_reverse_64(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64},
                                                   eval_status::Ptr{Int64},
                                                   x::Ptr{Float64},
                                                   f::Ptr{Float64},
...
function ugo_solve_reverse(::Type{Float128}, ::Type{Int32}, data, status,
                           eval_status, x, f, g, h)
  @ccall libgalahad_quadruple.ugo_solve_reverse_q(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int32},
                                                  eval_status::Ptr{Int32},
                                                  x::Ptr{Float128},
                                                  f::Ptr{Float128},
...
function ugo_solve_reverse(::Type{Float128}, ::Type{Int64}, data, status,
                           eval_status, x, f, g, h)
  @ccall libgalahad_quadruple_64.ugo_solve_reverse_q_64(data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64},
                                                        eval_status::Ptr{Int64},
                                                        x::Ptr{Float128},
                                                        f::Ptr{Float128},
...
function ugo_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.ugo_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                   inform::Ptr{ugo_inform_type{Float32,
                                                                               Int64}},
                                                   status::Ptr{Int64})::Cvoid
end
...
function ugo_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.ugo_information_64(data::Ptr{Ptr{Cvoid}},
                                                 inform::Ptr{ugo_inform_type{Float64,
                                                                             Int64}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function ugo_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.ugo_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                      inform::Ptr{ugo_inform_type{Float128,
                                                                                  Int64}},
                                                      status::Ptr{Int64})::Cvoid
end
...
function ugo_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.ugo_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{ugo_control_type{Float32,
                                                                               Int64}},
                                                 inform::Ptr{ugo_inform_type{Float32,
                                                                             Int64}})::Cvoid
...
function ugo_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.ugo_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{ugo_control_type{Float64,
                                                                             Int64}},
                                               inform::Ptr{ugo_inform_type{Float64,
                                                                           Int64}})::Cvoid
...
function ugo_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.ugo_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{ugo_control_type{Float128,
                                                                                  Int64}},
                                                    inform::Ptr{ugo_inform_type{Float128,
                                                                                Int64}})::Cvoid
...
function run_sif(::Val{:ugo}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runugo_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:ugo}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runugo_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
