...
mutable struct dgo_control_type{T}
  f_indexing::Bool
  error::Cint
  out::Cint
  print_level::Cint
...
mutable struct dgo_time_type{T}
  total::Float32
...
mutable struct dgo_inform_type{T}
  status::Cint
  alloc_status::Cint
...
function dgo_initialize_s(data, control, status)
  @ccall libgalahad_single.dgo_initialize_s(data::Ptr{Ptr{Cvoid}},
                                            control::Ref{dgo_control_type{Float32}},
...
function dgo_read_specfile_s(control, specfile)
  @ccall libgalahad_single.dgo_read_specfile_s(control::Ref{dgo_control_type{Float32}},
...
function dgo_read_specfile(control, specfile)
  @ccall libgalahad_double.dgo_read_specfile(control::Ref{dgo_control_type{Float64}},
                                             specfile::Ptr{Cchar})::Cvoid
end
...
function dgo_import_s(control, data, status, n, x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
  @ccall libgalahad_single.dgo_import_s(control::Ref{dgo_control_type{Float32}},
...
function dgo_import(control, data, status, n, x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
  @ccall libgalahad_double.dgo_import(control::Ref{dgo_control_type{Float64}},
                                      data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint}, n::Cint,
...
function dgo_reset_control_s(control, data, status)
  @ccall libgalahad_single.dgo_reset_control_s(control::Ref{dgo_control_type{Float32}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Cint})::Cvoid
end
...
function dgo_reset_control(control, data, status)
  @ccall libgalahad_double.dgo_reset_control(control::Ref{dgo_control_type{Float64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Cint})::Cvoid
end
...
function dgo_solve_without_mat_s(data, userdata, status, n, x, g, eval_f, eval_g, eval_hprod,
...
function dgo_solve_reverse_with_mat_s(data, status, eval_status, n, x, f, g, ne, H_val, u, v)
...
function dgo_information_s(data, inform, status)
  @ccall libgalahad_single.dgo_information_s(data::Ptr{Ptr{Cvoid}},
                                             inform::Ref{dgo_inform_type{Float32}},
                                             status::Ptr{Cint})::Cvoid
end
...
function dgo_terminate_s(data, control, inform)
  @ccall libgalahad_single.dgo_terminate_s(data::Ptr{Ptr{Cvoid}},
                                           control::Ref{dgo_control_type{Float32}},
                                           inform::Ref{dgo_inform_type{Float32}})::Cvoid
end
...
function dgo_terminate(data, control, inform)
  @ccall libgalahad_double.dgo_terminate(data::Ptr{Ptr{Cvoid}},
                                         control::Ref{dgo_control_type{Float64}},
                                         inform::Ref{dgo_inform_type{Float64}})::Cvoid
end
