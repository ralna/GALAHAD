...
function l2rt_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.l2rt_initialize_s(data::Ptr{Ptr{Cvoid}},
...
function l2rt_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.l2rt_initialize_q(data::Ptr{Ptr{Cvoid}},
                                                   control::Ptr{l2rt_control_type{Float128,
                                                                                  Int64}},
                                                   status::Ptr{Int64})::Cvoid
end
...
function l2rt_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.l2rt_read_specfile_s(control::Ptr{l2rt_control_type{Float32,
                                                                                  Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function l2rt_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.l2rt_read_specfile_q(control::Ptr{l2rt_control_type{Float128,
                                                                                     Int64}},
                                                      specfile::Ptr{Cchar})::Cvoid
end
...
function l2rt_import_control(::Type{Float32}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_single_64.l2rt_import_control_s(control::Ptr{l2rt_control_type{Float32,
                                                                                   Int64}},
                                                    data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64})::Cvoid
end
...
function l2rt_import_control(::Type{Float128}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_quadruple_64.l2rt_import_control_q(control::Ptr{l2rt_control_type{Float128,
                                                                                      Int64}},
                                                       data::Ptr{Ptr{Cvoid}},
                                                       status::Ptr{Int64})::Cvoid
end
...
function l2rt_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, m, n, power,
                            weight, shift, x, u, v)
  @ccall libgalahad_single_64.l2rt_solve_problem_s(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64}, m::Int64, n::Int64,
                                                   power::Float32, weight::Float32,
                                                   shift::Float32, x::Ptr{Float32},
...
function l2rt_solve_problem(::Type{Float128}, ::Type{Int64}, data, status, m, n, power,
                            weight, shift, x, u, v)
  @ccall libgalahad_quadruple_64.l2rt_solve_problem_q(data::Ptr{Ptr{Cvoid}},
...
function l2rt_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.l2rt_information_s(data::Ptr{Ptr{Cvoid}},
...
function l2rt_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.l2rt_information_q(data::Ptr{Ptr{Cvoid}},
                                                    inform::Ptr{l2rt_inform_type{Float128,
                                                                                 Int64}},
                                                    status::Ptr{Int64})::Cvoid
end
...
function l2rt_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.l2rt_terminate_s(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{l2rt_control_type{Float32,
                                                                              Int64}},
...
function l2rt_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.l2rt_terminate_q(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{l2rt_control_type{Float128,
                                                                                 Int64}},
                                                  inform::Ptr{l2rt_inform_type{Float128,
                                                                               Int64}})::Cvoid
