...
function l2rt_import_control(::Type{Float32}, ::Type{Int32}, control, data,
                             status)
...
function l2rt_import_control(::Type{Float32}, ::Type{Int64}, control, data,
                             status)
...
function l2rt_import_control(::Type{Float64}, ::Type{Int32}, control, data,
                             status)
...
function l2rt_import_control(::Type{Float64}, ::Type{Int64}, control, data,
                             status)
...
function l2rt_import_control(::Type{Float128}, ::Type{Int32}, control, data,
                             status)
...
function l2rt_import_control(::Type{Float128}, ::Type{Int64}, control, data,
                             status)
...
function l2rt_solve_problem(::Type{Float32}, ::Type{Int32}, data, status, m, n,
                            power, weight, shift, x, u, v)
  @ccall libgalahad_single.l2rt_solve_problem_s(data::Ptr{Ptr{Cvoid}},
...
function l2rt_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, m, n,
                            power, weight, shift, x, u, v)
...
function l2rt_solve_problem(::Type{Float64}, ::Type{Int32}, data, status, m, n,
                            power, weight, shift, x, u, v)
  @ccall libgalahad_double.l2rt_solve_problem(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, m::Int32,
...
function l2rt_solve_problem(::Type{Float64}, ::Type{Int64}, data, status, m, n,
                            power, weight, shift, x, u, v)
...
function l2rt_solve_problem(::Type{Float128}, ::Type{Int32}, data, status, m, n,
                            power, weight, shift, x, u, v)
...
function l2rt_solve_problem(::Type{Float128}, ::Type{Int64}, data, status, m, n,
                            power, weight, shift, x, u, v)
...
function run_sif(::Val{:l2rt}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
...
function run_sif(::Val{:l2rt}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
