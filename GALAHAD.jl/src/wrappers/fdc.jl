...
function fdc_find_dependent_rows(::Type{Float32}, ::Type{Int32}, control, data,
                                 inform, status, m, n, A_ne, A_col, A_ptr,
...
function fdc_find_dependent_rows(::Type{Float32}, ::Type{Int64}, control, data,
                                 inform, status, m, n, A_ne, A_col, A_ptr,
                                 A_val, b, n_depen, depen)
...
function fdc_find_dependent_rows(::Type{Float64}, ::Type{Int32}, control, data,
                                 inform, status, m, n, A_ne, A_col, A_ptr,
                                 A_val, b, n_depen, depen)
...
function fdc_find_dependent_rows(::Type{Float64}, ::Type{Int64}, control, data,
                                 inform, status, m, n, A_ne, A_col, A_ptr,
                                 A_val, b, n_depen, depen)
...
function fdc_find_dependent_rows(::Type{Float128}, ::Type{Int32}, control, data,
                                 inform, status, m, n, A_ne, A_col, A_ptr,
                                 A_val, b, n_depen, depen)
...
function fdc_find_dependent_rows(::Type{Float128}, ::Type{Int64}, control, data,
                                 inform, status, m, n, A_ne, A_col, A_ptr,
                                 A_val, b, n_depen, depen)
