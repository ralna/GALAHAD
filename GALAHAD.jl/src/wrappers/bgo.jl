...
function bgo_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
...
function bgo_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                    x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
  @ccall libgalahad_single_64.bgo_import_s_64(control::Ptr{bgo_control_type{Float32,
                                                                            Int64}},
                                              data::Ptr{Ptr{Cvoid}},
...
function bgo_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                    x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
...
function bgo_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                    x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
  @ccall libgalahad_double_64.bgo_import_64(control::Ptr{bgo_control_type{Float64,
                                                                          Int64}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int64}, n::Int64,
                                            x_l::Ptr{Float64},
...
function bgo_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                    x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
...
function bgo_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                    x_l, x_u, H_type, ne, H_row, H_col, H_ptr)
...
function bgo_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function bgo_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
...
function bgo_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function bgo_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
...
function bgo_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function bgo_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
...
function bgo_solve_with_mat(::Type{Float32}, ::Type{Int32}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_hprod, eval_prec)
  @ccall libgalahad_single.bgo_solve_with_mat_s(data::Ptr{Ptr{Cvoid}},
                                                userdata::Ptr{Cvoid},
                                                status::Ptr{Int32}, n::Int32,
                                                x::Ptr{Float32},
...
function bgo_solve_with_mat(::Type{Float32}, ::Type{Int64}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_hprod, eval_prec)
...
function bgo_solve_with_mat(::Type{Float64}, ::Type{Int32}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_hprod, eval_prec)
  @ccall libgalahad_double.bgo_solve_with_mat(data::Ptr{Ptr{Cvoid}},
                                              userdata::Ptr{Cvoid},
                                              status::Ptr{Int32}, n::Int32,
...
function bgo_solve_with_mat(::Type{Float64}, ::Type{Int64}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_hprod, eval_prec)
...
function bgo_solve_with_mat(::Type{Float128}, ::Type{Int32}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_hprod, eval_prec)
...
function bgo_solve_with_mat(::Type{Float128}, ::Type{Int64}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_hprod, eval_prec)
...
function bgo_solve_without_mat(::Type{Float32}, ::Type{Int32}, data, userdata,
...
function bgo_solve_without_mat(::Type{Float32}, ::Type{Int64}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_shprod, eval_prec)
...
function bgo_solve_without_mat(::Type{Float64}, ::Type{Int32}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_shprod, eval_prec)
...
function bgo_solve_without_mat(::Type{Float64}, ::Type{Int64}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_shprod, eval_prec)
...
function bgo_solve_without_mat(::Type{Float128}, ::Type{Int32}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_shprod, eval_prec)
...
function bgo_solve_without_mat(::Type{Float128}, ::Type{Int64}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_shprod, eval_prec)
...
function bgo_solve_reverse_with_mat(::Type{Float32}, ::Type{Int32}, data,
...
function bgo_solve_reverse_with_mat(::Type{Float32}, ::Type{Int64}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
...
function bgo_solve_reverse_with_mat(::Type{Float64}, ::Type{Int32}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
...
function bgo_solve_reverse_with_mat(::Type{Float64}, ::Type{Int64}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
...
function bgo_solve_reverse_with_mat(::Type{Float128}, ::Type{Int32}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
...
function bgo_solve_reverse_with_mat(::Type{Float128}, ::Type{Int64}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
...
function bgo_solve_reverse_without_mat(::Type{Float32}, ::Type{Int32}, data,
...
function bgo_solve_reverse_without_mat(::Type{Float32}, ::Type{Int64}, data,
                                       status, eval_status, n, x, f, g, u, v,
                                       index_nz_v, nnz_v, index_nz_u, nnz_u)
...
function bgo_solve_reverse_without_mat(::Type{Float64}, ::Type{Int32}, data,
                                       status, eval_status, n, x, f, g, u, v,
                                       index_nz_v, nnz_v, index_nz_u, nnz_u)
...
function bgo_solve_reverse_without_mat(::Type{Float64}, ::Type{Int64}, data,
                                       status, eval_status, n, x, f, g, u, v,
                                       index_nz_v, nnz_v, index_nz_u, nnz_u)
...
function bgo_solve_reverse_without_mat(::Type{Float128}, ::Type{Int32}, data,
                                       status, eval_status, n, x, f, g, u, v,
                                       index_nz_v, nnz_v, index_nz_u, nnz_u)
...
function bgo_solve_reverse_without_mat(::Type{Float128}, ::Type{Int64}, data,
                                       status, eval_status, n, x, f, g, u, v,
                                       index_nz_v, nnz_v, index_nz_u, nnz_u)
...
function run_sif(::Val{:bgo}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
...
function run_sif(::Val{:bgo}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
