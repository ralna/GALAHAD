...
function lpa_read_specfile(::Type{Float32}, ::Type{Int32}, control, specfile)
  @ccall libgalahad_single.lpa_read_specfile_s(control::Ptr{lpa_control_type{Float32,Int32}},
...
function lpa_import(::Type{Float32}, ::Type{Int32}, control, data, status, n, m, A_type,
  ...
  @ccall libgalahad_single.lpa_import_s(control::Ptr{lpa_control_type{Float32,Int32}},
...
function lpa_import(::Type{Float128}, ::Type{Int32}, control, data, status, n, m, A_type,
                    A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_quadruple.lpa_import_q(control::Ptr{lpa_control_type{Float128,Int32}},
...
function lpa_reset_control(::Type{Float32}, ::Type{Int32}, control, data, status)
  @ccall libgalahad_single.lpa_reset_control_s(control::Ptr{lpa_control_type{Float32,Int32}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32})::Cvoid
end
...
function lpa_solve_lp(::Type{Float32}, ::Type{Int32}, data, status, n, m, g, f, a_ne, A_val,
  ...
  @ccall libgalahad_single.lpa_solve_lp_s(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
...
function lpa_solve_lp(::Type{Float128}, ::Type{Int32}, data, status, n, m, g, f, a_ne,
  ...
  @ccall libgalahad_quadruple.lpa_solve_lp_q(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
...
function run_sif(::Val{:lpa}, ::Val{:single}, path_libsif::String, path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runlpa_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:lpa}, ::Val{:double}, path_libsif::String, path_outsdif::String)
