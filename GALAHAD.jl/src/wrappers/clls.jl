...
function clls_import_s(control, data, status, n, o, m, 
...
function clls_solve_clls_s(data, status, n, o, m, Ao_ne, Ao_val, b, sigma,
                           a_ne, A_val, c_l, c_u, x_l, x_u, 
                           x, r, c, y, z, x_stat, c_stat, w)
  @ccall libgalahad_single.clls_solve_clls_s(data::Ptr{Ptr{Cvoid}}, 
                                          status::Ptr{Cint}, 
                                          n::Cint, o::Cint, m::Cint, 
...
function clls_solve_clls(data, status, n, o, m, Ao_ne, Ao_val, b, sigma,
                         a_ne, A_val, c_l, c_u, x_l, x_u, 
                         x, r, c, y, z, x_stat, c_stat, w)
  @ccall libgalahad_double.clls_solve_clls(data::Ptr{Ptr{Cvoid}}, 
                                        status::Ptr{Cint}, 
                                        n::Cint, o::Cint, m::Cint, 
