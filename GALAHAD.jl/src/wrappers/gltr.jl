...
function gltr_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64gltr_initialize(data::Ptr{Ptr{Cvoid}},
...
function gltr_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64gltr_read_specfile(control::Ptr{gltr_control_type{Float32,
                                                                               Int64}},
                                                specfile::Ptr{Cchar})::Cvoid
end
...
function gltr_import_control(::Type{Float32}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_single_64gltr_import_control(control::Ptr{gltr_control_type{Float32,
                                                                                Int64}},
                                                 data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function gltr_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, n, radius, x, r,
                            vector)
  @ccall libgalahad_single_64gltr_solve_problem(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int64},
...
function gltr_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64gltr_information(data::Ptr{Ptr{Cvoid}},
...
function gltr_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64gltr_terminate(data::Ptr{Ptr{Cvoid}},
                                            control::Ptr{gltr_control_type{Float32,Int64}},
