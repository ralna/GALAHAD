...
function arc_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.arc_initialize_s_64(data::Ptr{Ptr{Cvoid}},
...
function arc_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.arc_initialize_64(data::Ptr{Ptr{Cvoid}},
...
function arc_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.arc_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{arc_control_type{Float128,
                                                                                   Int64}},
                                                     status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function arc_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.arc_read_specfile_s_64(control::Ptr{arc_control_type{Float32,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function arc_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.arc_read_specfile_64(control::Ptr{arc_control_type{Float64,
                                                                                 Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function arc_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.arc_read_specfile_q_64(control::Ptr{arc_control_type{Float128,
                                                                                      Int64}},
                                                        specfile::Ptr{Cchar})::Cvoid
end
...
function arc_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.arc_information_s_64(data::Ptr{Ptr{Cvoid}},
...
function arc_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.arc_information_q_64(data::Ptr{Ptr{Cvoid}},
...
function arc_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.arc_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{arc_control_type{Float128,
                                                                                  Int64}},
                                                    inform::Ptr{arc_inform_type{Float128,
                                                                                Int64}})::Cvoid
