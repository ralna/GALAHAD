...
function wcp_initialize(::Type{Float128}, data, control, status)
...
function wcp_read_specfile(::Type{Float128}, control, specfile)
...
function wcp_import(::Type{Float128}, control, data, status, n, m, A_type, A_ne, A_row,
                    A_col, A_ptr)
...
function wcp_reset_control(::Type{Float128}, control, data, status)
...
function wcp_find_wcp(::Type{Float128}, data, status, n, m, g, a_ne, A_val, c_l, c_u, x_l,
                      x_u, x, c, y_l, y_u, z_l, z_u, x_stat, c_stat)
  @ccall libgalahad_quadruple.wcp_find_wcp_q(data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint},
                                             n::Cint, m::Cint, g::Ptr{Float128}, a_ne::Cint,
                                             ...
                                             z_u::Ptr{Float128}, x_stat::Ptr{Cint},
                                             c_stat::Ptr{Cint})::Cvoid
end
...
function wcp_information(::Type{Float128}, data, inform, status)
...
function wcp_terminate(::Type{Float128}, data, control, inform)
  @ccall libgalahad_quadruple.wcp_terminate_q(data::Ptr{Ptr{Cvoid}},
                                              control::Ptr{wcp_control_type{Float128}},
                                              inform::Ptr{wcp_inform_type{Float128}})::Cvoid
end
