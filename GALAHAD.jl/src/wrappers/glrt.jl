...
function glrt_import_control(::Type{Float32}, ::Type{Int32}, control, data,
                             status)
...
function glrt_import_control(::Type{Float32}, ::Type{Int64}, control, data,
                             status)
...
function glrt_import_control(::Type{Float64}, ::Type{Int32}, control, data,
                             status)
...
function glrt_import_control(::Type{Float64}, ::Type{Int64}, control, data,
                             status)
...
function glrt_import_control(::Type{Float128}, ::Type{Int32}, control, data,
                             status)
...
function glrt_import_control(::Type{Float128}, ::Type{Int64}, control, data,
                             status)
...
function glrt_solve_problem(::Type{Float32}, ::Type{Int32}, data, status, n,
                            power, weight, x, r, vector)
  @ccall libgalahad_single.glrt_solve_problem_s(data::Ptr{Ptr{Cvoid}},
...
function glrt_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, n,
                            power, weight, x, r, vector)
...
function glrt_solve_problem(::Type{Float64}, ::Type{Int32}, data, status, n,
                            power, weight, x, r, vector)
  @ccall libgalahad_double.glrt_solve_problem(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, n::Int32,
...
function glrt_solve_problem(::Type{Float64}, ::Type{Int64}, data, status, n,
                            power, weight, x, r, vector)
  @ccall libgalahad_double_64.glrt_solve_problem_64(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    n::Int64, power::Float64,
                                                    weight::Float64,
                                                    x::Ptr{Float64},
                                                    r::Ptr{Float64},
                                                    vector::Ptr{Float64})::Cvoid
...
function glrt_solve_problem(::Type{Float128}, ::Type{Int32}, data, status, n,
                            power, weight, x, r, vector)
...
function glrt_solve_problem(::Type{Float128}, ::Type{Int64}, data, status, n,
                            power, weight, x, r, vector)
...
function run_sif(::Val{:glrt}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runglrt_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:glrt}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runglrt_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
