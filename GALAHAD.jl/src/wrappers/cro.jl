...
function cro_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.cro_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{cro_control_type{Float32,
                                                                                Int64}},
...
function cro_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.cro_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{cro_control_type{Float64,
                                                                              Int64}},
                                                status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function cro_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.cro_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{cro_control_type{Float128,
                                                                                   Int64}},
                                                     status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function cro_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.cro_read_specfile_s_64(control::Ptr{cro_control_type{Float32,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function cro_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.cro_read_specfile_64(control::Ptr{cro_control_type{Float64,
                                                                                 Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function cro_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.cro_read_specfile_q_64(control::Ptr{cro_control_type{Float128,
                                                                                      Int64}},
                                                        specfile::Ptr{Cchar})::Cvoid
end
...
function cro_crossover_solution(::Type{Float32}, ::Type{Int32}, data, control,
                                inform, n, m, m_equal, h_ne, H_val, H_col,
                                H_ptr, a_ne, A_val, A_col, A_ptr, g, c_l, c_u,
...
function cro_crossover_solution(::Type{Float32}, ::Type{Int64}, data, control,
                                inform, n, m, m_equal, h_ne, H_val, H_col,
                                H_ptr, a_ne, A_val, A_col, A_ptr, g, c_l, c_u,
                                x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_single_64.cro_crossover_solution_s_64(data::Ptr{Ptr{Cvoid}},
                                                          control::Ptr{cro_control_type{Float32,
                                                                                        Int64}},
                                                          inform::Ptr{cro_inform_type{Float32,
                                                                                      Int64}},
...
function cro_crossover_solution(::Type{Float64}, ::Type{Int32}, data, control,
                                inform, n, m, m_equal, h_ne, H_val, H_col,
                                H_ptr, a_ne, A_val, A_col, A_ptr, g, c_l, c_u,
                                x_l, x_u, x, c, y, z, x_stat, c_stat)
...
function cro_crossover_solution(::Type{Float64}, ::Type{Int64}, data, control,
                                inform, n, m, m_equal, h_ne, H_val, H_col,
                                H_ptr, a_ne, A_val, A_col, A_ptr, g, c_l, c_u,
                                x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_double_64.cro_crossover_solution_64(data::Ptr{Ptr{Cvoid}},
                                                        control::Ptr{cro_control_type{Float64,
                                                                                      Int64}},
                                                        inform::Ptr{cro_inform_type{Float64,
                                                                                    Int64}},
...
function cro_crossover_solution(::Type{Float128}, ::Type{Int32}, data, control,
                                inform, n, m, m_equal, h_ne, H_val, H_col,
                                H_ptr, a_ne, A_val, A_col, A_ptr, g, c_l, c_u,
                                x_l, x_u, x, c, y, z, x_stat, c_stat)
...
function cro_crossover_solution(::Type{Float128}, ::Type{Int64}, data, control,
                                inform, n, m, m_equal, h_ne, H_val, H_col,
                                H_ptr, a_ne, A_val, A_col, A_ptr, g, c_l, c_u,
                                x_l, x_u, x, c, y, z, x_stat, c_stat)
  @ccall libgalahad_quadruple_64.cro_crossover_solution_q_64(data::Ptr{Ptr{Cvoid}},
                                                             control::Ptr{cro_control_type{Float128,
                                                                                           Int64}},
                                                             inform::Ptr{cro_inform_type{Float128,
                                                                                         Int64}},
...
function cro_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.cro_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{cro_control_type{Float32,
                                                                               Int64}},
                                                 inform::Ptr{cro_inform_type{Float32,
                                                                             Int64}})::Cvoid
...
function cro_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.cro_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{cro_control_type{Float64,
                                                                             Int64}},
                                               inform::Ptr{cro_inform_type{Float64,
                                                                           Int64}})::Cvoid
...
function cro_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.cro_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{cro_control_type{Float128,
                                                                                  Int64}},
                                                    inform::Ptr{cro_inform_type{Float128,
                                                                                Int64}})::Cvoid
