...
function tru_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.tru_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{tru_control_type{Float32,
                                                                                Int64}},
...
function tru_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.tru_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{tru_control_type{Float64,
                                                                              Int64}},
                                                status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function tru_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.tru_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{tru_control_type{Float128,
                                                                                   Int64}},
                                                     status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function tru_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.tru_read_specfile_s_64(control::Ptr{tru_control_type{Float32,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function tru_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.tru_read_specfile_64(control::Ptr{tru_control_type{Float64,
                                                                                 Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function tru_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.tru_read_specfile_q_64(control::Ptr{tru_control_type{Float128,
                                                                                      Int64}},
                                                        specfile::Ptr{Cchar})::Cvoid
end
...
function tru_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
...
function tru_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                    H_type, ne, H_row, H_col, H_ptr)
  @ccall libgalahad_single_64.tru_import_s_64(control::Ptr{tru_control_type{Float32,
                                                                            Int64}},
                                              data::Ptr{Ptr{Cvoid}},
...
function tru_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                    H_type, ne, H_row, H_col, H_ptr)
...
function tru_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                    H_type, ne, H_row, H_col, H_ptr)
  @ccall libgalahad_double_64.tru_import_64(control::Ptr{tru_control_type{Float64,
                                                                          Int64}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int64}, n::Int64,
                                            H_type::Ptr{Cchar}, ne::Int64,
...
function tru_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                    H_type, ne, H_row, H_col, H_ptr)
...
function tru_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                    H_type, ne, H_row, H_col, H_ptr)
  @ccall libgalahad_quadruple_64.tru_import_q_64(control::Ptr{tru_control_type{Float128,
                                                                               Int64}},
                                                 data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64}, n::Int64,
                                                 H_type::Ptr{Cchar}, ne::Int64,
...
function tru_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function tru_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_single_64.tru_reset_control_s_64(control::Ptr{tru_control_type{Float32,
                                                                                   Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end

function tru_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function tru_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_double_64.tru_reset_control_64(control::Ptr{tru_control_type{Float64,
                                                                                 Int64}},
                                                   data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64})::Cvoid
end

function tru_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function tru_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_quadruple_64.tru_reset_control_q_64(control::Ptr{tru_control_type{Float128,
                                                                                      Int64}},
                                                        data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64})::Cvoid
end
...
function tru_solve_with_mat(::Type{Float32}, ::Type{Int32}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_prec)
  @ccall libgalahad_single.tru_solve_with_mat_s(data::Ptr{Ptr{Cvoid}},
                                                userdata::Ptr{Cvoid},
                                                status::Ptr{Int32}, n::Int32,
                                                x::Ptr{Float32},
...
function tru_solve_with_mat(::Type{Float32}, ::Type{Int64}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_prec)
  @ccall libgalahad_single_64.tru_solve_with_mat_s_64(data::Ptr{Ptr{Cvoid}},
                                                      userdata::Ptr{Cvoid},
                                                      status::Ptr{Int64},
...
function tru_solve_with_mat(::Type{Float64}, ::Type{Int32}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_prec)
  @ccall libgalahad_double.tru_solve_with_mat(data::Ptr{Ptr{Cvoid}},
                                              userdata::Ptr{Cvoid},
                                              status::Ptr{Int32}, n::Int32,
...
function tru_solve_with_mat(::Type{Float64}, ::Type{Int64}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_prec)
  @ccall libgalahad_double_64.tru_solve_with_mat_64(data::Ptr{Ptr{Cvoid}},
                                                    userdata::Ptr{Cvoid},
                                                    status::Ptr{Int64},
...
function tru_solve_with_mat(::Type{Float128}, ::Type{Int32}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_prec)
...
function tru_solve_with_mat(::Type{Float128}, ::Type{Int64}, data, userdata,
                            status, n, x, g, ne, eval_f, eval_g, eval_h,
                            eval_prec)
  @ccall libgalahad_quadruple_64.tru_solve_with_mat_q_64(data::Ptr{Ptr{Cvoid}},
                                                         userdata::Ptr{Cvoid},
                                                         status::Ptr{Int64},
                                                         n::Int64,
                                                         x::Ptr{Float128},
...
function tru_solve_without_mat(::Type{Float32}, ::Type{Int32}, data, userdata,
...
function tru_solve_without_mat(::Type{Float32}, ::Type{Int64}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_prec)
  @ccall libgalahad_single_64.tru_solve_without_mat_s_64(data::Ptr{Ptr{Cvoid}},
                                                         userdata::Ptr{Cvoid},
                                                         status::Ptr{Int64},
                                                         n::Int64,
                                                         x::Ptr{Float32},
...
function tru_solve_without_mat(::Type{Float64}, ::Type{Int32}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_prec)
...
function tru_solve_without_mat(::Type{Float64}, ::Type{Int64}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_prec)
  @ccall libgalahad_double_64.tru_solve_without_mat_64(data::Ptr{Ptr{Cvoid}},
                                                       userdata::Ptr{Cvoid},
                                                       status::Ptr{Int64},
                                                       n::Int64,
                                                       x::Ptr{Float64},
...
function tru_solve_without_mat(::Type{Float128}, ::Type{Int32}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_prec)
...
function tru_solve_without_mat(::Type{Float128}, ::Type{Int64}, data, userdata,
                               status, n, x, g, eval_f, eval_g, eval_hprod,
                               eval_prec)
  @ccall libgalahad_quadruple_64.tru_solve_without_mat_q_64(data::Ptr{Ptr{Cvoid}},
                                                            userdata::Ptr{Cvoid},
                                                            status::Ptr{Int64},
                                                            n::Int64,
                                                            x::Ptr{Float128},
...
function tru_solve_reverse_with_mat(::Type{Float32}, ::Type{Int32}, data,
...
function tru_solve_reverse_with_mat(::Type{Float32}, ::Type{Int64}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
  @ccall libgalahad_single_64.tru_solve_reverse_with_mat_s_64(data::Ptr{Ptr{Cvoid}},
                                                              status::Ptr{Int64},
...
function tru_solve_reverse_with_mat(::Type{Float64}, ::Type{Int32}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
...
function tru_solve_reverse_with_mat(::Type{Float64}, ::Type{Int64}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
  @ccall libgalahad_double_64.tru_solve_reverse_with_mat_64(data::Ptr{Ptr{Cvoid}},
                                                            status::Ptr{Int64},
                                                            eval_status::Ptr{Int64},
                                                            n::Int64,
                                                            x::Ptr{Float64},
...
function tru_solve_reverse_with_mat(::Type{Float128}, ::Type{Int32}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
...
function tru_solve_reverse_with_mat(::Type{Float128}, ::Type{Int64}, data,
                                    status, eval_status, n, x, f, g, ne, H_val,
                                    u, v)
  @ccall libgalahad_quadruple_64.tru_solve_reverse_with_mat_q_64(data::Ptr{Ptr{Cvoid}},
                                                                 status::Ptr{Int64},
                                                                 eval_status::Ptr{Int64},
                                                                 n::Int64,
                                                                 x::Ptr{Float128},
...
function tru_solve_reverse_without_mat(::Type{Float32}, ::Type{Int32}, data,
...
function tru_solve_reverse_without_mat(::Type{Float32}, ::Type{Int64}, data,
                                       status, eval_status, n, x, f, g, u, v)
  @ccall libgalahad_single_64.tru_solve_reverse_without_mat_s_64(data::Ptr{Ptr{Cvoid}},
                                                                 status::Ptr{Int64},
                                                                 eval_status::Ptr{Int64},
                                                                 n::Int64,
                                                                 x::Ptr{Float32},
...
function tru_solve_reverse_without_mat(::Type{Float64}, ::Type{Int32}, data,
                                       status, eval_status, n, x, f, g, u, v)
...
function tru_solve_reverse_without_mat(::Type{Float64}, ::Type{Int64}, data,
                                       status, eval_status, n, x, f, g, u, v)
  @ccall libgalahad_double_64.tru_solve_reverse_without_mat_64(data::Ptr{Ptr{Cvoid}},
                                                               status::Ptr{Int64},
                                                               eval_status::Ptr{Int64},
                                                               n::Int64,
                                                               x::Ptr{Float64},
...
function tru_solve_reverse_without_mat(::Type{Float128}, ::Type{Int32}, data,
                                       status, eval_status, n, x, f, g, u, v)
...
function tru_solve_reverse_without_mat(::Type{Float128}, ::Type{Int64}, data,
                                       status, eval_status, n, x, f, g, u, v)
  @ccall libgalahad_quadruple_64.tru_solve_reverse_without_mat_q_64(data::Ptr{Ptr{Cvoid}},
                                                                    status::Ptr{Int64},
                                                                    eval_status::Ptr{Int64},
                                                                    n::Int64,
                                                                    x::Ptr{Float128},
...
function tru_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.tru_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                   inform::Ptr{tru_inform_type{Float32,
                                                                               Int64}},
                                                   status::Ptr{Int64})::Cvoid
end
...
function tru_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.tru_information_64(data::Ptr{Ptr{Cvoid}},
                                                 inform::Ptr{tru_inform_type{Float64,
                                                                             Int64}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function tru_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.tru_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                      inform::Ptr{tru_inform_type{Float128,
                                                                                  Int64}},
                                                      status::Ptr{Int64})::Cvoid
end
...
function tru_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.tru_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{tru_control_type{Float32,
                                                                               Int64}},
                                                 inform::Ptr{tru_inform_type{Float32,
                                                                             Int64}})::Cvoid
...
function tru_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.tru_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{tru_control_type{Float64,
                                                                             Int64}},
                                               inform::Ptr{tru_inform_type{Float64,
                                                                           Int64}})::Cvoid
...
function tru_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.tru_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{tru_control_type{Float128,
                                                                                  Int64}},
                                                    inform::Ptr{tru_inform_type{Float128,
                                                                                Int64}})::Cvoid
...
function run_sif(::Val{:tru}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runtru_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:tru}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runtru_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
