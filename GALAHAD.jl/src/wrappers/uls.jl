...
function uls_initialize(::Type{Float32}, ::Type{Int64}, solver, data, control, status)
  @ccall libgalahad_single_64.uls_initialize_s(solver::Ptr{Cchar}, data::Ptr{Ptr{Cvoid}},
...
function uls_initialize(::Type{Float128}, ::Type{Int64}, solver, data, control, status)
  @ccall libgalahad_quadruple_64.uls_initialize_q(solver::Ptr{Cchar}, data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{uls_control_type{Float128,
                                                                                Int64}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function uls_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.uls_read_specfile_s(control::Ptr{uls_control_type{Float32,
                                                                                Int64}},
                                                  specfile::Ptr{Cchar})::Cvoid
end
...
function uls_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.uls_read_specfile_q(control::Ptr{uls_control_type{Float128,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function uls_factorize_matrix(::Type{Float32}, ::Type{Int64}, control, data, status, m, n,
                              type, ne, val, row, col, ptr)
  @ccall libgalahad_single_64.uls_factorize_matrix_s(control::Ptr{uls_control_type{Float32,
                                                                                   Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
...
function uls_factorize_matrix(::Type{Float128}, ::Type{Int64}, control, data, status, m, n,
                              type, ne, val, row, col, ptr)
  @ccall libgalahad_quadruple_64.uls_factorize_matrix_q(control::Ptr{uls_control_type{Float128,
                                                                                      Int64}},
                                                        data::Ptr{Ptr{Cvoid}},
...
function uls_reset_control(::Type{Float32}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_single_64.uls_reset_control_s(control::Ptr{uls_control_type{Float32,
                                                                                Int64}},
                                                  data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function uls_reset_control(::Type{Float128}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_quadruple_64.uls_reset_control_q(control::Ptr{uls_control_type{Float128,
                                                                                   Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end
...
function uls_solve_system(::Type{Float32}, ::Type{Int64}, data, status, m, n, sol, trans)
  @ccall libgalahad_single_64.uls_solve_system_s(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int64},
...
function uls_solve_system(::Type{Float128}, ::Type{Int64}, data, status, m, n, sol, trans)
  @ccall libgalahad_quadruple_64.uls_solve_system_q(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64}, m::Int64, n::Int64,
                                                    sol::Ptr{Float128}, trans::Bool)::Cvoid
end
...
function uls_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.uls_information_s(data::Ptr{Ptr{Cvoid}},
...
function uls_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.uls_information_q(data::Ptr{Ptr{Cvoid}},
...
function uls_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.uls_terminate_s(data::Ptr{Ptr{Cvoid}},
                                              control::Ptr{uls_control_type{Float32,Int64}},
...
function uls_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.uls_terminate_q(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{uls_control_type{Float128,
                                                                               Int64}},
                                                 inform::Ptr{uls_inform_type{Float128,
                                                                             Int64}})::Cvoid
