...
function nrek_read_specfile(::Type{Float64}, ::Type{Int32}, control, specfile)
  @ccall libgalahad_double.nrek_read_specfile(control::Ptr{nrek_control_type{Float64,
                                                                             Int32}},
                                              specfile::Ptr{Cchar})::Cvoid
end
...
function nrek_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_single.nrek_import_s(control::Ptr{nrek_control_type{Float32,
                                                                        Int32}},
                                         data::Ptr{Ptr{Cvoid}},
...
function nrek_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
...
function nrek_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_double.nrek_import(control::Ptr{nrek_control_type{Float64,
                                                                      Int32}},
                                       data::Ptr{Ptr{Cvoid}},
                                       status::Ptr{Int32}, n::Int32,
                                       H_type::Ptr{Cchar}, H_ne::Int32,
...
function nrek_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_double_64.nrek_import_64(control::Ptr{nrek_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64}, n::Int64,
                                             H_type::Ptr{Cchar}, H_ne::Int64,
...
function nrek_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_quadruple.nrek_import_q(control::Ptr{nrek_control_type{Float128,
                                                                           Int32}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int32}, n::Int32,
                                            H_type::Ptr{Cchar}, H_ne::Int32,
...
function nrek_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
...
function nrek_s_import(::Type{Float32}, ::Type{Int32}, data, status, n, S_type,
                       S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_single.nrek_s_import_s(data::Ptr{Ptr{Cvoid}},
                                           status::Ptr{Int32}, n::Int32,
...
function nrek_s_import(::Type{Float32}, ::Type{Int64}, data, status, n, S_type,
                       S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_single_64.nrek_s_import_s_64(data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64}, n::Int64,
                                                 S_type::Ptr{Cchar},
...
function nrek_s_import(::Type{Float64}, ::Type{Int32}, data, status, n, S_type,
                       S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_double.nrek_s_import(data::Ptr{Ptr{Cvoid}},
                                         status::Ptr{Int32}, n::Int32,
                                         S_type::Ptr{Cchar}, S_ne::Int32,
                                         S_row::Ptr{Int32}, S_col::Ptr{Int32},
                                         S_ptr::Ptr{Int32})::Cvoid
...
function nrek_s_import(::Type{Float64}, ::Type{Int64}, data, status, n, S_type,
                       S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_double_64.nrek_s_import_64(data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int64}, n::Int64,
...
function nrek_s_import(::Type{Float128}, ::Type{Int32}, data, status, n, S_type,
                       S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_quadruple.nrek_s_import_q(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, n::Int32,
                                              S_type::Ptr{Cchar}, S_ne::Int32,
                                              S_row::Ptr{Int32},
                                              S_col::Ptr{Int32},
...
function nrek_s_import(::Type{Float128}, ::Type{Int64}, data, status, n, S_type,
                       S_ne, S_row, S_col, S_ptr)
...
function nrek_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function nrek_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
...
function nrek_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
  @ccall libgalahad_double.nrek_reset_control(control::Ptr{nrek_control_type{Float64,
                                                                             Int32}},
                                              data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32})::Cvoid
end

function nrek_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
...
function nrek_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function nrek_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
...
function nrek_solve_problem(::Type{Float32}, ::Type{Int32}, data, status, n,
                            H_ne, H_val, c, power, weight, x, S_ne, S_val)
  @ccall libgalahad_single.nrek_solve_problem_s(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int32}, n::Int32,
                                                H_ne::Int32,
                                                H_val::Ptr{Float32},
...
function nrek_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, n,
                            H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float64}, ::Type{Int32}, data, status, n,
                            H_ne, H_val, c, power, weight, x, S_ne, S_val)
  @ccall libgalahad_double.nrek_solve_problem(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, n::Int32,
...
function nrek_solve_problem(::Type{Float64}, ::Type{Int64}, data, status, n,
                            H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float128}, ::Type{Int32}, data, status, n,
                            H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float128}, ::Type{Int64}, data, status, n,
                            H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function run_sif(::Val{:nrek}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
...
function run_sif(::Val{:nrek}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
