...
function nrek_read_specfile(::Type{Float32}, ::Type{Int32}, control, specfile)
  @ccall libgalahad_single.nrek_read_specfile_s(control::Ptr{nrek_control_type{Float32,Int32}},
...
function nrek_import(::Type{Float32}, ::Type{Int32}, control, data, status, n, H_type, H_ne,
                    H_row, H_col, H_ptr)
  @ccall libgalahad_single.nrek_s_import(control::Ptr{nrek_control_type{Float32,Int32}},
...
function nrek_import(::Type{Float32}, ::Type{Int64}, control, data, status, n, H_type, H_ne,
                    H_row, H_col, H_ptr)
  @ccall libgalahad_single_64.nrek_s_import_64(control::Ptr{nrek_control_type{Float32,Int64}},
...
function nrek_import(::Type{Float128}, ::Type{Int32}, control, data, status, n, H_type, H_ne,
                    H_row, H_col, H_ptr)
...
function nrek_import(::Type{Float128}, ::Type{Int64}, control, data, status, n, H_type, H_ne,
                    H_row, H_col, H_ptr)
...
function nrek_s_import(::Type{Float64}, ::Type{Int32}, data, status, n, S_type, S_ne, S_row,
                      S_col, S_ptr)
  @ccall libgalahad_double.nrek_s_import(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32}, n::Int32,
...
function nrek_s_import(::Type{Float128}, ::Type{Int32}, data, status, n, S_type, S_ne, S_row,
                      S_col, S_ptr)
...
function nrek_s_import(::Type{Float128}, ::Type{Int64}, data, status, n, S_type, S_ne, S_row,
                      S_col, S_ptr)
...
function nrek_reset_control(::Type{Float32}, ::Type{Int32}, control, data, status)
  @ccall libgalahad_single.nrek_reset_control_s(control::Ptr{nrek_control_type{Float32,Int32}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32})::Cvoid
end
...
function nrek_solve_problem(::Type{Float32}, ::Type{Int32}, data, status,
                            n, H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float32}, ::Type{Int64}, data, status,
                            n, H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float64}, ::Type{Int32}, data, status,
                            n, H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float64}, ::Type{Int64}, data, status,
                            n, H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float128}, ::Type{Int32}, data, status,
                            n, H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_solve_problem(::Type{Float128}, ::Type{Int64}, data, status,
                            n, H_ne, H_val, c, power, weight, x, S_ne, S_val)
...
function nrek_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.nrek_information_64(data::Ptr{Ptr{Cvoid}},
                                                 inform::Ptr{nrek_inform_type{Float64,Int64}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function nrek_information(::Type{Float128}, ::Type{Int32}, data, inform, status)
  @ccall libgalahad_quadruple.nrek_information_q(data::Ptr{Ptr{Cvoid}},
                                                inform::Ptr{nrek_inform_type{Float128,Int32}},
                                                status::Ptr{Int32})::Cvoid
end
...
function nrek_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.nrek_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{nrek_control_type{Float32,
                                                                               Int64}},
                                                 inform::Ptr{nrek_inform_type{Float32,Int64}})::Cvoid
end
...
function nrek_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.nrek_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{nrek_control_type{Float64,Int64}},
...
function nrek_terminate(::Type{Float128}, ::Type{Int32}, data, control, inform)
  @ccall libgalahad_quadruple.nrek_terminate_q(data::Ptr{Ptr{Cvoid}},
                                              control::Ptr{nrek_control_type{Float128,Int32}},
