...
function blls_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.blls_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                   control::Ptr{blls_control_type{Float32,
                                                                                  Int64}},
...
function blls_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.blls_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{blls_control_type{Float64,
                                                                                Int64}},
                                                 status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function blls_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.blls_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                      control::Ptr{blls_control_type{Float128,
                                                                                     Int64}},
                                                      status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function blls_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.blls_read_specfile_s_64(control::Ptr{blls_control_type{Float32,
                                                                                     Int64}},
                                                      specfile::Ptr{Cchar})::Cvoid
end
...
function blls_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.blls_read_specfile_64(control::Ptr{blls_control_type{Float64,
                                                                                   Int64}},
                                                    specfile::Ptr{Cchar})::Cvoid
end
...
function blls_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.blls_read_specfile_q_64(control::Ptr{blls_control_type{Float128,
                                                                                        Int64}},
                                                         specfile::Ptr{Cchar})::Cvoid
end
...
function blls_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
                     o, Ao_type, Ao_ne, Ao_row, Ao_col, Ao_ptr_ne, Ao_ptr)
...
function blls_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                     o, Ao_type, Ao_ne, Ao_row, Ao_col, Ao_ptr_ne, Ao_ptr)
  @ccall libgalahad_single_64.blls_import_s_64(control::Ptr{blls_control_type{Float32,
                                                                              Int64}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int64}, n::Int64,
                                               o::Int64, Ao_type::Ptr{Cchar},
...
function blls_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                     o, Ao_type, Ao_ne, Ao_row, Ao_col, Ao_ptr_ne, Ao_ptr)
...
function blls_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                     o, Ao_type, Ao_ne, Ao_row, Ao_col, Ao_ptr_ne, Ao_ptr)
  @ccall libgalahad_double_64.blls_import_64(control::Ptr{blls_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64}, n::Int64,
                                             o::Int64, Ao_type::Ptr{Cchar},
...
function blls_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                     o, Ao_type, Ao_ne, Ao_row, Ao_col, Ao_ptr_ne, Ao_ptr)
  @ccall libgalahad_quadruple_64.blls_import_q_64(control::Ptr{blls_control_type{Float128,
                                                                                 Int64}},
                                                  data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64}, n::Int64,
                                                  o::Int64, Ao_type::Ptr{Cchar},
...
function blls_import_without_a(::Type{Float32}, ::Type{Int32}, control, data,
                               status, n, o)
...
function blls_import_without_a(::Type{Float32}, ::Type{Int64}, control, data,
                               status, n, o)
  @ccall libgalahad_single_64.blls_import_without_a_s_64(control::Ptr{blls_control_type{Float32,
                                                                                        Int64}},
                                                         data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64},
                                                         n::Int64,
...
function blls_import_without_a(::Type{Float64}, ::Type{Int32}, control, data,
                               status, n, o)
...
function blls_import_without_a(::Type{Float64}, ::Type{Int64}, control, data,
                               status, n, o)
  @ccall libgalahad_double_64.blls_import_without_a_64(control::Ptr{blls_control_type{Float64,
                                                                                      Int64}},
                                                       data::Ptr{Ptr{Cvoid}},
                                                       status::Ptr{Int64},
                                                       n::Int64,
...
function blls_import_without_a(::Type{Float128}, ::Type{Int32}, control, data,
                               status, n, o)
...
function blls_import_without_a(::Type{Float128}, ::Type{Int64}, control, data,
                               status, n, o)
  @ccall libgalahad_quadruple_64.blls_import_without_a_q_64(control::Ptr{blls_control_type{Float128,
                                                                                           Int64}},
                                                            data::Ptr{Ptr{Cvoid}},
                                                            status::Ptr{Int64},
                                                            n::Int64,
...
function blls_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function blls_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_single_64.blls_reset_control_s_64(control::Ptr{blls_control_type{Float32,
                                                                                     Int64}},
                                                      data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64})::Cvoid
end

function blls_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
...
function blls_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_double_64.blls_reset_control_64(control::Ptr{blls_control_type{Float64,
                                                                                   Int64}},
                                                    data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64})::Cvoid
end

function blls_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function blls_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_quadruple_64.blls_reset_control_q_64(control::Ptr{blls_control_type{Float128,
                                                                                        Int64}},
                                                         data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64})::Cvoid
end
...
function blls_solve_given_a(::Type{Float32}, ::Type{Int32}, data, userdata,
                            status, n, o, Ao_ne, Ao_val, b,
                            regularization_weight, x_l, x_u, x, z, r, g, x_stat,
                            w, x_s, eval_prec)
  @ccall libgalahad_single.blls_solve_given_a_s(data::Ptr{Ptr{Cvoid}},
                                                userdata::Ptr{Cvoid},
                                                status::Ptr{Int32}, n::Int32,
                                                o::Int32, Ao_ne::Int32,
                                                Ao_val::Ptr{Float32},
...
function blls_solve_given_a(::Type{Float32}, ::Type{Int64}, data, userdata,
                            status, n, o, Ao_ne, Ao_val, b,
                            regularization_weight, x_l, x_u, x, z, r, g, x_stat,
                            w, x_s, eval_prec)
  @ccall libgalahad_single_64.blls_solve_given_a_s_64(data::Ptr{Ptr{Cvoid}},
                                                      userdata::Ptr{Cvoid},
                                                      status::Ptr{Int64},
                                                      n::Int64, o::Int64,
                                                      Ao_ne::Int64,
...
function blls_solve_given_a(::Type{Float64}, ::Type{Int32}, data, userdata,
                            status, n, o, Ao_ne, Ao_val, b,
                            regularization_weight, x_l, x_u, x, z, r, g, x_stat,
                            w, x_s, eval_prec)
  @ccall libgalahad_double.blls_solve_given_a(data::Ptr{Ptr{Cvoid}},
                                              userdata::Ptr{Cvoid},
                                              status::Ptr{Int32}, n::Int32,
                                              o::Int32, Ao_ne::Int32,
                                              Ao_val::Ptr{Float64},
...
function blls_solve_given_a(::Type{Float64}, ::Type{Int64}, data, userdata,
                            status, n, o, Ao_ne, Ao_val, b,
                            regularization_weight, x_l, x_u, x, z, r, g, x_stat,
                            w, x_s, eval_prec)
  @ccall libgalahad_double_64.blls_solve_given_a_64(data::Ptr{Ptr{Cvoid}},
                                                    userdata::Ptr{Cvoid},
                                                    status::Ptr{Int64},
                                                    n::Int64, o::Int64,
                                                    Ao_ne::Int64,
...
function blls_solve_given_a(::Type{Float128}, ::Type{Int32}, data, userdata,
                            status, n, o, Ao_ne, Ao_val, b,
                            regularization_weight, x_l, x_u, x, z, r, g, x_stat,
                            w, x_s, eval_prec)
...
function blls_solve_given_a(::Type{Float128}, ::Type{Int64}, data, userdata,
                            status, n, o, Ao_ne, Ao_val, b,
                            regularization_weight, x_l, x_u, x, z, r, g, x_stat,
                            w, x_s, eval_prec)
  @ccall libgalahad_quadruple_64.blls_solve_given_a_q_64(data::Ptr{Ptr{Cvoid}},
                                                         userdata::Ptr{Cvoid},
                                                         status::Ptr{Int64},
                                                         n::Int64, o::Int64,
                                                         Ao_ne::Int64,
...
function blls_solve_reverse_a_prod(::Type{Float32}, ::Type{Int32}, data, status,
                                   eval_status, n, o, b, regularization_weight,
                                   x_l, x_u, x, z, r, g, x_stat, v, p, nz_v,
                                   nz_v_start, nz_v_end, nz_p, nz_p_end, w, x_s)
...
function blls_solve_reverse_a_prod(::Type{Float32}, ::Type{Int64}, data, status,
                                   ...
                                   x_l, x_u, x, z, r, g, x_stat, v, p, nz_v,
                                   nz_v_start, nz_v_end, nz_p, nz_p_end, w, x_s)
  @ccall libgalahad_single_64.blls_solve_reverse_a_prod_s_64(data::Ptr{Ptr{Cvoid}},
                                                             status::Ptr{Int64},
...
function blls_solve_reverse_a_prod(::Type{Float64}, ::Type{Int64}, data, status,
                                   ...
                                   x_l, x_u, x, z, r, g, x_stat, v, p, nz_v,
                                   nz_v_start, nz_v_end, nz_p, nz_p_end, w, x_s)
  @ccall libgalahad_double_64.blls_solve_reverse_a_prod_64(data::Ptr{Ptr{Cvoid}},
                                                           status::Ptr{Int64},
                                                           eval_status::Ptr{Int64},
                                                           n::Int64, o::Int64,
                                                           b::Ptr{Float64},
...
function blls_solve_reverse_a_prod(::Type{Float128}, ::Type{Int32}, data,
                                   status, eval_status, n, o, b,
                                   regularization_weight, x_l, x_u, x, z, r, g,
                                   x_stat, v, p, nz_v, nz_v_start, nz_v_end,
                                   nz_p, nz_p_end, w, x_s)
...
function blls_solve_reverse_a_prod(::Type{Float128}, ::Type{Int64}, data,
                                   status, eval_status, n, o, b,
                                   regularization_weight, x_l, x_u, x, z, r, g,
                                   x_stat, v, p, nz_v, nz_v_start, nz_v_end,
                                   nz_p, nz_p_end, w, x_s)
  @ccall libgalahad_quadruple_64.blls_solve_reverse_a_prod_q_64(data::Ptr{Ptr{Cvoid}},
                                                                status::Ptr{Int64},
                                                                eval_status::Ptr{Int64},
                                                                n::Int64,
                                                                o::Int64,
...
function blls_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.blls_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                    inform::Ptr{blls_inform_type{Float32,
                                                                                 Int64}},
                                                    status::Ptr{Int64})::Cvoid
end
...
function blls_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.blls_information_64(data::Ptr{Ptr{Cvoid}},
                                                  inform::Ptr{blls_inform_type{Float64,
                                                                               Int64}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function blls_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.blls_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                       inform::Ptr{blls_inform_type{Float128,
                                                                                    Int64}},
                                                       status::Ptr{Int64})::Cvoid
end
...
function blls_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.blls_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{blls_control_type{Float32,
                                                                                 Int64}},
                                                  inform::Ptr{blls_inform_type{Float32,
                                                                               Int64}})::Cvoid
...
function blls_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.blls_terminate_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{blls_control_type{Float64,
                                                                               Int64}},
                                                inform::Ptr{blls_inform_type{Float64,
                                                                             Int64}})::Cvoid
...
function blls_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.blls_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{blls_control_type{Float128,
                                                                                    Int64}},
                                                     inform::Ptr{blls_inform_type{Float128,
                                                                                  Int64}})::Cvoid
...
function run_sif(::Val{:blls}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runblls_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:blls}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runblls_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
