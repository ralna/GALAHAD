...
function trs_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
...
function trs_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                    H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_single_64.trs_import_s_64(control::Ptr{trs_control_type{Float32,
                                                                            Int64}},
                                              data::Ptr{Ptr{Cvoid}},
...
function trs_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                    H_type, H_ne, H_row, H_col, H_ptr)
...
function trs_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                    H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_double_64.trs_import_64(control::Ptr{trs_control_type{Float64,
                                                                          Int64}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int64}, n::Int64,
                                            H_type::Ptr{Cchar}, H_ne::Int64,
...
function trs_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                    H_type, H_ne, H_row, H_col, H_ptr)
...
function trs_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                    H_type, H_ne, H_row, H_col, H_ptr)
...
function trs_import_m(::Type{Float32}, ::Type{Int32}, data, status, n, M_type,
                      M_ne, M_row, M_col, M_ptr)
  @ccall libgalahad_single.trs_import_m_s(data::Ptr{Ptr{Cvoid}},
                                          status::Ptr{Int32}, n::Int32,
...
function trs_import_m(::Type{Float32}, ::Type{Int64}, data, status, n, M_type,
                      M_ne, M_row, M_col, M_ptr)
  @ccall libgalahad_single_64.trs_import_m_s_64(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int64}, n::Int64,
...
function trs_import_m(::Type{Float64}, ::Type{Int32}, data, status, n, M_type,
                      M_ne, M_row, M_col, M_ptr)
  @ccall libgalahad_double.trs_import_m(data::Ptr{Ptr{Cvoid}},
                                        status::Ptr{Int32}, n::Int32,
                                        M_type::Ptr{Cchar}, M_ne::Int32,
                                        M_row::Ptr{Int32}, M_col::Ptr{Int32},
                                        M_ptr::Ptr{Int32})::Cvoid
...
function trs_import_m(::Type{Float64}, ::Type{Int64}, data, status, n, M_type,
                      M_ne, M_row, M_col, M_ptr)
  @ccall libgalahad_double_64.trs_import_m_64(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int64}, n::Int64,
                                              M_type::Ptr{Cchar}, M_ne::Int64,
                                              M_row::Ptr{Int64},
                                              M_col::Ptr{Int64},
...
function trs_import_m(::Type{Float128}, ::Type{Int32}, data, status, n, M_type,
                      M_ne, M_row, M_col, M_ptr)
  @ccall libgalahad_quadruple.trs_import_m_q(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32}, n::Int32,
                                             M_type::Ptr{Cchar}, M_ne::Int32,
                                             M_row::Ptr{Int32},
                                             M_col::Ptr{Int32},
...
function trs_import_m(::Type{Float128}, ::Type{Int64}, data, status, n, M_type,
                      M_ne, M_row, M_col, M_ptr)
...
function trs_import_a(::Type{Float32}, ::Type{Int32}, data, status, m, A_type,
                      A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_single.trs_import_a_s(data::Ptr{Ptr{Cvoid}},
...
function trs_import_a(::Type{Float32}, ::Type{Int64}, data, status, m, A_type,
                      A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_single_64.trs_import_a_s_64(data::Ptr{Ptr{Cvoid}},
...
function trs_import_a(::Type{Float64}, ::Type{Int32}, data, status, m, A_type,
                      A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_double.trs_import_a(data::Ptr{Ptr{Cvoid}},
                                        status::Ptr{Int32}, m::Int32,
                                        A_type::Ptr{Cchar}, A_ne::Int32,
                                        A_row::Ptr{Int32}, A_col::Ptr{Int32},
                                        A_ptr::Ptr{Int32})::Cvoid
...
function trs_import_a(::Type{Float64}, ::Type{Int64}, data, status, m, A_type,
                      A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_double_64.trs_import_a_64(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int64}, m::Int64,
                                              A_type::Ptr{Cchar}, A_ne::Int64,
                                              A_row::Ptr{Int64},
                                              A_col::Ptr{Int64},
...
function trs_import_a(::Type{Float128}, ::Type{Int32}, data, status, m, A_type,
                      A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_quadruple.trs_import_a_q(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32}, m::Int32,
                                             A_type::Ptr{Cchar}, A_ne::Int32,
                                             A_row::Ptr{Int32},
                                             A_col::Ptr{Int32},
...
function trs_import_a(::Type{Float128}, ::Type{Int64}, data, status, m, A_type,
                      A_ne, A_row, A_col, A_ptr)
...
function trs_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function trs_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
...
function trs_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function trs_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
...
function trs_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function trs_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
...
function trs_solve_problem(::Type{Float32}, ::Type{Int32}, data, status, n,
                           radius, f, c, H_ne, H_val, x, M_ne, M_val, m, A_ne,
                           A_val, y)
  @ccall libgalahad_single.trs_solve_problem_s(data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32}, n::Int32,
...
function trs_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, n,
                           radius, f, c, H_ne, H_val, x, M_ne, M_val, m, A_ne,
                           A_val, y)
  @ccall libgalahad_single_64.trs_solve_problem_s_64(data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64},
                                                     n::Int64, radius::Float32,
                                                     f::Float32,
                                                     c::Ptr{Float32},
                                                     H_ne::Int64,
                                                     H_val::Ptr{Float32},
...
function trs_solve_problem(::Type{Float64}, ::Type{Int32}, data, status, n,
                           radius, f, c, H_ne, H_val, x, M_ne, M_val, m, A_ne,
                           A_val, y)
  @ccall libgalahad_double.trs_solve_problem(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32}, n::Int32,
...
function trs_solve_problem(::Type{Float64}, ::Type{Int64}, data, status, n,
                           radius, f, c, H_ne, H_val, x, M_ne, M_val, m, A_ne,
                           A_val, y)
...
function trs_solve_problem(::Type{Float128}, ::Type{Int32}, data, status, n,
                           radius, f, c, H_ne, H_val, x, M_ne, M_val, m, A_ne,
                           A_val, y)
  @ccall libgalahad_quadruple.trs_solve_problem_q(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int32}, n::Int32,
                                                  radius::Cfloat128,
                                                  f::Cfloat128,
...
function trs_solve_problem(::Type{Float128}, ::Type{Int64}, data, status, n,
                           radius, f, c, H_ne, H_val, x, M_ne, M_val, m, A_ne,
                           A_val, y)
...
function run_sif(::Val{:trs}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runtrs_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:trs}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runtrs_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
