...
function llst_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.llst_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                   control::Ptr{llst_control_type{Float32,
                                                                                  Int64}},
...
function llst_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.llst_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{llst_control_type{Float64,
                                                                                Int64}},
                                                 status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function llst_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.llst_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                      control::Ptr{llst_control_type{Float128,
                                                                                     Int64}},
                                                      status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function llst_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.llst_read_specfile_s_64(control::Ptr{llst_control_type{Float32,
                                                                                     Int64}},
                                                      specfile::Ptr{Cchar})::Cvoid
end
...
function llst_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.llst_read_specfile_64(control::Ptr{llst_control_type{Float64,
                                                                                   Int64}},
                                                    specfile::Ptr{Cchar})::Cvoid
end
...
function llst_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.llst_read_specfile_q_64(control::Ptr{llst_control_type{Float128,
                                                                                        Int64}},
                                                         specfile::Ptr{Cchar})::Cvoid
end
...
function llst_import(::Type{Float32}, ::Type{Int32}, control, data, status, m,
...
function llst_import(::Type{Float32}, ::Type{Int64}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_single_64.llst_import_s_64(control::Ptr{llst_control_type{Float32,
                                                                              Int64}},
                                               data::Ptr{Ptr{Cvoid}},
...
function llst_import(::Type{Float64}, ::Type{Int32}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
...
function llst_import(::Type{Float64}, ::Type{Int64}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_double_64.llst_import_64(control::Ptr{llst_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64}, m::Int64,
                                             n::Int64, A_type::Ptr{Cchar},
...
function llst_import(::Type{Float128}, ::Type{Int32}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
...
function llst_import(::Type{Float128}, ::Type{Int64}, control, data, status, m,
                     n, A_type, A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_quadruple_64.llst_import_q_64(control::Ptr{llst_control_type{Float128,
                                                                                 Int64}},
                                                  data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64}, m::Int64,
                                                  n::Int64, A_type::Ptr{Cchar},
...
function llst_import_scaling(::Type{Float32}, ::Type{Int32}, control, data,
...
function llst_import_scaling(::Type{Float32}, ::Type{Int64}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_single_64.llst_import_scaling_s_64(control::Ptr{llst_control_type{Float32,
                                                                                      Int64}},
                                                       data::Ptr{Ptr{Cvoid}},
                                                       status::Ptr{Int64},
                                                       n::Int64,
...
function llst_import_scaling(::Type{Float64}, ::Type{Int32}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
...
function llst_import_scaling(::Type{Float64}, ::Type{Int64}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_double_64.llst_import_scaling_64(control::Ptr{llst_control_type{Float64,
                                                                                    Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64},
                                                     n::Int64,
...
function llst_import_scaling(::Type{Float128}, ::Type{Int32}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
...
function llst_import_scaling(::Type{Float128}, ::Type{Int64}, control, data,
                             status, n, S_type, S_ne, S_row, S_col, S_ptr)
  @ccall libgalahad_quadruple_64.llst_import_scaling_q_64(control::Ptr{llst_control_type{Float128,
                                                                                         Int64}},
                                                          data::Ptr{Ptr{Cvoid}},
                                                          status::Ptr{Int64},
                                                          n::Int64,
...
function llst_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function llst_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_single_64.llst_reset_control_s_64(control::Ptr{llst_control_type{Float32,
                                                                                     Int64}},
                                                      data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64})::Cvoid
end

function llst_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
...
function llst_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_double_64.llst_reset_control_64(control::Ptr{llst_control_type{Float64,
                                                                                   Int64}},
                                                    data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64})::Cvoid
end

function llst_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function llst_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_quadruple_64.llst_reset_control_q_64(control::Ptr{llst_control_type{Float128,
                                                                                        Int64}},
                                                         data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64})::Cvoid
end
...
function llst_solve_problem(::Type{Float32}, ::Type{Int32}, data, status, m, n,
                            radius, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_single.llst_solve_problem_s(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int32}, m::Int32,
                                                n::Int32, radius::Float32,
                                                A_ne::Int32,
                                                A_val::Ptr{Float32},
                                                b::Ptr{Float32},
...
function llst_solve_problem(::Type{Float32}, ::Type{Int64}, data, status, m, n,
                            radius, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_single_64.llst_solve_problem_s_64(data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64},
                                                      m::Int64, n::Int64,
                                                      radius::Float32,
                                                      A_ne::Int64,
...
function llst_solve_problem(::Type{Float64}, ::Type{Int32}, data, status, m, n,
                            radius, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_double.llst_solve_problem(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, m::Int32,
                                              n::Int32, radius::Float64,
...
function llst_solve_problem(::Type{Float64}, ::Type{Int64}, data, status, m, n,
                            radius, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_double_64.llst_solve_problem_64(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    m::Int64, n::Int64,
                                                    radius::Float64,
                                                    A_ne::Int64,
...
function llst_solve_problem(::Type{Float128}, ::Type{Int32}, data, status, m, n,
                            radius, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_quadruple.llst_solve_problem_q(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int32}, m::Int32,
...
function llst_solve_problem(::Type{Float128}, ::Type{Int64}, data, status, m, n,
                            radius, A_ne, A_val, b, x, S_ne, S_val)
  @ccall libgalahad_quadruple_64.llst_solve_problem_q_64(data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64},
                                                         m::Int64, n::Int64,
                                                         radius::Cfloat128,
                                                         A_ne::Int64,
...
function llst_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.llst_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                    inform::Ptr{llst_inform_type{Float32,
                                                                                 Int64}},
                                                    status::Ptr{Int64})::Cvoid
end
...
function llst_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.llst_information_64(data::Ptr{Ptr{Cvoid}},
                                                  inform::Ptr{llst_inform_type{Float64,
                                                                               Int64}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function llst_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.llst_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                       inform::Ptr{llst_inform_type{Float128,
                                                                                    Int64}},
                                                       status::Ptr{Int64})::Cvoid
end
...
function llst_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.llst_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{llst_control_type{Float32,
                                                                                 Int64}},
                                                  inform::Ptr{llst_inform_type{Float32,
                                                                               Int64}})::Cvoid
...
function llst_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.llst_terminate_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{llst_control_type{Float64,
                                                                               Int64}},
                                                inform::Ptr{llst_inform_type{Float64,
                                                                             Int64}})::Cvoid
...
function llst_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.llst_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{llst_control_type{Float128,
                                                                                    Int64}},
                                                     inform::Ptr{llst_inform_type{Float128,
                                                                                  Int64}})::Cvoid
