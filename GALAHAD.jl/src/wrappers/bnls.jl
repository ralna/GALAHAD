...
function bnls_import_s(control, data, status, n, m, J_type, J_ne, J_row, J_col, J_ptr,
                      H_type, H_ne, H_row, H_col, H_ptr, P_type, P_ne, P_row, P_col, P_ptr,
                      w)
...
function bnls_import(control, data, status, n, m, J_type, J_ne, J_row, J_col, J_ptr, H_type,
...
function bnls_solve_with_mat_s(data, userdata, status, n, m, x, c, g, eval_c, j_ne, eval_j,
  ...
  @ccall libgalahad_single.bnls_solve_with_mat_s(data::Ptr{Ptr{Cvoid}}, userdata::Ptr{Cvoid},
...
function bnls_solve_reverse_with_mat_s(data, status, eval_status, n, m, x, c, g, j_ne, J_val,
