...
function ssls_read_specfile(::Type{Float64}, ::Type{Int32}, control, specfile)
  @ccall libgalahad_double.ssls_read_specfile(control::Ptr{ssls_control_type{Float64,
                                                                             Int32}},
                                              specfile::Ptr{Cchar})::Cvoid
end
...
function ssls_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_single.ssls_import_s(control::Ptr{ssls_control_type{Float32,
                                                                        Int32}},
                                         data::Ptr{Ptr{Cvoid}},
...
function ssls_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
...
function ssls_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_double.ssls_import(control::Ptr{ssls_control_type{Float64,
                                                                      Int32}},
                                       data::Ptr{Ptr{Cvoid}},
                                       status::Ptr{Int32}, n::Int32, m::Int32,
                                       H_type::Ptr{Cchar}, H_ne::Int32,
...
function ssls_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_double_64.ssls_import_64(control::Ptr{ssls_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64}, n::Int64,
                                             m::Int64, H_type::Ptr{Cchar},
...
function ssls_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_quadruple.ssls_import_q(control::Ptr{ssls_control_type{Float128,
                                                                           Int32}},
                                            data::Ptr{Ptr{Cvoid}},
...
function ssls_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
...
function ssls_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function ssls_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
...
function ssls_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
  @ccall libgalahad_double.ssls_reset_control(control::Ptr{ssls_control_type{Float64,
                                                                             Int32}},
                                              data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32})::Cvoid
end

function ssls_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
...
function ssls_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function ssls_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
...
function ssls_factorize_matrix(::Type{Float64}, ::Type{Int32}, data, status,
                               h_ne, H_val, a_ne, A_val, c_ne, C_val)
  @ccall libgalahad_double.ssls_factorize_matrix(data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int32},
                                                 h_ne::Int32,
                                                 H_val::Ptr{Float64},
                                                 a_ne::Int32,
...
function ssls_solve_system(::Type{Float32}, ::Type{Int32}, data, status, n, m,
                           sol)
  @ccall libgalahad_single.ssls_solve_system_s(data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32}, n::Int32,
                                               m::Int32,
                                               sol::Ptr{Float32})::Cvoid
end

function ssls_solve_system(::Type{Float32}, ::Type{Int64}, data, status, n, m,
                           sol)
...
function ssls_solve_system(::Type{Float64}, ::Type{Int32}, data, status, n, m,
                           sol)
  @ccall libgalahad_double.ssls_solve_system(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32}, n::Int32,
                                             m::Int32, sol::Ptr{Float64})::Cvoid
end

function ssls_solve_system(::Type{Float64}, ::Type{Int64}, data, status, n, m,
                           sol)
...
function ssls_solve_system(::Type{Float128}, ::Type{Int32}, data, status, n, m,
                           sol)
  @ccall libgalahad_quadruple.ssls_solve_system_q(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int32}, n::Int32,
                                                  m::Int32,
                                                  sol::Ptr{Float128})::Cvoid
end

function ssls_solve_system(::Type{Float128}, ::Type{Int64}, data, status, n, m,
                           sol)
...
function run_sif(::Val{:ssls}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
...
function run_sif(::Val{:ssls}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
