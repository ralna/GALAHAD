...
function sbls_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.sbls_initialize_s_64(data::Ptr{Ptr{Cvoid}},
                                                   control::Ptr{sbls_control_type{Float32,
                                                                                  Int64}},
...
function sbls_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.sbls_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{sbls_control_type{Float64,
                                                                                Int64}},
                                                 status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function sbls_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.sbls_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                      control::Ptr{sbls_control_type{Float128,
                                                                                     Int64}},
                                                      status::Ptr{Int64})::Cvoid
  new_control = @set control[].f_indexing = true
...
function sbls_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.sbls_read_specfile_s_64(control::Ptr{sbls_control_type{Float32,
                                                                                     Int64}},
                                                      specfile::Ptr{Cchar})::Cvoid
end
...
function sbls_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.sbls_read_specfile_64(control::Ptr{sbls_control_type{Float64,
                                                                                   Int64}},
                                                    specfile::Ptr{Cchar})::Cvoid
end
...
function sbls_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.sbls_read_specfile_q_64(control::Ptr{sbls_control_type{Float128,
                                                                                        Int64}},
                                                         specfile::Ptr{Cchar})::Cvoid
end
...
function sbls_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_single.sbls_import_s(control::Ptr{sbls_control_type{Float32,
                                         ...
                                         C_type::Ptr{Cchar}, C_ne::Int32,
                                         C_row::Ptr{Int32}, C_col::Ptr{Int32},
                                         C_ptr::Ptr{Int32})::Cvoid
end

function sbls_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_single_64.sbls_import_s_64(control::Ptr{sbls_control_type{Float32,
                                                                              Int64}},
                                               data::Ptr{Ptr{Cvoid}},
                                               ...
                                               A_col::Ptr{Int64},
                                               A_ptr::Ptr{Int64},
                                               C_type::Ptr{Cchar}, C_ne::Int64,
                                               C_row::Ptr{Int64},
                                               C_col::Ptr{Int64},
                                               C_ptr::Ptr{Int64})::Cvoid
end

function sbls_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
...
function sbls_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_double_64.sbls_import_64(control::Ptr{sbls_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64}, n::Int64,
                                             m::Int64, H_type::Ptr{Cchar},
...
function sbls_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
...
function sbls_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                     m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row,
                     A_col, A_ptr, C_type, C_ne, C_row, C_col, C_ptr)
  @ccall libgalahad_quadruple_64.sbls_import_q_64(control::Ptr{sbls_control_type{Float128,
                                                                                 Int64}},
                                                  data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64}, n::Int64,
                                                  m::Int64, H_type::Ptr{Cchar},
...
function sbls_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function sbls_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_single_64.sbls_reset_control_s_64(control::Ptr{sbls_control_type{Float32,
                                                                                     Int64}},
                                                      data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64})::Cvoid
end

function sbls_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
...
function sbls_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_double_64.sbls_reset_control_64(control::Ptr{sbls_control_type{Float64,
                                                                                   Int64}},
                                                    data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64})::Cvoid
end

function sbls_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function sbls_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
  @ccall libgalahad_quadruple_64.sbls_reset_control_q_64(control::Ptr{sbls_control_type{Float128,
                                                                                        Int64}},
                                                         data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64})::Cvoid
end
...
function sbls_factorize_matrix(::Type{Float32}, ::Type{Int32}, data, status, n,
                               h_ne, H_val, a_ne, A_val, c_ne, C_val, D)
  @ccall libgalahad_single.sbls_factorize_matrix_s(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int32}, n::Int32,
                                                   h_ne::Int32,
                                                   H_val::Ptr{Float32},
                                                   a_ne::Int32,
...
function sbls_factorize_matrix(::Type{Float32}, ::Type{Int64}, data, status, n,
                               h_ne, H_val, a_ne, A_val, c_ne, C_val, D)
  @ccall libgalahad_single_64.sbls_factorize_matrix_s_64(data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64},
                                                         n::Int64, h_ne::Int64,
                                                         H_val::Ptr{Float32},
                                                         a_ne::Int64,
...
function sbls_factorize_matrix(::Type{Float64}, ::Type{Int32}, data, status, n,
                               h_ne, H_val, a_ne, A_val, c_ne, C_val, D)
  @ccall libgalahad_double.sbls_factorize_matrix(data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int32}, n::Int32,
                                                 h_ne::Int32,
                                                 H_val::Ptr{Float64},
                                                 a_ne::Int32,
...
function sbls_factorize_matrix(::Type{Float64}, ::Type{Int64}, data, status, n,
                               h_ne, H_val, a_ne, A_val, c_ne, C_val, D)
  @ccall libgalahad_double_64.sbls_factorize_matrix_64(data::Ptr{Ptr{Cvoid}},
                                                       status::Ptr{Int64},
                                                       n::Int64, h_ne::Int64,
                                                       H_val::Ptr{Float64},
                                                       a_ne::Int64,
...
function sbls_factorize_matrix(::Type{Float128}, ::Type{Int32}, data, status, n,
                               h_ne, H_val, a_ne, A_val, c_ne, C_val, D)
...
function sbls_factorize_matrix(::Type{Float128}, ::Type{Int64}, data, status, n,
                               h_ne, H_val, a_ne, A_val, c_ne, C_val, D)
  @ccall libgalahad_quadruple_64.sbls_factorize_matrix_q_64(data::Ptr{Ptr{Cvoid}},
                                                            status::Ptr{Int64},
                                                            n::Int64,
                                                            h_ne::Int64,
                                                            H_val::Ptr{Float128},
...
function sbls_solve_system(::Type{Float32}, ::Type{Int32}, data, status, n, m,
                           sol)
  @ccall libgalahad_single.sbls_solve_system_s(data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int32}, n::Int32,
                                               m::Int32,
                                               sol::Ptr{Float32})::Cvoid
end

function sbls_solve_system(::Type{Float32}, ::Type{Int64}, data, status, n, m,
                           sol)
  @ccall libgalahad_single_64.sbls_solve_system_s_64(data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64},
                                                     n::Int64, m::Int64,
                                                     sol::Ptr{Float32})::Cvoid
end

function sbls_solve_system(::Type{Float64}, ::Type{Int32}, data, status, n, m,
                           sol)
  @ccall libgalahad_double.sbls_solve_system(data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int32}, n::Int32,
                                             m::Int32, sol::Ptr{Float64})::Cvoid
end

function sbls_solve_system(::Type{Float64}, ::Type{Int64}, data, status, n, m,
                           sol)
  @ccall libgalahad_double_64.sbls_solve_system_64(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64}, n::Int64,
                                                   m::Int64,
                                                   sol::Ptr{Float64})::Cvoid
end

function sbls_solve_system(::Type{Float128}, ::Type{Int32}, data, status, n, m,
                           sol)
  @ccall libgalahad_quadruple.sbls_solve_system_q(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int32}, n::Int32,
                                                  m::Int32,
                                                  sol::Ptr{Float128})::Cvoid
end

function sbls_solve_system(::Type{Float128}, ::Type{Int64}, data, status, n, m,
                           sol)
  @ccall libgalahad_quadruple_64.sbls_solve_system_q_64(data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64},
                                                        n::Int64, m::Int64,
                                                        sol::Ptr{Float128})::Cvoid
end
...
function sbls_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.sbls_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                    inform::Ptr{sbls_inform_type{Float32,
                                                                                 Int64}},
                                                    status::Ptr{Int64})::Cvoid
end
...
function sbls_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.sbls_information_64(data::Ptr{Ptr{Cvoid}},
                                                  inform::Ptr{sbls_inform_type{Float64,
                                                                               Int64}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function sbls_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.sbls_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                       inform::Ptr{sbls_inform_type{Float128,
                                                                                    Int64}},
                                                       status::Ptr{Int64})::Cvoid
end
...
function sbls_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.sbls_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{sbls_control_type{Float32,
                                                                                 Int64}},
                                                  inform::Ptr{sbls_inform_type{Float32,
                                                                               Int64}})::Cvoid
...
function sbls_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.sbls_terminate_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{sbls_control_type{Float64,
                                                                               Int64}},
                                                inform::Ptr{sbls_inform_type{Float64,
                                                                             Int64}})::Cvoid
...
function sbls_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.sbls_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{sbls_control_type{Float128,
                                                                                    Int64}},
                                                     inform::Ptr{sbls_inform_type{Float128,
                                                                                  Int64}})::Cvoid
...
function run_sif(::Val{:sbls}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runsbls_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:sbls}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runsbls_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
