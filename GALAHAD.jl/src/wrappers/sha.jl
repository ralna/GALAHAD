...
function sha_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.sha_initialize_s(data::Ptr{Ptr{Cvoid}},
...
function sha_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.sha_initialize_q(data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{sha_control_type{Int64}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function sha_reset_control(::Type{Float32}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_single_64.sha_reset_control_s(control::Ptr{sha_control_type{Int64}},
                                                  data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64})::Cvoid
end
...
function sha_reset_control(::Type{Float128}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_quadruple_64.sha_reset_control_q(control::Ptr{sha_control_type{Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end
...
function sha_analyse_matrix(::Type{Float32}, ::Type{Int64}, control, data, status, n, ne,
                            row, col, m)
  @ccall libgalahad_single_64.sha_analyse_matrix_s(control::Ptr{sha_control_type{Int64}},
                                                   data::Ptr{Ptr{Cvoid}},
...
function sha_analyse_matrix(::Type{Float128}, ::Type{Int64}, control, data, status, n, ne,
                            row, col, m)
  @ccall libgalahad_quadruple_64.sha_analyse_matrix_q(control::Ptr{sha_control_type{Int64}},
                                                      data::Ptr{Ptr{Cvoid}},
...
function sha_recover_matrix(::Type{Float32}, ::Type{Int64}, data, status, ne, m, ls1, ls2,
                            strans, ly1, ly2, ytrans, val, precedence)
  @ccall libgalahad_single_64.sha_recover_matrix_s(data::Ptr{Ptr{Cvoid}},
...
function sha_recover_matrix(::Type{Float128}, ::Type{Int64}, data, status, ne, m, ls1, ls2,
                            strans, ly1, ly2, ytrans, val, precedence)
  @ccall libgalahad_quadruple_64.sha_recover_matrix_q(data::Ptr{Ptr{Cvoid}},
...
function sha_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.sha_information_s(data::Ptr{Ptr{Cvoid}},
...
function sha_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.sha_information_q(data::Ptr{Ptr{Cvoid}},
...
function sha_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.sha_terminate_s(data::Ptr{Ptr{Cvoid}},
                                              control::Ptr{sha_control_type{Int64}},
...
function sha_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.sha_terminate_q(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{sha_control_type{Int64}},
                                                 inform::Ptr{sha_inform_type{Float128,
                                                                             Int64}})::Cvoid
end
