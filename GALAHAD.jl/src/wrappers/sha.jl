...
function sha_initialize(::Type{Float32}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_single_64.sha_initialize_s_64(data::Ptr{Ptr{Cvoid}},
...
function sha_initialize(::Type{Float64}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_double_64.sha_initialize_64(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{sha_control_type{Int64}},
                                                status::Ptr{Int64})::Cvoid
end
...
function sha_initialize(::Type{Float128}, ::Type{Int64}, data, control, status)
  @ccall libgalahad_quadruple_64.sha_initialize_q_64(data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{sha_control_type{Int64}},
                                                     status::Ptr{Int64})::Cvoid
end
...
function sha_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function sha_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_single_64.sha_reset_control_s_64(control::Ptr{sha_control_type{Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end

function sha_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function sha_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_double_64.sha_reset_control_64(control::Ptr{sha_control_type{Int64}},
                                                   data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64})::Cvoid
end

function sha_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function sha_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_quadruple_64.sha_reset_control_q_64(control::Ptr{sha_control_type{Int64}},
                                                        data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64})::Cvoid
end
...
function sha_analyse_matrix(::Type{Float32}, ::Type{Int32}, control, data,
                            status, n, ne, row, col, m)
  @ccall libgalahad_single.sha_analyse_matrix_s(control::Ptr{sha_control_type{Int32}},
                                                data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int32}, n::Int32,
                                                ne::Int32, row::Ptr{Int32},
                                                col::Ptr{Int32},
                                                m::Ptr{Int32})::Cvoid
end

function sha_analyse_matrix(::Type{Float32}, ::Type{Int64}, control, data,
                            status, n, ne, row, col, m)
  @ccall libgalahad_single_64.sha_analyse_matrix_s_64(control::Ptr{sha_control_type{Int64}},
                                                      data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64},
                                                      n::Int64, ne::Int64,
                                                      row::Ptr{Int64},
...
function sha_analyse_matrix(::Type{Float64}, ::Type{Int32}, control, data,
                            status, n, ne, row, col, m)
...
function sha_analyse_matrix(::Type{Float64}, ::Type{Int64}, control, data,
                            status, n, ne, row, col, m)
  @ccall libgalahad_double_64.sha_analyse_matrix_64(control::Ptr{sha_control_type{Int64}},
                                                    data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    n::Int64, ne::Int64,
                                                    row::Ptr{Int64},
...
function sha_analyse_matrix(::Type{Float128}, ::Type{Int32}, control, data,
                            status, n, ne, row, col, m)
...
function sha_analyse_matrix(::Type{Float128}, ::Type{Int64}, control, data,
                            status, n, ne, row, col, m)
  @ccall libgalahad_quadruple_64.sha_analyse_matrix_q_64(control::Ptr{sha_control_type{Int64}},
                                                         data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64},
                                                         n::Int64, ne::Int64,
                                                         row::Ptr{Int64},
...
function sha_recover_matrix(::Type{Float32}, ::Type{Int32}, data, status, ne, m,
                            ls1, ls2, strans, ly1, ly2, ytrans, val, precedence)
  @ccall libgalahad_single.sha_recover_matrix_s(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int32}, ne::Int32,
                                                m::Int32, ls1::Int32,
                                                ls2::Int32,
                                                strans::Ptr{Ptr{Float32}},
                                                ly1::Int32, ly2::Int32,
...
function sha_recover_matrix(::Type{Float32}, ::Type{Int64}, data, status, ne, m,
                            ls1, ls2, strans, ly1, ly2, ytrans, val, precedence)
  @ccall libgalahad_single_64.sha_recover_matrix_s_64(data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64},
                                                      ne::Int64, m::Int64,
                                                      ls1::Int64, ls2::Int64,
                                                      strans::Ptr{Ptr{Float32}},
...
function sha_recover_matrix(::Type{Float64}, ::Type{Int32}, data, status, ne, m,
                            ls1, ls2, strans, ly1, ly2, ytrans, val, precedence)
  @ccall libgalahad_double.sha_recover_matrix(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, ne::Int32,
                                              m::Int32, ls1::Int32, ls2::Int32,
                                              strans::Ptr{Ptr{Float64}},
                                              ly1::Int32, ly2::Int32,
...
function sha_recover_matrix(::Type{Float64}, ::Type{Int64}, data, status, ne, m,
                            ls1, ls2, strans, ly1, ly2, ytrans, val, precedence)
  @ccall libgalahad_double_64.sha_recover_matrix_64(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    ne::Int64, m::Int64,
                                                    ls1::Int64, ls2::Int64,
                                                    strans::Ptr{Ptr{Float64}},
...
function sha_recover_matrix(::Type{Float128}, ::Type{Int32}, data, status, ne,
                            m, ls1, ls2, strans, ly1, ly2, ytrans, val,
                            precedence)
  @ccall libgalahad_quadruple.sha_recover_matrix_q(data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int32},
                                                   ne::Int32, m::Int32,
                                                   ls1::Int32, ls2::Int32,
                                                   strans::Ptr{Ptr{Float128}},
                                                   ly1::Int32, ly2::Int32,
...
function sha_recover_matrix(::Type{Float128}, ::Type{Int64}, data, status, ne,
                            m, ls1, ls2, strans, ly1, ly2, ytrans, val,
                            precedence)
  @ccall libgalahad_quadruple_64.sha_recover_matrix_q_64(data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64},
                                                         ne::Int64, m::Int64,
                                                         ls1::Int64, ls2::Int64,
                                                         strans::Ptr{Ptr{Float128}},
...
function sha_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.sha_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                   inform::Ptr{sha_inform_type{Float32,
                                                                               Int64}},
                                                   status::Ptr{Int64})::Cvoid
end
...
function sha_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.sha_information_64(data::Ptr{Ptr{Cvoid}},
                                                 inform::Ptr{sha_inform_type{Float64,
                                                                             Int64}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function sha_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.sha_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                      inform::Ptr{sha_inform_type{Float128,
                                                                                  Int64}},
                                                      status::Ptr{Int64})::Cvoid
end
...
function sha_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.sha_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{sha_control_type{Int64}},
                                                 inform::Ptr{sha_inform_type{Float32,
                                                                             Int64}})::Cvoid
end
...
function sha_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.sha_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{sha_control_type{Int64}},
                                               inform::Ptr{sha_inform_type{Float64,
                                                                           Int64}})::Cvoid
end
...
function sha_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.sha_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{sha_control_type{Int64}},
                                                    inform::Ptr{sha_inform_type{Float128,
                                                                                Int64}})::Cvoid
end

function run_sif(::Val{:sha}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runsha_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:sha}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runsha_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
