...
function roots_initialize(::Type{Float128}, data, control, status)
...
function roots_information(::Type{Float128}, data, inform, status)
...
function roots_terminate(::Type{Float128}, data, control, inform)
