...
function ccqp_read_specfile(control, specfile)
    @ccall libgalahad_double.ccqp_read_specfile(control::Ptr{ccqp_control_type},
                                                specfile::Ptr{Cchar})::Cvoid
end

function ccqp_import(control, data, status, n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type,
                     A_ne, A_row, A_col, A_ptr)
    @ccall libgalahad_double.ccqp_import(control::Ptr{ccqp_control_type},
...
function ccqp_reset_control(control, data, status)
    @ccall libgalahad_double.ccqp_reset_control(control::Ptr{ccqp_control_type},
                                                data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Cint})::Cvoid
end
...
function ccqp_terminate(data, control, inform)
    @ccall libgalahad_double.ccqp_terminate(data::Ptr{Ptr{Cvoid}},
                                            control::Ptr{ccqp_control_type},
                                            inform::Ptr{ccqp_inform_type})::Cvoid
end
