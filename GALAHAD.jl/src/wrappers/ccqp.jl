mutable struct ccqp_control_type
    f_indexing::Bool
    error::Cint
    out::Cint
    print_level::Cint
...
mutable struct ccqp_inform_type
    status::Cint
    alloc_status::Cint
...
function ccqp_initialize(data, control, status)
    @ccall libgalahad_double.ccqp_initialize(data::Ptr{Ptr{Cvoid}},
                                             control::Ref{ccqp_control_type},
                                             status::Ptr{Cint})::Cvoid
end

function ccqp_read_specfile(control, specfile)
    @ccall libgalahad_double.ccqp_read_specfile(control::Ref{ccqp_control_type},
                                                specfile::Ptr{Cchar})::Cvoid
end

function ccqp_import(control, data, status, n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type,
                     A_ne, A_row, A_col, A_ptr)
    @ccall libgalahad_double.ccqp_import(control::Ref{ccqp_control_type},
...
function ccqp_reset_control(control, data, status)
    @ccall libgalahad_double.ccqp_reset_control(control::Ref{ccqp_control_type},
                                                data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Cint})::Cvoid
end
...
function ccqp_terminate(data, control, inform)
    @ccall libgalahad_double.ccqp_terminate(data::Ptr{Ptr{Cvoid}},
                                            control::Ref{ccqp_control_type},
                                            inform::Ref{ccqp_inform_type})::Cvoid
end
