...
function bllsb_import_s(control, data, status, n, o,  
...
export bllsb_solve_bllsb_s

function bllsb_solve_bllsb_s(data, status, n, o, Ao_ne, Ao_val, b, sigma,
                             x_l, x_u, x, r, z, x_stat, w)
  @ccall libgalahad_single.bllsb_solve_bllsb_s(data::Ptr{Ptr{Cvoid}}, 
                                          status::Ptr{Cint}, 
                                          n::Cint, o::Cint, 
                                          Ao_ne::Cint, Ao_val::Ptr{Float32},
                                          b::Ptr{Float32}, sigma::Float32,
...
export bllsb_solve_bllsb

function bllsb_solve_bllsb(data, status, n, o, Ao_ne, Ao_val, b, sigma,
                         x_l, x_u, x, r, z, x_stat, w)
  @ccall libgalahad_double.bllsb_solve_bllsb(data::Ptr{Ptr{Cvoid}}, 
                                        status::Ptr{Cint}, 
                                        n::Cint, o::Cint,
                                        Ao_ne::Cint, Ao_val::Ptr{Float64},
                                        b::Ptr{Float64}, sigma::Float64,
