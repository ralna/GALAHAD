...
function bsc_import(::Type{Float32}, ::Type{Int32}, control, data, status, m, n,
...
function bsc_import(::Type{Float32}, ::Type{Int64}, control, data, status, m, n,
                    A_type, A_ne, A_row, A_col, A_ptr, S_ne)
...
function bsc_import(::Type{Float64}, ::Type{Int32}, control, data, status, m, n,
                    A_type, A_ne, A_row, A_col, A_ptr, S_ne)
...
function bsc_import(::Type{Float64}, ::Type{Int64}, control, data, status, m, n,
                    A_type, A_ne, A_row, A_col, A_ptr, S_ne)
...
function bsc_import(::Type{Float128}, ::Type{Int32}, control, data, status, m,
                    n, A_type, A_ne, A_row, A_col, A_ptr, S_ne)
...
function bsc_import(::Type{Float128}, ::Type{Int64}, control, data, status, m,
                    n, A_type, A_ne, A_row, A_col, A_ptr, S_ne)
...
function bsc_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function bsc_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
...
function bsc_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function bsc_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
...
function bsc_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function bsc_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
...
function bsc_form_s(::Type{Float32}, ::Type{Int32}, data, status, m, n, a_ne,
                    A_val, s_ne, S_row, S_col, S_ptr, S_val, D)
  @ccall libgalahad_single.bsc_form_s_s(data::Ptr{Ptr{Cvoid}},
                                        status::Ptr{Int32}, m::Int32, n::Int32,
...
function bsc_form_s(::Type{Float32}, ::Type{Int64}, data, status, m, n, a_ne,
                    A_val, s_ne, S_row, S_col, S_ptr, S_val, D)
  @ccall libgalahad_single_64.bsc_form_s_s_64(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int64}, m::Int64,
                                              n::Int64, a_ne::Int64,
...
function bsc_form_s(::Type{Float64}, ::Type{Int32}, data, status, m, n, a_ne,
                    A_val, s_ne, S_row, S_col, S_ptr, S_val, D)
  @ccall libgalahad_double.bsc_form_s(data::Ptr{Ptr{Cvoid}}, status::Ptr{Int32},
                                      m::Int32, n::Int32, a_ne::Int32,
                                      A_val::Ptr{Float64}, s_ne::Int32,
                                      S_row::Ptr{Int32}, S_col::Ptr{Int32},
                                      S_ptr::Ptr{Int32}, S_val::Ptr{Float64},
                                      D::Ptr{Float64})::Cvoid
end

function bsc_form_s(::Type{Float64}, ::Type{Int64}, data, status, m, n, a_ne,
                    A_val, s_ne, S_row, S_col, S_ptr, S_val, D)
  @ccall libgalahad_double_64.bsc_form_s_64(data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int64}, m::Int64,
                                            n::Int64, a_ne::Int64,
...
function bsc_form_s(::Type{Float128}, ::Type{Int32}, data, status, m, n, a_ne,
                    A_val, s_ne, S_row, S_col, S_ptr, S_val, D)
  @ccall libgalahad_quadruple.bsc_form_s_q(data::Ptr{Ptr{Cvoid}},
                                           status::Ptr{Int32}, m::Int32,
                                           n::Int32, a_ne::Int32,
...
function bsc_form_s(::Type{Float128}, ::Type{Int64}, data, status, m, n, a_ne,
                    A_val, s_ne, S_row, S_col, S_ptr, S_val, D)
  @ccall libgalahad_quadruple_64.bsc_form_s_q_64(data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64}, m::Int64,
                                                 n::Int64, a_ne::Int64,
                                                 A_val::Ptr{Float128},
