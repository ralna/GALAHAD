...
function version_galahad(::Type{Float32}, ::Type{Int64})
  ...
  minor = Ref{Int64}(0)
  patch = Ref{Int64}(0)
  @ccall libgalahad_single_64.version_galahad_64(major::Ref{Int64}, minor::Ref{Int64}, patch::Ref{Int64})::Cvoid
  return VersionNumber(major[], minor[], patch[])
end
...
function version_galahad(::Type{Float128}, ::Type{Int64})
  ...
  minor = Ref{Int64}(0)
  patch = Ref{Int64}(0)
  @ccall libgalahad_quadruple_64.version_galahad_64(major::Ref{Int64}, minor::Ref{Int64}, patch::Ref{Int64})::Cvoid
  return VersionNumber(major[], minor[], patch[])
end
