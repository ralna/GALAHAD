...
function expo_initialize(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.expo_initialize(data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{expo_control_type{Float128,
                                                                              Int64}},
                                                inform::Ptr{expo_inform_type{Float128,Int64}})::Cvoid
  new_control = @set control[].f_indexing = true
  control[] = new_control[]
  return Cvoid
end
...
function expo_import(::Type{Float32}, ::Type{Int32}, control, data, status, 
                       n, m, J_type, J_ne, J_row, J_col, J_ptr, 
...
function expo_import(::Type{Float32}, ::Type{Int64}, control, data, status, 
                       n, m, J_type, J_ne, J_row, J_col, J_ptr, 
                       H_type, H_ne, H_row, H_col, H_ptr)
...
function expo_import(::Type{Float64}, ::Type{Int32}, control, data, status, 
                       n, m, J_type, J_ne, J_row, J_col, J_ptr, 
                       H_type, H_ne, H_row, H_col, H_ptr)
...
function expo_import(::Type{Float64}, ::Type{Int64}, control, data, status, 
                       n, m, J_type, J_ne, J_row, J_col, J_ptr, 
                       H_type, H_ne, H_row, H_col, H_ptr)
...
function expo_import(::Type{Float128}, ::Type{Int32}, control, data, status, 
                       n, m, J_type, J_ne, J_row, J_col, J_ptr, 
                       H_type, H_ne, H_row, H_col, H_ptr)
...
function expo_import(::Type{Float128}, ::Type{Int64}, control, data, status,
                       n, m, J_type, J_ne, J_row, J_col, J_ptr, 
                       H_type, H_ne, H_row, H_col, H_ptr)
