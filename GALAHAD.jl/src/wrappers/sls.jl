...
struct sls_inform_type{T,INT}
  ...
  slblt_inform::slblt_inform_type{T,INT}
...
function sls_initialize(::Type{Float32}, ::Type{Int32}, solver, data, control,
                        status)
  @ccall libgalahad_single.sls_initialize_s(solver::Ptr{Cchar},
                                            data::Ptr{Ptr{Cvoid}},
...
function sls_initialize(::Type{Float32}, ::Type{Int64}, solver, data, control,
                        status)
  @ccall libgalahad_single_64.sls_initialize_s_64(solver::Ptr{Cchar},
                                                  data::Ptr{Ptr{Cvoid}},
                                                  control::Ptr{sls_control_type{Float32,
                                                                                Int64}},
...
function sls_initialize(::Type{Float64}, ::Type{Int32}, solver, data, control,
                        status)
  @ccall libgalahad_double.sls_initialize(solver::Ptr{Cchar},
                                          data::Ptr{Ptr{Cvoid}},
...
function sls_initialize(::Type{Float64}, ::Type{Int64}, solver, data, control,
                        status)
  @ccall libgalahad_double_64.sls_initialize_64(solver::Ptr{Cchar},
                                                data::Ptr{Ptr{Cvoid}},
                                                control::Ptr{sls_control_type{Float64,
                                                                              Int64}},
                                                status::Ptr{Int64})::Cvoid
...
function sls_initialize(::Type{Float128}, ::Type{Int32}, solver, data, control,
                        status)
  @ccall libgalahad_quadruple.sls_initialize_q(solver::Ptr{Cchar},
                                               data::Ptr{Ptr{Cvoid}},
...
function sls_initialize(::Type{Float128}, ::Type{Int64}, solver, data, control,
                        status)
  @ccall libgalahad_quadruple_64.sls_initialize_q_64(solver::Ptr{Cchar},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     control::Ptr{sls_control_type{Float128,
                                                                                   Int64}},
                                                     status::Ptr{Int64})::Cvoid
...
function sls_read_specfile(::Type{Float32}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_single_64.sls_read_specfile_s_64(control::Ptr{sls_control_type{Float32,
                                                                                   Int64}},
                                                     specfile::Ptr{Cchar})::Cvoid
end
...
function sls_read_specfile(::Type{Float64}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_double_64.sls_read_specfile_64(control::Ptr{sls_control_type{Float64,
                                                                                 Int64}},
                                                   specfile::Ptr{Cchar})::Cvoid
end
...
function sls_read_specfile(::Type{Float128}, ::Type{Int64}, control, specfile)
  @ccall libgalahad_quadruple_64.sls_read_specfile_q_64(control::Ptr{sls_control_type{Float128,
                                                                                      Int64}},
                                                        specfile::Ptr{Cchar})::Cvoid
end
...
function sls_analyse_matrix(::Type{Float32}, ::Type{Int32}, control, data,
                            status, n, type, ne, row, col, ptr)
...
function sls_analyse_matrix(::Type{Float32}, ::Type{Int64}, control, data,
                            status, n, type, ne, row, col, ptr)
  @ccall libgalahad_single_64.sls_analyse_matrix_s_64(control::Ptr{sls_control_type{Float32,
                                                                                    Int64}},
                                                      data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64},
                                                      n::Int64,
...
function sls_analyse_matrix(::Type{Float64}, ::Type{Int32}, control, data,
                            status, n, type, ne, row, col, ptr)
...
function sls_analyse_matrix(::Type{Float64}, ::Type{Int64}, control, data,
                            status, n, type, ne, row, col, ptr)
  @ccall libgalahad_double_64.sls_analyse_matrix_64(control::Ptr{sls_control_type{Float64,
                                                                                  Int64}},
                                                    data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
...
function sls_analyse_matrix(::Type{Float128}, ::Type{Int32}, control, data,
                            status, n, type, ne, row, col, ptr)
...
function sls_analyse_matrix(::Type{Float128}, ::Type{Int64}, control, data,
                            status, n, type, ne, row, col, ptr)
  @ccall libgalahad_quadruple_64.sls_analyse_matrix_q_64(control::Ptr{sls_control_type{Float128,
                                                                                       Int64}},
                                                         data::Ptr{Ptr{Cvoid}},
                                                         status::Ptr{Int64},
                                                         n::Int64,
...
function sls_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                           status)
...
function sls_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_single_64.sls_reset_control_s_64(control::Ptr{sls_control_type{Float32,
                                                                                   Int64}},
                                                     data::Ptr{Ptr{Cvoid}},
                                                     status::Ptr{Int64})::Cvoid
end

function sls_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                           status)
...
function sls_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_double_64.sls_reset_control_64(control::Ptr{sls_control_type{Float64,
                                                                                 Int64}},
                                                   data::Ptr{Ptr{Cvoid}},
                                                   status::Ptr{Int64})::Cvoid
end

function sls_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                           status)
...
function sls_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                           status)
  @ccall libgalahad_quadruple_64.sls_reset_control_q_64(control::Ptr{sls_control_type{Float128,
                                                                                      Int64}},
                                                        data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64})::Cvoid
end
...
function sls_factorize_matrix(::Type{Float32}, ::Type{Int32}, data, status, ne,
                              val)
  @ccall libgalahad_single.sls_factorize_matrix_s(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int32}, ne::Int32,
                                                  val::Ptr{Float32})::Cvoid
end

function sls_factorize_matrix(::Type{Float32}, ::Type{Int64}, data, status, ne,
                              val)
  @ccall libgalahad_single_64.sls_factorize_matrix_s_64(data::Ptr{Ptr{Cvoid}},
                                                        status::Ptr{Int64},
                                                        ne::Int64,
                                                        val::Ptr{Float32})::Cvoid
end

function sls_factorize_matrix(::Type{Float64}, ::Type{Int32}, data, status, ne,
                              val)
  @ccall libgalahad_double.sls_factorize_matrix(data::Ptr{Ptr{Cvoid}},
                                                status::Ptr{Int32}, ne::Int32,
                                                val::Ptr{Float64})::Cvoid
end

function sls_factorize_matrix(::Type{Float64}, ::Type{Int64}, data, status, ne,
                              val)
  @ccall libgalahad_double_64.sls_factorize_matrix_64(data::Ptr{Ptr{Cvoid}},
                                                      status::Ptr{Int64},
                                                      ne::Int64,
                                                      val::Ptr{Float64})::Cvoid
end

function sls_factorize_matrix(::Type{Float128}, ::Type{Int32}, data, status, ne,
                              val)
...
function sls_factorize_matrix(::Type{Float128}, ::Type{Int64}, data, status, ne,
                              val)
  @ccall libgalahad_quadruple_64.sls_factorize_matrix_q_64(data::Ptr{Ptr{Cvoid}},
                                                           status::Ptr{Int64},
                                                           ne::Int64,
                                                           val::Ptr{Float128})::Cvoid
end
...
function sls_solve_system(::Type{Float32}, ::Type{Int32}, data, status, n, sol)
  @ccall libgalahad_single.sls_solve_system_s(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, n::Int32,
                                              sol::Ptr{Float32})::Cvoid
end

function sls_solve_system(::Type{Float32}, ::Type{Int64}, data, status, n, sol)
  @ccall libgalahad_single_64.sls_solve_system_s_64(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    n::Int64,
                                                    sol::Ptr{Float32})::Cvoid
end
...
function sls_partial_solve_system(::Type{Float32}, ::Type{Int32}, part, data,
                                  status, n, sol)
...
function sls_partial_solve_system(::Type{Float32}, ::Type{Int64}, part, data,
                                  status, n, sol)
  @ccall libgalahad_single_64.sls_partial_solve_system_s_64(part::Ptr{Cchar},
                                                            data::Ptr{Ptr{Cvoid}},
                                                            status::Ptr{Int64},
                                                            n::Int64,
                                                            sol::Ptr{Float32})::Cvoid
...
function sls_partial_solve_system(::Type{Float64}, ::Type{Int32}, part, data,
                                  status, n, sol)
...
function sls_partial_solve_system(::Type{Float64}, ::Type{Int64}, part, data,
                                  status, n, sol)
  @ccall libgalahad_double_64.sls_partial_solve_system_64(part::Ptr{Cchar},
                                                          data::Ptr{Ptr{Cvoid}},
                                                          status::Ptr{Int64},
                                                          n::Int64,
                                                          sol::Ptr{Float64})::Cvoid
...
function sls_partial_solve_system(::Type{Float128}, ::Type{Int32}, part, data,
                                  status, n, sol)
...
function sls_partial_solve_system(::Type{Float128}, ::Type{Int64}, part, data,
                                  status, n, sol)
  @ccall libgalahad_quadruple_64.sls_partial_solve_system_q_64(part::Ptr{Cchar},
                                                               data::Ptr{Ptr{Cvoid}},
                                                               status::Ptr{Int64},
                                                               n::Int64,
                                                               sol::Ptr{Float128})::Cvoid
...
function sls_information(::Type{Float32}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_single_64.sls_information_s_64(data::Ptr{Ptr{Cvoid}},
                                                   inform::Ptr{sls_inform_type{Float32,
                                                                               Int64}},
                                                   status::Ptr{Int64})::Cvoid
end
...
function sls_information(::Type{Float64}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_double_64.sls_information_64(data::Ptr{Ptr{Cvoid}},
                                                 inform::Ptr{sls_inform_type{Float64,
                                                                             Int64}},
                                                 status::Ptr{Int64})::Cvoid
end
...
function sls_information(::Type{Float128}, ::Type{Int64}, data, inform, status)
  @ccall libgalahad_quadruple_64.sls_information_q_64(data::Ptr{Ptr{Cvoid}},
                                                      inform::Ptr{sls_inform_type{Float128,
                                                                                  Int64}},
                                                      status::Ptr{Int64})::Cvoid
end
...
function sls_terminate(::Type{Float32}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_single_64.sls_terminate_s_64(data::Ptr{Ptr{Cvoid}},
                                                 control::Ptr{sls_control_type{Float32,
                                                                               Int64}},
                                                 inform::Ptr{sls_inform_type{Float32,
                                                                             Int64}})::Cvoid
...
function sls_terminate(::Type{Float64}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_double_64.sls_terminate_64(data::Ptr{Ptr{Cvoid}},
                                               control::Ptr{sls_control_type{Float64,
                                                                             Int64}},
                                               inform::Ptr{sls_inform_type{Float64,
                                                                           Int64}})::Cvoid
...
function sls_terminate(::Type{Float128}, ::Type{Int64}, data, control, inform)
  @ccall libgalahad_quadruple_64.sls_terminate_q_64(data::Ptr{Ptr{Cvoid}},
                                                    control::Ptr{sls_control_type{Float128,
                                                                                  Int64}},
                                                    inform::Ptr{sls_inform_type{Float128,
                                                                                Int64}})::Cvoid
...
function run_sif(::Val{:sls}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runsls_sif_single()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end

function run_sif(::Val{:sls}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
  cmd = setup_env_lbt(`$(GALAHAD_jll.runsls_sif_double()) $path_libsif $path_outsdif`)
  run(cmd)
  return nothing
end
