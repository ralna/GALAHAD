...
function sils_import(::Type{Float64}, ::Type{Int64}, control, data, status)
  @ccall libgalahad_double_64.sils_import_64(control::Ptr{sils_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64})::Cvoid
end
...
function sils_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function sils_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
...
function sils_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
...
function sils_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
...
function sils_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function sils_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
...
function sils_information(::Type{Float32}, ::Type{Int32}, data, ainfo, finfo,
                          sinfo, status)
...
function sils_information(::Type{Float32}, ::Type{Int64}, data, ainfo, finfo,
                          sinfo, status)
...
function sils_information(::Type{Float64}, ::Type{Int32}, data, ainfo, finfo,
                          sinfo, status)
...
function sils_information(::Type{Float64}, ::Type{Int64}, data, ainfo, finfo,
                          sinfo, status)
...
function sils_information(::Type{Float128}, ::Type{Int32}, data, ainfo, finfo,
                          sinfo, status)
...
function sils_information(::Type{Float128}, ::Type{Int64}, data, ainfo, finfo,
                          sinfo, status)
...
function run_sif(::Val{:sils}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
...
function run_sif(::Val{:sils}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
