...
mutable struct cqp_control_type{T}
  f_indexing::Bool
  error::Cint
  out::Cint
  print_level::Cint
...
mutable struct cqp_time_type{T}
  total::T
  preprocess::T
  find_dependent::T
  analyse::T
  ...
  cqp_time_type{T}() where T = new()
end

export cqp_inform_type

mutable struct cqp_inform_type{T}
  status::Cint
  alloc_status::Cint
...
function cqp_initialize_s(data, control, status)
  @ccall libgalahad_single.cqp_initialize_s(data::Ptr{Ptr{Cvoid}},
                                            control::Ref{cqp_control_type{Float32}},
...
function cqp_read_specfile_s(control, specfile)
  @ccall libgalahad_single.cqp_read_specfile_s(control::Ref{cqp_control_type{Float32}},
...
function cqp_read_specfile(control, specfile)
  @ccall libgalahad_double.cqp_read_specfile(control::Ref{cqp_control_type{Float64}},
                                             specfile::Ptr{Cchar})::Cvoid
end

export cqp_import_s

function cqp_import_s(control, data, status, n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type,
                    A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_single.cqp_import_s(control::Ref{cqp_control_type{Float32}},
...
function cqp_import(control, data, status, n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type,
                  A_ne, A_row, A_col, A_ptr)
  @ccall libgalahad_double.cqp_import(control::Ref{cqp_control_type{Float64}},
                                      data::Ptr{Ptr{Cvoid}}, status::Ptr{Cint}, n::Cint,
                                      m::Cint, H_type::Ptr{Cchar}, H_ne::Cint,
                                      H_row::Ptr{Cint}, H_col::Ptr{Cint},
                                      H_ptr::Ptr{Cint}, A_type::Ptr{Cchar}, A_ne::Cint,
...
function cqp_reset_control_s(control, data, status)
  @ccall libgalahad_single.cqp_reset_control_s(control::Ref{cqp_control_type{Float32}},
                                               data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Cint})::Cvoid
end
...
function cqp_reset_control(control, data, status)
  @ccall libgalahad_double.cqp_reset_control(control::Ref{cqp_control_type{Float64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Cint})::Cvoid
end
...
function cqp_information_s(data, inform, status)
  @ccall libgalahad_single.cqp_information_s(data::Ptr{Ptr{Cvoid}},
                                             inform::Ref{cqp_inform_type{Float32}},
                                             status::Ptr{Cint})::Cvoid
end
...
function cqp_terminate_s(data, control, inform)
  @ccall libgalahad_single.cqp_terminate_s(data::Ptr{Ptr{Cvoid}},
                                           control::Ref{cqp_control_type{Float32}},
                                           inform::Ref{cqp_inform_type{Float32}})::Cvoid
end
...
function cqp_terminate(data, control, inform)
  @ccall libgalahad_double.cqp_terminate(data::Ptr{Ptr{Cvoid}},
                                         control::Ref{cqp_control_type{Float64}},
                                         inform::Ref{cqp_inform_type{Float64}})::Cvoid
end
