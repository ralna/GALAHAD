...
function bqpb_import(::Type{Float32}, ::Type{Int32}, control, data, status, n,
...
function bqpb_import(::Type{Float32}, ::Type{Int64}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
...
function bqpb_import(::Type{Float64}, ::Type{Int32}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
...
function bqpb_import(::Type{Float64}, ::Type{Int64}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_double_64.bqpb_import_64(control::Ptr{bqpb_control_type{Float64,
                                                                            Int64}},
                                             data::Ptr{Ptr{Cvoid}},
                                             status::Ptr{Int64}, n::Int64,
                                             H_type::Ptr{Cchar}, H_ne::Int64,
...
function bqpb_import(::Type{Float128}, ::Type{Int32}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
  @ccall libgalahad_quadruple.bqpb_import_q(control::Ptr{bqpb_control_type{Float128,
                                                                           Int32}},
                                            data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int32}, n::Int32,
                                            H_type::Ptr{Cchar}, H_ne::Int32,
...
function bqpb_import(::Type{Float128}, ::Type{Int64}, control, data, status, n,
                     H_type, H_ne, H_row, H_col, H_ptr)
...
function bqpb_reset_control(::Type{Float32}, ::Type{Int32}, control, data,
                            status)
...
function bqpb_reset_control(::Type{Float32}, ::Type{Int64}, control, data,
                            status)
...
function bqpb_reset_control(::Type{Float64}, ::Type{Int32}, control, data,
                            status)
...
function bqpb_reset_control(::Type{Float64}, ::Type{Int64}, control, data,
                            status)
...
function bqpb_reset_control(::Type{Float128}, ::Type{Int32}, control, data,
                            status)
...
function bqpb_reset_control(::Type{Float128}, ::Type{Int64}, control, data,
                            status)
...
function bqpb_solve_qp(::Type{Float32}, ::Type{Int32}, data, status, n, h_ne,
                       H_val, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_single.bqpb_solve_qp_s(data::Ptr{Ptr{Cvoid}},
                                           status::Ptr{Int32}, n::Int32,
...
function bqpb_solve_qp(::Type{Float32}, ::Type{Int64}, data, status, n, h_ne,
                       H_val, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_single_64.bqpb_solve_qp_s_64(data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int64}, n::Int64,
                                                 h_ne::Int64,
                                                 H_val::Ptr{Float32},
                                                 g::Ptr{Float32}, f::Float32,
...
function bqpb_solve_qp(::Type{Float64}, ::Type{Int32}, data, status, n, h_ne,
                       H_val, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_double.bqpb_solve_qp(data::Ptr{Ptr{Cvoid}},
                                         status::Ptr{Int32}, n::Int32,
...
function bqpb_solve_qp(::Type{Float64}, ::Type{Int64}, data, status, n, h_ne,
                       H_val, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_double_64.bqpb_solve_qp_64(data::Ptr{Ptr{Cvoid}},
                                               status::Ptr{Int64}, n::Int64,
...
function bqpb_solve_qp(::Type{Float128}, ::Type{Int32}, data, status, n, h_ne,
                       H_val, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_quadruple.bqpb_solve_qp_q(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, n::Int32,
...
function bqpb_solve_qp(::Type{Float128}, ::Type{Int64}, data, status, n, h_ne,
                       H_val, g, f, x_l, x_u, x, z, x_stat)
...
function bqpb_solve_sldqp(::Type{Float32}, ::Type{Int32}, data, status, n, w,
                          x0, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_single.bqpb_solve_sldqp_s(data::Ptr{Ptr{Cvoid}},
                                              status::Ptr{Int32}, n::Int32,
...
function bqpb_solve_sldqp(::Type{Float32}, ::Type{Int64}, data, status, n, w,
                          x0, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_single_64.bqpb_solve_sldqp_s_64(data::Ptr{Ptr{Cvoid}},
                                                    status::Ptr{Int64},
                                                    n::Int64, w::Ptr{Float32},
                                                    x0::Ptr{Float32},
                                                    g::Ptr{Float32}, f::Float32,
                                                    x_l::Ptr{Float32},
                                                    x_u::Ptr{Float32},
...
function bqpb_solve_sldqp(::Type{Float64}, ::Type{Int32}, data, status, n, w,
                          x0, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_double.bqpb_solve_sldqp(data::Ptr{Ptr{Cvoid}},
                                            status::Ptr{Int32}, n::Int32,
...
function bqpb_solve_sldqp(::Type{Float64}, ::Type{Int64}, data, status, n, w,
                          x0, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_double_64.bqpb_solve_sldqp_64(data::Ptr{Ptr{Cvoid}},
                                                  status::Ptr{Int64}, n::Int64,
                                                  w::Ptr{Float64},
                                                  x0::Ptr{Float64},
                                                  g::Ptr{Float64}, f::Float64,
...
function bqpb_solve_sldqp(::Type{Float128}, ::Type{Int32}, data, status, n, w,
                          x0, g, f, x_l, x_u, x, z, x_stat)
  @ccall libgalahad_quadruple.bqpb_solve_sldqp_q(data::Ptr{Ptr{Cvoid}},
                                                 status::Ptr{Int32}, n::Int32,
                                                 w::Ptr{Float128},
                                                 x0::Ptr{Float128},
                                                 g::Ptr{Float128}, f::Cfloat128,
...
function bqpb_solve_sldqp(::Type{Float128}, ::Type{Int64}, data, status, n, w,
                          x0, g, f, x_l, x_u, x, z, x_stat)
...
function run_sif(::Val{:bqpb}, ::Val{:single}, path_libsif::String,
                 path_outsdif::String)
...
function run_sif(::Val{:bqpb}, ::Val{:double}, path_libsif::String,
                 path_outsdif::String)
