...
!  -------------------------------------
  ...
  USE GALAHAD_CONVERT_double_ciface
  IMPLICIT NONE
...
!  ---------------------------------
!  C interface to fortran convert_inport
!  ---------------------------------

  SUBROUTINE convert_import( ccontrol, cdata, status ) BIND( C )
  USE GALAHAD_CONVERT_double_ciface
  IMPLICIT NONE
...
!  import the problem data into the required CONVERT structure

    CALL f_convert_import( fcontrol, fdata, status )
  ELSE
    CALL f_convert_import( fcontrol, fdata, status )
  END IF
...
!  copy control out
  ...
  END SUBROUTINE convert_import

!  ---------------------------------------
!  C interface to fortran convert_reset_control
!  ----------------------------------------

  SUBROUTINE convert_reset_control( ccontrol, cdata, status ) BIND( C )
  USE GALAHAD_CONVERT_double_ciface
  IMPLICIT NONE
...
!  import the control parameters into the required structure
  ...
  CALL f_CONVERT_reset_control( fcontrol, fdata, status )
  RETURN

  END SUBROUTINE convert_reset_control
