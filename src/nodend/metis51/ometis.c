 ...
 * ometis.c
 *
 * This file contains the top level routines for the multilevel 
 * nested-dieection algorithm OMETIS.
 *
 * Started 7/24/97
 * George
 *
 ...
 *
 * modified by Nick Gould, STFC-RAL, 2025-02-23 to remove unused variables
 * and procedures
 *
 */
