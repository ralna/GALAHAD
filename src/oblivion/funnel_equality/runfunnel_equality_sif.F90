...
!  October 17th 2007
   ...
   PROGRAM RUNFUNNEL_equality_SIF_precision
   USE GALAHAD_KINDS_precision
   USE GALAHAD_USEFUNNELE_precision
...
!  End of RUNFUNNEL_equality_SIF_precision

   END PROGRAM RUNFUNNEL_equality_SIF_precision
