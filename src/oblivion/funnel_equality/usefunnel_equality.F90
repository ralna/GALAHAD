...
!  Started: October 17th 2007
   ...
   MODULE GALAHAD_USEFUNNELE_precision
...
!  checks data, and calls the appropriate minimizers
     ...
     USE GALAHAD_FUNNELEQ_precision
...
!  Specfile characteristics
     ...
     CHARACTER ( LEN = 22 ) :: runspec = 'RUNFUNNEL_EQUALITY.SPC'
...
!  End of module USEFUNNEL
   ...
   END MODULE GALAHAD_USEFUNNELE_precision
