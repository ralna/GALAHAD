   PROGRAM GALAHAD_TR2_EXAMPLE  !  GALAHAD 4.2 - 2023-07-01 AT 14:00 GMT
   USE GALAHAD_TR2_double                       ! double precision version
   IMPLICIT NONE
...
!  control%print_level = 1
   ...
   IF ( inform%status == 0 ) THEN               ! Successful return
     WRITE( 6, "( ' TR2: ', I0, ' iterations -',                               &
    &     ' optimal objective value =',                                        &
    &       ES12.4, /, ' Optimal solution = ', ( 5ES12.4 ) )" )                &
     inform%iter, inform%obj, nlp%X
   ELSE                                         ! Error returns
     WRITE( 6, "( ' TR2_solve exit status = ', I6 ) " ) inform%status
   END IF
   ...
   END PROGRAM GALAHAD_TR2_EXAMPLE
