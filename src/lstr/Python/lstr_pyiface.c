...
bool lstr_update_control(struct lstr_control_type *control,
                         PyObject *py_options){
...
PyObject* lstr_make_inform_dict(const struct lstr_inform_type *inform){
...
static PyObject* py_lstr_solve_problem(PyObject *self, PyObject *args, PyObject *keywds){
   ...
   // Create NumPy output arrays
    ...
    solve_problem_return = Py_BuildValue("iNNN", status, py_x, py_u, py_v);
