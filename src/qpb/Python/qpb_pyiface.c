...
/*
 * THIS VERSION: GALAHAD 4.1 - 2023-04-05 AT 12:40 GMT.
 *
...
static PyObject* py_qpb_solve_qp(PyObject *self, PyObject *args){
...
static PyMethodDef qpb_module_methods[] = {
    ...
    {"solve_qp", (PyCFunction) py_qpb_solve_qp, METH_VARARGS, NULL},
