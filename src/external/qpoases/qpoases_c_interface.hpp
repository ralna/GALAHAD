...
#define QPOASES_WRAPPER_H
	...
	typedef unsigned long la_uint_t;
        ...
        #define qpOASES_c_solve qpOASES_c_solve_sgl_64
        #else
        #define qpOASES_c_solve qpOASES_c_solve_sgl
        #endif
        #else
	#ifdef __USE_LONG_INTEGERS__
        #define qpOASES_c_solve qpOASES_c_solve_dbl_64
        #else
        #define qpOASES_c_solve qpOASES_c_solve_dbl
        #endif
        #endif
