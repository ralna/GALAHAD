! THIS VERSION: GALAHAD 5.4 - 2025-11-22 AT 12:00 GMT.
   PROGRAM GALAHAD_NREK_2ND_EXAMPLE
...
!  control%it_max = 2
   ...
   IF ( inform%status == 0 ) THEN
     ...
     WRITE( 6, "( ' weight, ||x||, f, multiplier =',  2ES11.4, 2ES12.4 )" )    &
       weight, TWO_NORM( X ), inform%obj, inform%multiplier
   ELSE
   ...
   END PROGRAM GALAHAD_NREK_2ND_EXAMPLE
