! THIS VERSION: GALAHAD 2.5 - 09/02/2013 AT 17:35 GMT.
...
!     INTEGER :: np1, npm
      ...
      INTEGER :: alloc_stat, cutest_status, newton, A_ne, H_ne, iter
...
!  End of module USECQPS_double

   END MODULE GALAHAD_USECQPS_double
