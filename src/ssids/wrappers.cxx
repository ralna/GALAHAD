...
/* _GEMM */
template <>
void host_gemm_64<float>(enum galahad::ssids::cpu::operation transa, 
...
/* _GEMV */
template <>
void gemv_64<float>(enum galahad::ssids::cpu::operation trans, 
...
/* _POTRF */
template<>
int64_t lapack_potrf_64<float>(enum galahad::ssids::cpu::fillmode uplo, 
                               int64_t n, float* a, int64_t lda) {
   char fuplo;
   switch(uplo) {
      case galahad::ssids::cpu::FILL_MODE_LWR: fuplo = 'L'; break;
      case galahad::ssids::cpu::FILL_MODE_UPR: fuplo = 'U'; break;
...
template<>
int64_t lapack_sytrf_64<float>(enum galahad::ssids::cpu::fillmode uplo, 
                               int64_t n, float* a, int64_t lda, 
...
/* _SYRK */
template <>
void host_syrk_64<float>(enum galahad::ssids::cpu::fillmode uplo, 
...
/* _TRSV */
template <>
void host_trsv_64<float>(enum galahad::ssids::cpu::fillmode uplo, 
                         enum galahad::ssids::cpu::operation trans, 
...
/* _TRSM */
template <>
void host_trsm_64<float>(enum galahad::ssids::cpu::side side, 
...
/* _GEMM */
template <>
void host_gemm<float>(enum galahad::ssids::cpu::operation transa, 
                      enum galahad::ssids::cpu::operation transb, 
...
/* _GEMV */
template <>
void gemv<float>(enum galahad::ssids::cpu::operation trans, 
...
/* _POTRF */
template<>
int lapack_potrf<float>(enum galahad::ssids::cpu::fillmode uplo, 
...
/* _SYTRF - Bunch-Kaufman factorization */
template<>
int lapack_sytrf<float>(enum galahad::ssids::cpu::fillmode uplo, 
                        int n, float* a, int lda, 
...
/* _SYRK */
template <>
void host_syrk<float>(enum galahad::ssids::cpu::fillmode uplo, 
                      enum galahad::ssids::cpu::operation trans, 
...
/* _TRSV */
template <>
void host_trsv<float>(enum galahad::ssids::cpu::fillmode uplo, 
                      enum galahad::ssids::cpu::operation trans, 
                      enum galahad::ssids::cpu::diagonal diag, 
                      int n, const float* a, int lda, 
                      float* x, int incx) {
...
/* _TRSM */
template <>
void host_trsm<float>(enum galahad::ssids::cpu::side side, 
                      enum galahad::ssids::cpu::fillmode uplo, 
                      enum galahad::ssids::cpu::operation transa, 
                      enum galahad::ssids::cpu::diagonal diag, 
                      int m, int n, float alpha, const float* a, 
...
/* _GEMM */
template <>
void host_gemm_64<double>(enum galahad::ssids::cpu::operation transa, 
                          enum galahad::ssids::cpu::operation transb, 
...
/* _GEMV */
template <>
void gemv_64<double>(enum galahad::ssids::cpu::operation trans, 
...
/* _POTRF */
template<>
int64_t lapack_potrf_64<double>(enum galahad::ssids::cpu::fillmode uplo, 
...
/* _SYTRF - Bunch-Kaufman factorization */
template<>
int64_t lapack_sytrf_64<double>(enum galahad::ssids::cpu::fillmode uplo, 
                                int64_t n, double* a, 
...
/* _SYRK */
template <>
void host_syrk_64<double>(enum galahad::ssids::cpu::fillmode uplo, 
                          enum galahad::ssids::cpu::operation trans, 
...
/* _TRSV */
template <>
void host_trsv_64<double>(enum galahad::ssids::cpu::fillmode uplo, 
                          enum galahad::ssids::cpu::operation trans, 
                          enum galahad::ssids::cpu::diagonal diag, 
                          int64_t n, const double* a, int64_t lda, 
                          double* x, int64_t incx) {
...
/* _TRSM */
template <>
void host_trsm_64<double>(enum galahad::ssids::cpu::side side, 
                          enum galahad::ssids::cpu::fillmode uplo, 
                          enum galahad::ssids::cpu::operation transa, 
                          enum galahad::ssids::cpu::diagonal diag, 
                          int64_t m, int64_t n, double alpha, const double* a, 
...
/* _GEMM */
template <>
void host_gemm<double>(enum galahad::ssids::cpu::operation transa, 
                       enum galahad::ssids::cpu::operation transb, 
...
/* _GEMV */
template <>
void gemv<double>(enum galahad::ssids::cpu::operation trans, 
...
/* _POTRF */
template<>
int lapack_potrf<double>(enum galahad::ssids::cpu::fillmode uplo, 
...
/* _SYTRF - Bunch-Kaufman factorization */
template<>
int lapack_sytrf<double>(enum galahad::ssids::cpu::fillmode uplo, 
...
/* _SYRK */
template <>
void host_syrk<double>(enum galahad::ssids::cpu::fillmode uplo, 
                       enum galahad::ssids::cpu::operation trans, 
...
/* _TRSV */
template <>
void host_trsv<double>(enum galahad::ssids::cpu::fillmode uplo, 
                       enum galahad::ssids::cpu::operation trans, 
                       enum galahad::ssids::cpu::diagonal diag, 
                       int n, const double* a, int lda, 
                       double* x, int incx) {
...
/* _TRSM */
template <>
void host_trsm<double>(enum galahad::ssids::cpu::side side, 
                       enum galahad::ssids::cpu::fillmode uplo, 
                       enum galahad::ssids::cpu::operation transa, 
                       enum galahad::ssids::cpu::diagonal diag, 
                       int m, int n, double alpha, const double* a, 
