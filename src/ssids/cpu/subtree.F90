...
module spral_ssids_cpu_subtree
  ...
  interface
     type(C_PTR) function c_create_symbolic_subtree(n, sa, en, sptr, sparent, &
       ...
       implicit none
       integer(ipc_), value :: n
       integer(ipc_), value :: sa
       integer(ipc_), value :: en
       integer(ipc_), dimension(*), intent(in) :: sptr
       integer(ipc_), dimension(*), intent(in) :: sparent
       integer(C_INT64_T), dimension(*), intent(in) :: rptr
       integer(ipc_), dimension(*), intent(in) :: rlist
       integer(C_INT64_T), dimension(*), intent(in) :: nptr
       integer(C_INT64_T), dimension(*), intent(in) :: nlist
       integer(ipc_), value :: ncontrib
       integer(ipc_), dimension(*), intent(in) :: contrib_idx
     ...
     type(C_PTR) function c_create_numeric_subtree(posdef, symbolic_subtree, &
       ...
       real(rpc_), dimension(*), intent(in) :: aval
     ...
     integer(ipc_) function c_subtree_solve_fwd(posdef, subtree, nrhs, x, &
          ldx) &
       ...
       logical(C_BOOL), value :: posdef
       type(C_PTR), value :: subtree
       integer(ipc_), value :: nrhs
       real(rpc_), dimension(*), intent(inout) :: x
       integer(ipc_), value :: ldx
     end function c_subtree_solve_fwd

     integer(ipc_) function c_subtree_solve_diag(posdef, subtree, nrhs, x, &
          ldx) &
     ...
     integer(ipc_) function c_subtree_solve_diag_bwd(posdef, subtree, nrhs, &
          x, ldx) &
     ...
     integer(ipc_) function c_subtree_solve_bwd(posdef, subtree, nrhs, x, &
          ldx) &
     ...
     subroutine c_subtree_alter(posdef, subtree, d) &
       ...
       logical(C_BOOL), value :: posdef
       type(C_PTR), value :: subtree
       real(rpc_), dimension(*), intent(in) :: d
...
10  continue
  ...
  subroutine enquire_indef(this, piv_order, d)
    implicit none
    class(cpu_numeric_subtree), intent(in) :: this
    integer ( kind = ip_ ), dimension(*), target, OPTIONAL, intent(out) :: piv_order
