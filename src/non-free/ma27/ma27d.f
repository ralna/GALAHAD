...
C  17/9/09. Bug corrected in MA27HD.  Also some tidying of code in MA27HD
     ...
     +                 ICNTL,CNTL,INFO,OPS)
      ...
      DOUBLE PRECISION, INTENT( IN ), DIMENSION( 5 ) :: CNTL
      DOUBLE PRECISION, INTENT( OUT ) :: ops
  ...
  200 CONTINUE
     ...
     +                 IW1,ICNTL,CNTL,INFO)
      ...
      INTEGER, INTENT( IN ), DIMENSION( 30 ) :: ICNTL
      INTEGER, INTENT( OUT ), DIMENSION( 20 ) :: INFO
      DOUBLE PRECISION, INTENT( INOUT ), DIMENSION( la ) :: A
      DOUBLE PRECISION, INTENT( IN ), DIMENSION( 5 ) :: CNTL
  ...
  310 RETURN
     ...
     + ICNTL,INFO)
      ...
      DOUBLE PRECISION, INTENT( IN ), DIMENSION( la ) :: A
      DOUBLE PRECISION, INTENT( OUT ), DIMENSION( maxfrt ) :: W
      DOUBLE PRECISION, INTENT( INOUT ), DIMENSION( n ) :: RHS
      INTEGER, INTENT( IN ), DIMENSION( 30 ) :: ICNTL
      INTEGER, INTENT( OUT ), DIMENSION( 20 ) :: INFO
...
!            write(6,*) ' rmax', rmax
!            write(6,*) ' apos', apos
!            write(6,*) ' aapos', a(apos)
!            IF (ABS(A(APOS)).GT.MAX(CNTL(3),UU*RMAX)) GO TO 450
