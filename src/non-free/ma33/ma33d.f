...
C
     ...
     +                  IFLAG,ICNTL,CNTL,INFO,RINFO)
      ...
      DOUBLE PRECISION, INTENT( INOUT ), DIMENSION( licn ) :: A
      DOUBLE PRECISION, INTENT( OUT ), DIMENSION( 5 ) :: RINFO
...
99999 FORMAT (' Error return from MA33B/BD singularity detected in',
     ...
     +                  MTYPE,RINFO)
      ...
      DOUBLE PRECISION, INTENT( IN ), DIMENSION( licn ) :: A
      DOUBLE PRECISION, INTENT( OUT ), DIMENSION( n ) :: W
      DOUBLE PRECISION, INTENT( INOUT ), DIMENSION( n ) :: X
      DOUBLE PRECISION, INTENT( INOUT ), DIMENSION( 5 ) :: RINFO
