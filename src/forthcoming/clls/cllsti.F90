...
#include "galahad_modules.h"
   ...
   INTEGER ( KIND = ip_ ) :: n, m, L_ne, H_ne
   ...
   INTEGER ( KIND = ip_ ), ALLOCATABLE, DIMENSION( : ) :: L_row, L_col, L_ptr
   REAL ( KIND = rp_ ), ALLOCATABLE, DIMENSION( : ) :: L_val, L_dense, H_zero
...
! set up problem data
   ...
   L_val = (/ 2.0_rp_, 1.0_rp_, 1.0_rp_, 1.0_rp_ /)
   L_row = (/ 1, 1, 2, 2 /)
   L_col = (/ 1, 2, 2, 3 /)
   L_ptr = (/ 1, 3, 5 /)
   ...
   L_dense = (/ 2.0_rp_, 1.0_rp_, 0.0_rp_, 0.0_rp_, 1.0_rp_, 1.0_rp_ /)
