...
int main(void) {
    ...
    int L_row[] = {1, 1, 2, 2}; // row indices
    int L_col[] = {1, 2, 2, 3}; // column indices
    int L_ptr[] = {1, 3, 5}; // row pointers
    real_wp_ L_val[] = {2.0, 1.0, 1.0, 1.0 }; // values
    ...
    for( int d=1; d <= 7; d++){
        ...
        switch(d){
            ...
            case 3: // dense
                ...
                real_wp_ L_dense[] = {2.0, 1.0, 0.0, 0.0, 1.0, 1.0};
                clls_import( &control, &data, &status, n, m,
