   PROGRAM GALAHAD_QPF2_EXAMPLE  !  GALAHAD 5.1 - 2024-10-28 AT 08:20 GMT.
...
! problem data complete
   ...
   CALL QPF_initialize( data, control, inform ) ! Initialize control parameters
