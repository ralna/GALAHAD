...
!-*-*-*-*-*-*-*-*-*-   U S E _ P D Q P  S U B R O U T I N E   -*-*-*-*-*-*-*-*-

     SUBROUTINE USE_PDQP( input )
...
!                    x_l <=  x <= x_u
!
!  where H is an M-matrix using the GALAHAD package GALAHAD_PDQP
!
!  --------------------------------------------------------------------
...
!  The default values for PDQP could have been set as:

! BEGIN RUNPDQP SPECIFICATIONS (DEFAULT)
!  write-problem-data                        NO
!  problem-data-file-name                    PDQP.data
...
!  write-solution                            NO
!  solution-file-name                        PDQPSOL.d
!  solution-file-device                      62
!  write-result-summary                      NO
!  result-summary-file-name                  PDQPRES.d
!  result-summary-file-device                47
!  perturb-bounds-by                         0.0
! END RUNPDQP SPECIFICATIONS
...
!  Default values for specfile-defined parameters
      ...
      CHARACTER ( LEN = 30 ) :: dfilename = 'PDQP.data'
      CHARACTER ( LEN = 30 ) :: ifilename = 'INITIAL.SIF'
      CHARACTER ( LEN = 30 ) :: pfilename = 'PRESOLVE.SIF'
      CHARACTER ( LEN = 30 ) :: rfilename = 'PDQPRES.d'
      CHARACTER ( LEN = 30 ) :: sfilename = 'PDQPSOL.d'
...
!  Deallocate arrays from the minimization
        ...
        status = PDQP_inform%status
        iter = PDQP_inform%iter
        CALL PDQP_terminate( data, PDQP_control, PDQP_inform )
