...
static struct bqpb_control_type control;  // control struct
static struct bqpb_inform_type inform;    // inform struct
...
PyObject* bqpb_make_options_dict(const struct bqpb_control_type *control){
...
static PyObject* bqpb_make_time_dict(const struct bqpb_time_type *time){
...
static PyObject* bqpb_make_inform_dict(const struct bqpb_inform_type *inform){
    ...
    PyDict_SetItemString(py_inform, "time",
                         bqpb_make_time_dict(&inform->time));
...
static PyObject* py_bqpb_initialize(PyObject *self){

    // Call bqpb_initialize
    bqpb_initialize(&data, &control, &status);

    // Record that BQPB has been initialised
    init_called = true;
...
static PyObject* py_bqpb_load(PyObject *self, PyObject *args, PyObject *keywds){
    ...
    bqpb_reset_control(&control, &data, &status);

    // Update BQPB control options
    if(!bqpb_update_control(&control, py_options))
        return NULL;
...
static PyObject* py_bqpb_solve_qp(PyObject *self, PyObject *args, PyObject *keywds){
...
static PyObject* py_bqpb_solve_sldqp(PyObject *self, PyObject *args, PyObject *keywds){
    PyArrayObject *py_g, *py_w, *py_x0;
    PyArrayObject *py_x_l, *py_x_u;
    PyArrayObject *py_x, *py_z;
    ...
    // Parse positional arguments
    static char *kwlist[] = {"n","f","g","w","x0","x_l","x_u","x","z",NULL};
    if(!PyArg_ParseTupleAndKeywords(args, keywds, "idOOOOOOO", kwlist, &n, &f, &py_g,
    ...
    // Call bqpb_solve_direct
    status = 1; // set status to 1 on entry
    bqpb_solve_sldqp(&data, &status, n, w, x0, g, f,
                     x_l, x_u, x, z, x_stat);
...
static PyObject* py_bqpb_information(PyObject *self){

    // Check that package has been initialised
    if(!check_init(init_called))
        return NULL;

    // Call bqpb_information
...
static PyObject* py_bqpb_terminate(PyObject *self){
...
//  *-*-*-*-*-*-*-*-*-*-   INITIALIZE BQPB PYTHON MODULE    -*-*-*-*-*-*-*-*-*-*

/* bqpb python module method table */
static PyMethodDef bqpb_module_methods[] = {
    {"initialize", (PyCFunction) py_bqpb_initialize, METH_NOARGS, NULL},
    {"load", (PyCFunction) py_bqpb_load, METH_VARARGS | METH_KEYWORDS, NULL},
    {"solve_qp", (PyCFunction) py_bqpb_solve_qp, METH_VARARGS | METH_KEYWORDS, NULL},
    {"solve_sldqp", (PyCFunction) py_bqpb_solve_sldqp, METH_VARARGS | METH_KEYWORDS, NULL},
    {"information", (PyCFunction) py_bqpb_information, METH_NOARGS, NULL},
    {"terminate", (PyCFunction) py_bqpb_terminate, METH_NOARGS, NULL},
    {NULL, NULL, 0, NULL}  /* Sentinel */
};

/* bqpb python module documentation */

PyDoc_STRVAR(bqpb_module_doc,

"The bqpb package uses a primal-dual interior-point method to solve a \n"
"bound-constrained convex quadratic programming problem.\n"
...
"H, the vectors g, w, x^0, x^l, x^u and the scalar f are given.\n"
"Any of the constraint bounds x_j^l and x_j^u may be infinite.\n"
"The method offers the choice of direct and iterative solution of the key\n"
"regularization subproblems, and is most suitable for problems\n"
"involving a large number of unknowns x.\n"
"\n"
"See $GALAHAD/html/Python/bqpb.html for argument lists, call order\n"
"and other details.\n"
"\n"
);

/* bqpb python module definition */
static struct PyModuleDef module = {
   PyModuleDef_HEAD_INIT,
   "bqpb",               /* name of module */
   bqpb_module_doc,      /* module documentation, may be NULL */
   -1,                  /* size of per-interpreter state of the module,or -1
                           if the module keeps state in global variables */
   bqpb_module_methods   /* module methods */
};

/* Python module initialization */
PyMODINIT_FUNC PyInit_bqpb(void) { // must be same as module name above
