...
!   http://galahad.rl.ac.uk/galahad-www/specs.html
  ...
  MODULE GALAHAD_BLLSB_precision_ciface
    USE GALAHAD_KINDS_precision
    USE GALAHAD_common_ciface
    USE GALAHAD_BLLSB_precision, ONLY:                                         &
        f_bllsb_control_type   => BLLSB_control_type,                          &
        f_bllsb_time_type      => BLLSB_time_type,                             &
        f_bllsb_inform_type    => BLLSB_inform_type,                           &
        f_bllsb_full_data_type => BLLSB_full_data_type,                        &
        f_bllsb_initialize     => BLLSB_initialize,                            &
...
!-------------------------------------------------
    ...
    TYPE, BIND( C ) :: bllsb_control_type
    ...
    END TYPE bllsb_control_type

    TYPE, BIND( C ) :: bllsb_time_type
    ...
    END TYPE bllsb_time_type

    TYPE, BIND( C ) :: bllsb_inform_type
...
!  copy C control parameters to fortran
    ...
    TYPE ( bllsb_control_type ), INTENT( IN ) :: ccontrol
    TYPE ( f_bllsb_control_type ), INTENT( OUT ) :: fcontrol
...
!  copy fortran control parameters to C
    ...
    TYPE ( f_bllsb_control_type ), INTENT( IN ) :: fcontrol
    TYPE ( bllsb_control_type ), INTENT( OUT ) :: ccontrol
...
!  copy C time parameters to fortran
    ...
    TYPE ( bllsb_time_type ), INTENT( IN ) :: ctime
    TYPE ( f_bllsb_time_type ), INTENT( OUT ) :: ftime
...
!  copy fortran time parameters to C
    ...
    TYPE ( f_bllsb_time_type ), INTENT( IN ) :: ftime
    TYPE ( bllsb_time_type ), INTENT( OUT ) :: ctime
...
!  copy C inform parameters to fortran
    ...
    TYPE ( bllsb_inform_type ), INTENT( IN ) :: cinform
    TYPE ( f_bllsb_inform_type ), INTENT( OUT ) :: finform
    INTEGER ( KIND = ip_ ) :: i
...
!  copy fortran inform parameters to C
    ...
    TYPE ( f_bllsb_inform_type ), INTENT( IN ) :: finform
    TYPE ( bllsb_inform_type ), INTENT( OUT ) :: cinform
    INTEGER ( KIND = ip_ ) :: i, l
  ...
  END MODULE GALAHAD_BLLSB_precision_ciface

!  -------------------------------------
!  C interface to fortran bllsb_initialize
!  -------------------------------------

  SUBROUTINE bllsb_initialize( cdata, ccontrol, status ) BIND( C )
...
!  local variables
  ...
  TYPE ( f_bllsb_full_data_type ), POINTER :: fdata
  TYPE ( f_bllsb_control_type ) :: fcontrol
  TYPE ( f_bllsb_inform_type ) :: finform
  LOGICAL :: f_indexing
...
!  initialize required fortran types
  ...
  CALL f_bllsb_initialize( fdata, fcontrol, finform )
...
!  ----------------------------------------
!  C interface to fortran bllsb_read_specfile
!  ----------------------------------------

  SUBROUTINE bllsb_read_specfile( ccontrol, cspecfile ) BIND( C )
  USE GALAHAD_BLLSB_precision_ciface
  IMPLICIT NONE

!  dummy arguments

  TYPE ( bllsb_control_type ), INTENT( INOUT ) :: ccontrol
...
!  read control parameters from the specfile
  ...
  CALL f_bllsb_read_specfile( fcontrol, device )
...
!  ---------------------------------
!  C interface to fortran bllsb_inport
!  ---------------------------------

  SUBROUTINE bllsb_import( ccontrol, cdata, status, n, o, caotype, aone,       &
...
!  import the problem data into the required BLLSB structure

  CALL f_bllsb_import( fcontrol, fdata, status, n, o,                          &
...
!  ------------------------------------------
!  C interface to fortran bllsb_reset_control
!  ------------------------------------------

  SUBROUTINE bllsb_reset_control( ccontrol, cdata, status ) BIND( C )
  USE GALAHAD_BLLSB_precision_ciface
  IMPLICIT NONE
...
!  import the control parameters into the required structure
  ...
  CALL f_bllsb_reset_control( fcontrol, fdata, status )
  RETURN
...
!  ----------------------------------------
  ...
  SUBROUTINE bllsb_information( cdata, cinform, status ) BIND( C )
  USE GALAHAD_BLLSB_precision_ciface
  IMPLICIT NONE
...
!  dummy arguments
  ...
  TYPE ( C_PTR ), INTENT( INOUT ) :: cdata
  TYPE ( bllsb_inform_type ), INTENT( INOUT ) :: cinform
  INTEGER ( KIND = ipc_ ), INTENT( OUT ) :: status
...
!  obtain BLLSB solution information

  CALL f_bllsb_information( fdata, finform, status )
...
!  --------------------------------------
!  C interface to fortran bllsb_terminate
!  --------------------------------------

  SUBROUTINE bllsb_terminate( cdata, ccontrol, cinform ) BIND( C )
  USE GALAHAD_BLLSB_precision_ciface
  IMPLICIT NONE
...
!  deallocate workspace
  ...
  CALL f_bllsb_terminate( fdata, fcontrol, finform )
