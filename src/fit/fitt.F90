...
#include "galahad_modules.h"
   ...
   INTEGER ( KIND = ip_ ) :: i, m
!   INTEGER ( KIND = ip_ ), PARAMETER :: n = 9
!  INTEGER ( KIND = ip_ ), PARAMETER :: n = 16
   INTEGER ( KIND = ip_ ), PARAMETER :: n = 7
   REAL ( KIND = rp_ ), DIMENSION( n ) :: ALPHA, F, COEF
!   ALPHA = (/ 0.5_rp_, 1.0_rp_, 1.0_rp_, 1.0_rp_, 1.0_rp_, 1.0_rp_, &
!              1.0_rp_, 1.0_rp_, 2.0_rp_ /)
!  ALPHA = (/    0.000010000000000_rp_,    0.000010000000000_rp_,             &
!                0.000010000000000_rp_,    0.000010000000000_rp_,             &
!                0.000100000000000_rp_,    0.000100000000000_rp_,             &
!                0.000100000000000_rp_,    0.000100000000000_rp_,             &
!                0.001000000000000_rp_,    0.001000000000000_rp_,             &
!                0.001000000000000_rp_,    0.001000000000000_rp_,             &
!                0.010000000000000_rp_,    0.010000000000000_rp_,             &
!                0.010000000000000_rp_,    0.010000000000000_rp_ /)
!  ALPHA = (/    0.000010000000000_rp_,    0.000010000000000_rp_,             &
!                0.000100000000000_rp_,    0.000100000000000_rp_,             &
!                0.001000000000000_rp_,    0.001000000000000_rp_,             &
