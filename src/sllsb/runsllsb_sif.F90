...
!-*-*-*-*-*-*-*-*-  G A L A H A D   R U N S L L S B _ S I F  *-*-*-*-*-*-*-*-*-
...
!   http://galahad.rl.ac.uk/galahad-www/specs.html
   ...
   PROGRAM RUNSLLSB_SIF_precision

!    ---------------------------------------------------
!    | Main program for the SIF/CUTEst interface to    |
!    | SLLSB, an interior-point crossover algorithm for |
!    | constrained linear least-squares optimization   |
!    ---------------------------------------------------

   USE GALAHAD_KINDS_precision
   USE GALAHAD_USESLLSB_precision
...
!  Call the CUTEst interface
   ...
   CALL USE_SLLSB( input, close_input = .TRUE. )
...
!  End of RUNSLLSB_SIF_precision

   END PROGRAM RUNSLLSB_SIF_precision
