...
#include "galahad_metis51.h" /* from MeTiS 5.1 */

#include "stdio.h"

/* name change to avoid any possible conflicts */

void galahad_metis51_adapter(idx_t* nvtxs, idx_t* xadj, idx_t* adjncy,
...
/*
    options5[METIS_OPTION_UFACTOR] =  OMETIS_DEFAULT_UFACTOR;
    ...
    options5[METIS_OPTION_UFACTOR] = 1;
    options5[METIS_OPTION_DBGLVL] = 2;
*/
