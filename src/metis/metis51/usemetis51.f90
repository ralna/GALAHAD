...
!   http://galahad.rl.ac.uk/galahad-www/specs.html
    ...
    MODULE GALAHAD_USEMETIS51_precision
...
!  check to see if the MeTiS ordering packages is available
     ...
     CALL galahad_metis51_setopt( ICNTL_metis )
     CALL galahad_metis51( n_dum, PTR_dum, ROW_dum, 1_ip_, ICNTL_metis,        &
                           INVP_dum, PERM_dum )
...
!  call the MeTiS ordering packages
      ...
      ICNTL_metis( 1 ) = 1
      ICNTL_metis( 5 ) = 2
      CALL galahad_metis51( nm, K_ptr, K_row, 1_ip_, ICNTL_metis, INVP, PERM )
      CALL CPU_TIME( time ) ; CALL CLOCK_time( clock )
      WRITE( out, "( ' Metis 5.1 clock time = ', F6.2 )" ) clock - clocks
...
!  End of subroutine USE_METIS51

     END SUBROUTINE USE_METIS51

!  End of module USEMETIS51

   END MODULE GALAHAD_USEMETIS51_precision
