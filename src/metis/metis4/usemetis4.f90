! THIS VERSION: GALAHAD 5.2 - 2025-02-20 AT 12:00 GMT.

#include "galahad_modules.h"
#include "cutest_routines.h"

!-*-*-*-*-*-*-*-  G A L A H A D   U S E M E T I S 4  M O D U L E  -*-*-*-*-*-*-
...
!   http://galahad.rl.ac.uk/galahad-www/specs.html
    ...
    MODULE GALAHAD_USEMETIS4_precision
...
!  check to see if the MeTiS ordering packages is available
     ...
     CALL galahad_metis4_setopt( ICNTL_metis )
     CALL galahad_metis4( n_dum, PTR_dum, ROW_dum, 1_ip_, ICNTL_metis,        &
                           INVP_dum, PERM_dum )
...
!  call the MeTiS ordering packages
      ...
      ICNTL_metis( 1 ) = 1
      ICNTL_metis( 5 ) = 1
      CALL galahad_metis4( nm, K_ptr, K_row, 1_ip_, ICNTL_metis, INVP, PERM )
      CALL CPU_TIME( time ) ; CALL CLOCK_time( clock )
      WRITE( out, "( ' Metis 4.0 clock time = ', F6.2 )" ) clock - clocks
...
!  End of subroutine USE_METIS4

     END SUBROUTINE USE_METIS4

!  End of module USEMETIS4

   END MODULE GALAHAD_USEMETIS4_precision
