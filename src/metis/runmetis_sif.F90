...
!   http://galahad.rl.ac.uk/galahad-www/specs.html
   ...
   PROGRAM RUNMETIS_SIF_precision

!    -------------------------------------------------------
!    | Main program for the SIF/CUTEst interface to METIS, |
!    | a method for ordering symmetric sparse matices      |
!    -------------------------------------------------------

   USE GALAHAD_KINDS_precision
   USE GALAHAD_USEMETIS_precision
...
!  End of RUNMETIS_SIF_precision

   END PROGRAM RUNMETIS_SIF_precision
