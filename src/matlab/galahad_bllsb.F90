...
!  THIS VERSION: GALAHAD 5.5 - 2026-03-24 AT 16:20 GMT.
...
!    minimize 0.5 * || A x - b||_W^2 + 0.5 * sigma ||x_x_s||^2
...
!  local variables
      ...
      mwSize :: s_len
      mwPointer :: b_pr, sigma_pr, xl_pr, xu_pr, w_pr, xs_pr
      mwPointer :: ao_in, b_in, xl_in, xu_in
      mwPointer :: sigma_in, w_in, xs_in, c_in, i_in
      mwPointer :: x_pr, z_pr, x_status_pr, r_pr
      mwPointer :: aux_r_pr, aux_z_pr, aux_x_status_pr
