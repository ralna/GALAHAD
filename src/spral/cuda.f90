...
contains
  ...
  integer(C_INT) function cudaMemcpyAsync_H2D(dst, src, cnt, stream)
    use, intrinsic :: iso_c_binding
    implicit none
    type(C_PTR), value :: dst
    type(C_PTR), value :: src
    ...
    cudaMemcpyAsync_H2D = cudaMemcpyAsync(dst, src, cnt, &
         cudaMemcpyHostToDevice, stream)
  end function cudaMemcpyAsync_H2D
  integer(C_INT) function cudaMemcpyAsync_D2H(dst, src, cnt, stream)
    use, intrinsic :: iso_c_binding
    implicit none
    type(C_PTR), value :: dst
    type(C_PTR), value :: src
    ...
    cudaMemcpyAsync_D2H = cudaMemcpyAsync(dst, src, cnt, &
         cudaMemcpyDeviceToHost, stream)
  end function cudaMemcpyAsync_D2H
  integer(C_INT) function cudaMemcpyAsync_D2D(dst, src, cnt, stream)
    use, intrinsic :: iso_c_binding
    implicit none
    type(C_PTR), value :: dst
    type(C_PTR), value :: src
    ...
    cudaMemcpyAsync_D2D = cudaMemcpyAsync(dst, src, cnt, &
