...
!    USE IEEE_ARITHMETIC
     ...
     PUBLIC :: TRU_initialize, TRU_read_specfile, TRU_solve,                   &
               TRU_terminate, NLPT_problem_type, USERDATA_type,        &
               SMT_type, SMT_put,                                              &
...
!    LOGICAL, PARAMETER  :: test_s = .FALSE.
     ...
     REAL ( KIND = rp_ ), PARAMETER :: skip_sr1 = ten ** ( - 8 )
...
!  models
     ...
     INTEGER ( KIND = ip_ ), PARAMETER  :: bfgs_hessian_model = 7
     INTEGER ( KIND = ip_ ), PARAMETER  :: sr1_hessian_model = 8
...
!   specify the semi-bandwidth of the band matrix P if required
       ...
       INTEGER ( KIND = ip_ ) :: semi_bandwidth = 10
...
!  - - - - - - - - - -
     ...
     TYPE, PUBLIC :: TRU_data_type
       ...
       INTEGER ( KIND = ip_ ) :: gltr_inform_status, ref( 1 )
...
!  End of module GALAHAD_TRU
   ...
   END MODULE GALAHAD_TRU_precision
