...
!    --------------
        ...
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: COLSCA_loc
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: ROWSCA_loc
        INTEGER ( KIND = ip_ ), DIMENSION(:), POINTER :: ROWIND, COLIND
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: PIVOTS
!
!       ------------------------------------
...
!       ------------------------------------
        ...
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: A_loc, pad2
!
!    ----------------------------------------
...
!    ----------------------------------------
        ...
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: A_ELT, pad4
!
!    ---------------------------------------------
...
!    -------------------------------------------------------
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: RHS, REDRHS
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: RHS_SPARSE
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: SOL_loc
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: RHS_loc
...
!    ---------------------------
        ...
        REAL ( KIND = r16_ ) ::  COST_SUBTREES
        REAL ( KIND = r16_ ) ::  CNTL(15)
        REAL ( KIND = r16_ ) ::  RINFO(40)
        REAL ( KIND = r16_ ) ::  RINFOG(40)
...
!    -----
        ...
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: SCHUR
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: SCHUR_CINTERFACE
...
!       main real working arrays for factorization/solve phases
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: S
...
!       Compressed RHS
        ...
        REAL ( KIND = r16_ ), DIMENSION(:),   POINTER :: RHSINTR
!       Info on the subtrees to be used during factorization
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: MEM_SUBTREE
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: COST_TRAV
...
! for Rank-Revealing on root
        REAL ( KIND = r16_ ), DIMENSION(:), POINTER :: SINGULAR_VALUES
