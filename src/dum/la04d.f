...
!-----------------------------------------------
      ...
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( la ) :: A
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( m ) :: B
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( 2, kb ) :: BND
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( n ) :: C
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( 15 ) :: CNTL
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( 40 ) :: RINFO
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( n + m ) :: X
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( n ) :: Z
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( n ) :: G
      REAL ( KIND = KIND( 1.0D+0 ) ), INTENT( INOUT ), DIMENSION( lws ) :: WS
