...
!-*-*-*-  G A L A H A D  -  D U M M Y   P A R D I S O  R O U T I N E S  -*-*-*-
  ...
  TYPE(MKL_PARDISO_HANDLE), INTENT(INOUT) :: PT(*)
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: MAXFCT
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: MNUM
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: MTYPE
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: PHASE
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: N
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: IA(*)
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: JA(*)
  INTEGER( KIND = C_INT64_T ), INTENT(INOUT) :: PERM(*)
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: NRHS
  INTEGER( KIND = C_INT64_T ), INTENT(INOUT) :: IPARM(*)
  INTEGER( KIND = C_INT64_T ), INTENT(IN)    :: MSGLVL
  INTEGER( KIND = C_INT64_T ), INTENT(OUT)   :: ERROR
  REAL( KIND = sp ), INTENT(IN)    :: A(*)
  REAL( KIND = sp ), INTENT(INOUT) :: B(*)
  REAL( KIND = sp ), INTENT(OUT)   :: X(*)
  ...
  REAL( KIND = dp ), INTENT(INOUT) :: B(*)
  REAL( KIND = dp ), INTENT(OUT)   :: X(*)
  ERROR = INT( GALAHAD_unavailable_option, KIND = C_INT64_T )
