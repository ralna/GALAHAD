...
module hsl_ma57_single
   ...
   type ma57_sinfo
      real(sp_) :: cond = -1.0_sp_  ! Condition # of matrix (cat 1 equations)
      real(sp_) :: cond2 = -1.0_sp_ ! Condition # of matrix (cat 2 equations)
      real(sp_) :: berr = -1.0_sp_  ! Condition # of matrix (cat 1 equations)
      real(sp_) :: berr2 = -1.0_sp_ ! Condition # of matrix (cat 2 equations)
