...
!-*-*-*-*-  G A L A H A D  -  D U M M Y   M I 3 5   M O D U L E  -*-*-*-
  ...
  contains
    ...
    real(sp_), intent(inout), optional :: weight(m)
    real(sp_), intent(inout), optional :: b(m)
...
!****************************************************************************
    ...
    type(mi35_control), intent(in) :: control
    type(mi35_info), intent(out) :: info
    real(sp_), intent(in), optional :: weight(m)
