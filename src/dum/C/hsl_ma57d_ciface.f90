...
module hsl_ma57_double_ciface
  ...
  type, bind(C) :: ma57_ainfo_d
     ...
     integer(C_INT) :: ispare(5)
     real(rp) :: rspare(10)
  end type ma57_ainfo_d

  type, bind(C) :: ma57_finfo_d
     real(rp)       :: opsa
     real(rp)       :: opse
     real(rp)       :: opsb
     real(rp)       :: maxchange
     ...
     integer(C_INT) :: ispare(5)
     real(rp) :: rspare(10)
  end type ma57_finfo_d

  type, bind(C) :: ma57_sinfo_d
     real(rp)       :: cond
     real(rp)       :: cond2
     real(rp)       :: berr
     real(rp)       :: berr2
...
contains
  ...
  subroutine copy_ainfo_out(finfo, cinfo)
    ...
    type(ma57_ainfo_d), intent(out) :: cinfo
  ...
  subroutine copy_finfo_out(finfo, cinfo)
    ...
    type(ma57_finfo_d), intent(out) :: cinfo
  ...
  subroutine copy_sinfo_out(finfo, cinfo)
    ...
    type(ma57_sinfo_d), intent(out) :: cinfo
...
end module hsl_ma57_double_ciface
