! THIS VERSION: GALAHAD 4.1 - 2022-12-19 AT 09:15 GMT.
...
!--------------------------------------------------------------
     ...
     INTEGER ( KIND = ip_ ), INTENT( INOUT ) :: lirnh, ljcnh, lh, lh_min
     INTEGER ( KIND = ip_ ), INTENT( INOUT ) :: lirnh_min, ljcnh_min
...
!  Check for error returns
                 ...
                 IF ( S%infor == - 26 ) THEN
                   inform%status = 26 ; GO TO 820
                 ELSE IF ( S%infor == 10 ) THEN
                   inform%status = 4 ; GO TO 820
                 ELSE IF ( S%infor == 11 ) THEN
                   inform%status = 5 ; GO TO 820
                 ELSE IF ( S%infor == 12 ) THEN
                   GO TO 990
                 END IF
               ELSE
...
!-----------------------------------------------
     ...
     INTEGER ( KIND = ip_ ), INTENT( IN    ) :: n , ng, nel, ntotel, nnza
     INTEGER ( KIND = ip_ ), INTENT( IN    ) :: nvargp, nvrels, lguval
