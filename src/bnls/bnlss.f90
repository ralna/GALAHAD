   PROGRAM GALAHAD_BNLS_EXAMPLE !  GALAHAD 5.1 - 2024-07-14 AT 14:00 GMT
...
! finally solve using a tensor Gauss Newton model
   ...
   DEALLOCATE( nlp%X, nlp%G, nlp%X_l, nlp%X_u, userdata%real )
   DEALLOCATE( nlp%J%val, nlp%J%row, nlp%J%col )
