...
!-*-*-*-*-*-*-*-  G A L A H A D   U S E C L L S   M O D U L E  -*-*-*-*-*-*-*-*-
...
!   http://galahad.rl.ac.uk/galahad-www/specs.html
    ...
    MODULE GALAHAD_USECLLS_double

!    ---------------------------------------------------------------
!    | CUTEst/AMPL interface to CLLS, an interior-point crossover  |
!    | algorithm for constrained linear least-squares optimization |
!    ---------------------------------------------------------------
...
!-*-*-*-*-*-*-*-*-*-   U S E _ C L L S  S U B R O U T I N E   -*-*-*-*-*-*-*-*-

     SUBROUTINE USE_CLLS( input, close_input )
...
!  Specfile characteristics
      ...
      CHARACTER ( LEN = 7 ) :: specname = 'RUNCLLS'
      TYPE ( SPECFILE_item_type ), DIMENSION( lspec ) :: spec
      CHARACTER ( LEN = 11 ) :: runspec = 'RUNCLLS.SPC'

!  The default values for CLLS could have been set as:

! BEGIN RUNCLLS SPECIFICATIONS (DEFAULT)
!  write-problem-data                        NO
!  problem-data-file-name                    CLLS.data
...
!  Default values for specfile-defined parameters
      ...
      CHARACTER ( LEN = 30 ) :: dfilename = 'CLLS.data'
      CHARACTER ( LEN = 30 ) :: ifilename = 'INITIAL.SIF'
      CHARACTER ( LEN = 30 ) :: pfilename = 'PRESOLVE.SIF'
      CHARACTER ( LEN = 30 ) :: qfilename = 'SCALED.SIF'
      CHARACTER ( LEN = 30 ) :: rfilename = 'CLLSRES.d'
      CHARACTER ( LEN = 30 ) :: sfilename = 'CLLSSOL.d'
      CHARACTER ( LEN = 30 ) :: cfilename = 'CLLS.checkpoints'
...
!  ------------------ Open the specfile for clls ----------------

      INQUIRE( FILE = runspec, EXIST = is_specfile )
write(6,*) ' is there a specfile? ', is_specfile, runspec
      IF ( is_specfile ) THEN
...
!  End of subroutine USE_CLLS

     END SUBROUTINE USE_CLLS

!  End of module USECLLS_double

   END MODULE GALAHAD_USECLLS_double
