...
!        3) the vector of filter points norms
         ...
         IF ( ALLOCATED( s%fnorm_1 ) ) DEALLOCATE( s%fnorm_1 )
...
!        4) the ordered list of norms
         ...
         s%filter_first = -1
         IF ( ALLOCATED( s%filter_next_1 ) ) DEALLOCATE( s%filter_next_1 )
...
!     Clean up the various workspace arrays.
      ...
      IF ( ALLOCATED( s%filter_next_1 ) ) DEALLOCATE( s%filter_next_1  )
      IF ( ALLOCATED( s%filter_next_2 ) ) DEALLOCATE( s%filter_next_2  )
      IF ( ALLOCATED( s%active_1      ) ) DEALLOCATE( s%active_1       )
      IF ( ALLOCATED( s%active_2      ) ) DEALLOCATE( s%active_2       )
      IF ( ALLOCATED( s%fnorm_1       ) ) DEALLOCATE( s%fnorm_1        )
      IF ( ALLOCATED( s%fnorm_2       ) ) DEALLOCATE( s%fnorm_2        )
