...
ipc_ shessprod_diag( ipc_ n, const real_wp_ x[], ipc_ nnz_v, 
                     const ipc_ index_nz_v[], const real_wp_ v[], 
                     ipc_ *nnz_u, ipc_ index_nz_u[], real_wp_ u[],
                     bool got_h, const void * );
...
// Sparse Hessian-vector product
ipc_ shessprod_diag( ipc_ n, const real_wp_ x[], ipc_ nnz_v, 
                     const ipc_ index_nz_v[], const real_wp_ v[], ipc_ *nnz_u,
                     ipc_ index_nz_u[], real_wp_ u[],
                     bool got_h, const void *userdata ){
    real_wp_ p[] = {0., 0., 0.};
    bool used[] = {false, false, false};
    for( ipc_ i = 0; i < nnz_v; i++){
