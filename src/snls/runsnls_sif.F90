...
!-*-*-*-*-*-*-*-*-  G A L A H A D   R U N S N L S _ S I F  *-*-*-*-*-*-*-*-*-*-

!  Nick Gould, Dominique Orban and Philippe Toint, for GALAHAD productions
!  Copyright reserved
!  October 27th 2015

   PROGRAM RUNSNLS_SIF_precision
   USE GALAHAD_KINDS_precision
   USE GALAHAD_USESNLS_precision
   USE GALAHAD_CUTEST_precision
   USE ISO_C_BINDING, ONLY : C_NULL_CHAR

!  Main program for the SIF interface to SNLS, a regularization algorithm for
...
!  End of RUNSNLS_SIF_precision

   END PROGRAM RUNSNLS_SIF_precision
