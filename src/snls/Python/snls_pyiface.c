...
static PyObject* py_snls_solve(PyObject *self, PyObject *args, PyObject *keywds){
  ...
  // Create NumPy output arrays
   ...
   // Return x, y, z, r, g and x_stat
    snls_solve_return = Py_BuildValue("NNNNNN", py_x, py_y, py_z, py_r, py_g,
                                      py_x_stat);
...
"of many variables, where the variables satisfy a collection of simplex\n"
"constraints sum_Ci x_ci = 1, x_ci >= 0, involving\n"
"positive weights w_i, i=1,...,m_r.\n"
