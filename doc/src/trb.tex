...
\itt{stop\_pg\_absolute} is a scalar variable of type \realdp,
...
\itt{stop\_rel\_cg} is a scalar variable of type \realdp,
...
\itt{cg\_maxit} is a scalar variable of type \integer, that gives the
...
\itt{radius} is a scalar variable of type \realdp, that holds
