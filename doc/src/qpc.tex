...
\itt{rho\_g} is a scalar variable of type \realdp, that holds 
...
\itt{rho\_b} is a scalar variable of type \realdp, that holds 
...
\itt{clock\_find\_dependent} is a scalar variable of type \realdp, that 
