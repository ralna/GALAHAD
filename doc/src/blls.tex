...
\itt{regularization\_weight} is a scalar variable of type default \realdp
that specifies the regularization weight added to the search-direction
subproblem to stabilise the computation.
The default is {\tt regularization\_weight =} $10^{-12}$.
