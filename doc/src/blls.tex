...
$\bmp + \bmA \bmv$ when {\tt \%transpose} is \true.
...
\itt{NZ\_in} is an \optional\  rank-one allocatable array of dimension $n$
...
\itt{NZ\_out} is an \optional\ rank-one allocatable array of dimension $m$
