...
\itt{ratio\_cg\_vs\_sd} is a scalar variable of type \integer, 
...
\itt{stop\_p} is a scalar variable of type \realdp, that holds the
...
\itt{zero\_curvature} is a scalar variable of type \realdp
...
\itt{exact\_arcsearch} is a scalar variable of type default \logical, that should
...
\itt{nz\_prod\_end} is a scalar variable of type \integer, that 
...
\ittf{PROD} is a rank-one \intentout\ array argument of type \realdp\
...
\itt{nz\_v\_start} is an \optional\ scalar variable of type \integer, 
that, if \present, holds the starting position in {\tt NZ\_v}
of the list of indices of nonzero components of $\bmv$.

\itt{nz\_v\_end} is an \optional\ scalar variable of type \integer, 
