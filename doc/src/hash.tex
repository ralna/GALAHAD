...
\ittf{nchar} is a scalar \intentin\ argument of type default \integer\ that
should be sent to an upper bound on the number of characters in each
word that may be inserted into the dictionary.

\itt{length} is a scalar \intentin\ argument of type default \integer\ that
...
\itt{position} is a scalar \intentout\ argument of type default \integer\ that
...
\ittf{position} is a scalar \intentout\ argument of type default \integer\ that
...
\itt{new\_length} is a scalar \intentin\ argument of type default \integer\ 
