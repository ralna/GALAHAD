...
\itt{attempts\_max} is a scalar variable of type default \integer, that 
...
\itt{sampling\_strategy} is a scalar variable of type default \integer, 
...
\itt{hypercube\_discretization} is a scalar variable of type default \integer, 
