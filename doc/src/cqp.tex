...
for the identity matrix storage scheme (see Section~\ref{identity}),
the first eight components of {\tt H\%type} must contain the
...
{\tt C\_stat(i)}, {\tt i}$=1, \ldots ,$ {\tt prob\%m}, and their meanings are
\begin{description}
...
\itt{B\_stat} is an \optional\ rank-one \intentout\ array argument of
dimension {\tt prob\%n}
