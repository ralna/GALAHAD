...
over the finite interval $x_l \leq x \leq x_u$.} Function and derivative
...
\itt{buffer} is a scalar variable of type default \integer, that
...
\hspace{8mm}
{\tt CALL \packagename\_solve( x_l, x_u, x, f, g, h, control, inform, data, \&
\vspace*{-1mm}
...
\vspace*{-2mm}
\begin{description}
\ittf{x\_l} and {\tt x\_u} are scalar \intentin\ variables 
of type default \realdp that must be set to the lower and upper bounds
$x_l$ and $x_u$, respectively.
