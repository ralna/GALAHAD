...
{\tt \packagename\_\-form\_and\_factorize},
...
\itt{new\_c} is a scalar variable of type \integer, that is used
...
%\itt{scaling} is a scalar variable of type \integer, that is used

%\itt{ordering} is a scalar variable of type \integer, that is used
...
%\itt{static\_tolerance} is a scalar variable of type \realdp,
%that is used

%\itt{static\_level} is a scalar variable of type \realdp,
%that is used
...
{\tt 'wsmp'},
{\tt 'sytr'},
although only {\tt 'sils'}, {\tt 'sytr'}  and {\tt 'slblt'} are installed by default.
See the documentation for the \galahad\ package {\tt SLS} for further details.
The default is {\tt symmetric\_linear\_solver = 'slblt'}.
...
and {\tt 'slblt'} are installed by default.
See the documentation for the \galahad\ package {\tt SLS} for further details.
The default is {\tt definite\_linear\_solver = 'slblt'}.
...
\itt{clock\_update} is a scalar variable of type \realdp, that gives
...
%\itt{sls\_analyse\_status} is a scalar variable of type \integer
...
%\itt{uls\_solve\_status} is a scalar variable of type \integer,
...
\itt{factorization} is a scalar variable of type \integer,
...
\itt{\galerrrestrictions.} One of the restrictions
   {\tt prob\%n} $> 0$ or {\tt prob\%m} $\geq  0$
    ...
    {\tt prob\%C\_\-type} contain its relevant string
