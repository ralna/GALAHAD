...
\itt{phase1\_total} is a scalar variable of type \realdp, that gives
 the total CPU time spent in the initial-feasible-point phase of the package.

\itt{phase1\_analyse} is a scalar variable of type \realdp, that gives
 the CPU time spent analysing the required matrices prior to factorization
 in the initial-feasible-point phase.

\itt{phase1\_factorize} is a scalar variable of type \realdp, that gives
 the CPU time spent factorizing the required matrices
 in the initial-feasible-point phase.

\itt{phase1\_solve} is a scalar variable of type \realdp, that gives
 the CPU time spent computing the search direction
 in the initial-feasible-point phase.
...
\itt{clock\_phase1\_total} is a scalar variable of type \realdp, that 
gives the total elapsed system clock time spent in the initial-feasible-point 
phase of the package.

\itt{clock\_phase1\_analyse} is a scalar variable of type \realdp, that 
...
\itt{clock\_phase1\_factorize} is a scalar variable of type \realdp, that
gives the elapsed system clock time spent factorizing the required matrices
 in the initial-feasible-point phase.

\itt{clock\_phase1\_solve} is a scalar variable of type \realdp, that 
...
of dimension {\tt p\%m}
and type \integer, that if \present\
...
of dimension {\tt p\%n}
and type \integer, that that if \present\
