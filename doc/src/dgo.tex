...
\itt{max\_evals} is a scalar variable of type default \integer, that gives
the maximum number of function evaluations that are allowed.
The default is {\tt max\_evals = 10000}.

\itt{dictionary\_size} is a scalar variable of type default \integer, that
...
of type default \realdp, that are used to provide a reliable estimate of
...
\itt{stop\_length} is a scalar variable of type default \realdp, that is
...
\itt{stop\_f} is a scalar variable of type default \realdp, that is used to
...
\itt{univariate\_global} is a scalar variable of type default \realdp, that
gives the CPU time spent performing univariate global optimization.

\itt{multivariate\_local} is a scalar variable of type default \realdp, that
...
\itt{clock\_univariate\_global} is a scalar variable of type default \realdp,
that gives the elapsed system clock time spent performing univariate global
optimization.

\itt{clock\_multivariate\_local} is a scalar variable of type default \realdp,
...
\ittf{length\_ratio} is a scalar variable of type default \realdp, that holds
the ratio of the final to the initial box lengths.

\ittf{f\_gap} is a scalar variable of type default \realdp, that holds the
...
Components of variables of type {\tt GALAHAD\_user\-data\_type} may be allocated
