...
\itt{initial\_point} is a scalar variable of type \integer, 
...
\itt{perturbation\_strategy} is a scalar variable of type \integer, 
...
\itt{perturb\_start} is a scalar variable of type \realdp, 
...
\itt{reduce\_perturb\_factor} is a scalar variable of type \realdp, 
...
\itt{reduce\_perturb\_multiplier} is a scalar variable of type \realdp, 
that is used to adjust the perturbations. This corresponds to the
value $\rho$ in \S\ref{galmethod}, and should lie strictly between zero and
one. Any value outside $(0,1)$ will be reset to a suitable value by
The default is {\tt reduce\_perturb\_factor = 0.01}.

\itt{insufficiently\_feasible} is a scalar variable of type \realdp, 
that is used to adjust the perturbations. This corresponds to the
...
\itt{implicit\_tol} is a scalar variable of type \realdp, 
...
\itt{perturbation\_small} is a scalar variable of type \realdp, 
...
\itt{alpha\_scale} is a scalar variable of type \realdp, that is used to
...
\itt{mu\_target} is a scalar variable of type \realdp, 
...
\itt{mu\_accept\_fraction} is a scalar variable of type \realdp, 
...
\itt{mu\_increase\_factor} is a scalar variable of type \realdp, 
...
\itt{c\_implicit} is a scalar variable of type \integer, that gives the
...
\itt{x\_implicit} is a scalar variable of type \integer, that gives the
...
\itt{y\_implicit} is a scalar variable of type \integer, that gives the
...
\itt{z\_implicit} is a scalar variable of type \integer, that gives the
...
\itt{mu\_final\_target\_max} is a scalar variable of type \realdp, 
...
\itt{X\_status} is a rank-one allocatable array of type \integer,
