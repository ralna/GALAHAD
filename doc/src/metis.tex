...
\itt{perm} is an 
\itt{PERM} is a rank-one \integer\ \out\ array argument
...
\itt{PTR} is a rank-one \integer\ array argument of \in\ and length 
...
\itt{IND} is a rank-one \integer\ array argument of \in\ and length 
...
SIAM Journal on Scientific Computing. {\bf 20(1)} (1999) 359.
