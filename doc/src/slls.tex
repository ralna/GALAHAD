...
\itt{Ao\%row} is a rank-one allocatable array variable of type default \integer,
...
\itt{Ao\%ptr} is a rank-one allocatable array and type default \integer,
