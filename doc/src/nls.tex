...
\itt{P\%val} is a rank-one allocatable array of type \realdp,
that holds the values of the entries of the product matrix $\bmP$ stored
as consecutive columns.

\itt{P\%row} is a rank-one allocatable array of type \integer,
...
\itt{hessian\_available} is a scalar variable of type \integer,
...
\itt{stop\_c\_absolute} is a scalar variable of type \realdp,
...
\itt{stop\_c\_relative} is a scalar variable of type \realdp,
...
\itt{regularization\_power} is a scalar variable of type \realdp,
...
\itt{initial\_inner\_weight} is a scalar variable of type \realdp,
that holds the required initial value of the regularization weight if
...
\itt{j\_eval} is a scalar variable of type \integer, that gives the
...
\itt{norm\_c} is a scalar variable of type \realdp, that holds the
...
\ittf{C} is a rank-one \intentout\ array argument of type \realdp\
...
\itt{P\%val} is a scalar \intentout\ argument of type \realdp,
