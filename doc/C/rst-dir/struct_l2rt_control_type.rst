...
.. ref-code-block:: cpp
	...
	struct l2rt_control_type {
		...
		bool :ref:`f_indexing<doxid-structl2rt__control__type_f_indexing>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`error<doxid-structl2rt__control__type_error>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`out<doxid-structl2rt__control__type_out>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`print_level<doxid-structl2rt__control__type_print_level>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`start_print<doxid-structl2rt__control__type_start_print>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`stop_print<doxid-structl2rt__control__type_stop_print>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`print_gap<doxid-structl2rt__control__type_print_gap>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`itmin<doxid-structl2rt__control__type_itmin>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`itmax<doxid-structl2rt__control__type_itmax>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`bitmax<doxid-structl2rt__control__type_bitmax>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`extra_vectors<doxid-structl2rt__control__type_extra_vectors>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`stopping_rule<doxid-structl2rt__control__type_stopping_rule>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`freq<doxid-structl2rt__control__type_freq>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_relative<doxid-structl2rt__control__type_stop_relative>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_absolute<doxid-structl2rt__control__type_stop_absolute>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`fraction_opt<doxid-structl2rt__control__type_fraction_opt>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`time_limit<doxid-structl2rt__control__type_time_limit>`;
		bool :ref:`space_critical<doxid-structl2rt__control__type_space_critical>`;
		bool :ref:`deallocate_error_fatal<doxid-structl2rt__control__type_deallocate_error_fatal>`;
		char :ref:`prefix<doxid-structl2rt__control__type_prefix>`[31];
	};
