...
.. ref-code-block:: lua
	...
	:ref:`dgo_control_type<doxid-structdgo__control__type>`
	:ref:`dgo_inform_type<doxid-structdgo__inform__type>`
	:ref:`dgo_time_type<doxid-structdgo__time__type>`

	-- functions

	function :ref:`dgo_initialize<doxid-galahad__dgo_8h_1a80425d4671e565a45c13aa026f6897ef>`(data, control, status)
	function :ref:`dgo_read_specfile<doxid-galahad__dgo_8h_1ab8ba227e6d624a0197afab9f77bbe66a>`(control, specfile)

	function :ref:`dgo_import<doxid-galahad__dgo_8h_1ace7cbe696d8be7026753681d9b7cd149>`(
		control,
		data,
		status,
		n,
	...
	function :ref:`dgo_reset_control<doxid-galahad__dgo_8h_1ab52e88675fc811f7e9bc38148d42e932>`(control, data, status)

	function :ref:`dgo_solve_with_mat<doxid-galahad__dgo_8h_1a3b573f5a56c7162383a757221a5b7a36>`(
		data,
		userdata,
		status,
		n,
	...
	function :ref:`dgo_solve_without_mat<doxid-galahad__dgo_8h_1a6ea7cfa79c25e784d21e10cc26ed9954>`(
		data,
		userdata,
		status,
		n,
	...
	function :ref:`dgo_solve_reverse_with_mat<doxid-galahad__dgo_8h_1a02f408b215596c01b0e3836dfa301b9f>`(
		data,
		status,
		eval_status,
		n,
	...
	function :ref:`dgo_solve_reverse_without_mat<doxid-galahad__dgo_8h_1a878a7d98d55794fa38f885a5d76aa4f0>`(
		data,
		status,
		eval_status,
		n,
	...
	function :ref:`dgo_information<doxid-galahad__dgo_8h_1aea0c208de08f507be7a31fe3ab7d3b91>`(data, inform, status)
	function :ref:`dgo_terminate<doxid-galahad__dgo_8h_1ad12337a0c7ad3ac74e7f8c0783fbbfab>`(data, control, inform)
...
.. ref-code-block:: lua
	...
	function dgo_solve_without_mat(
		data,
		userdata,
		status,
		n,
...
.. ref-code-block:: lua
	...
	function dgo_solve_reverse_with_mat(
		data,
		status,
		eval_status,
		n,
...
.. ref-code-block:: lua
	...
	function dgo_solve_reverse_without_mat(
		data,
		status,
		eval_status,
		n,
