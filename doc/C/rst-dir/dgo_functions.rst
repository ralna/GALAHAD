...
.. ref-code-block:: cpp
	...
	void dgo_initialize_s_64(void **data, struct :ref:`dgo_control_type_s_64<doxid-structdgo__control__type>`* control, 
                             int64_t *status)
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of type char that specifies the :ref:`symmetric storage scheme<details-dgo_storage__sym>` used for the Hessian. It should be one of 'coordinate', 'sparse_by_rows', 'dense', 'diagonal' or 'absent', the latter if access to the Hessian is via matrix-vector products; lower or upper case variants are allowed.
