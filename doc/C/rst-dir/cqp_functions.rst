...
.. ref-code-block:: lua
	...
	:ref:`cqp_control_type<doxid-structcqp__control__type>`
	:ref:`cqp_inform_type<doxid-structcqp__inform__type>`
	:ref:`cqp_time_type<doxid-structcqp__time__type>`

	-- functions

	function :ref:`cqp_initialize<doxid-galahad__cqp_8h_1a782387ad9cccc5f2e2da9df9016fb923>`(data, control, status)
	function :ref:`cqp_read_specfile<doxid-galahad__cqp_8h_1ade439e5e06c2852fcb089bb39a667a74>`(control, specfile)

	function :ref:`cqp_import<doxid-galahad__cqp_8h_1a6a2be17b6f871df80bbac93940b83af3>`(
		control,
		data,
		status,
		n,
	...
	function :ref:`cqp_reset_control<doxid-galahad__cqp_8h_1a9f7ccb0cffa909a2be7556edda430190>`(control, data, status)

	function :ref:`cqp_solve_qp<doxid-galahad__cqp_8h_1ac2d720ee7b719bf63c3fa208d37f1bc1>`(
		data,
		status,
		n,
		m,
	...
	function :ref:`cqp_solve_sldqp<doxid-galahad__cqp_8h_1a311864de053b1cbbf78b1cbab052e56e>`(
		data,
		status,
		n,
		m,
	...
	function :ref:`cqp_information<doxid-galahad__cqp_8h_1adfb7589696e4e07fdb65f02bc42c5daf>`(data, inform, status)
	function :ref:`cqp_terminate<doxid-galahad__cqp_8h_1a84e12e9e546f51762d305333dce68e2b>`(data, control, inform)
