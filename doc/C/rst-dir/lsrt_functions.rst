...
Thus a call to ``lsrt_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void lsrt_initialize_s_64(void **data, struct :ref:`lsrt_control_type_s_64<doxid-structlsrt__control__type>`* control, 
                             int64_t *status)
