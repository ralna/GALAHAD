...
.. ref-code-block:: lua
	...
	:ref:`eqp_control_type<doxid-structeqp__control__type>`
	:ref:`eqp_inform_type<doxid-structeqp__inform__type>`
	:ref:`eqp_time_type<doxid-structeqp__time__type>`

	-- functions

	function :ref:`eqp_initialize<doxid-galahad__eqp_8h_1a0d6a00469fba32b588f74c05a386626d>`(data, control, status)
	function :ref:`eqp_read_specfile<doxid-galahad__eqp_8h_1a24889f7ee5c51b3c76daab94687faed9>`(control, specfile)

	function :ref:`eqp_import<doxid-galahad__eqp_8h_1adbadbd11a40aedbbb705334023406de1>`(
		control,
		data,
		status,
		n,
	...
	function :ref:`eqp_reset_control<doxid-galahad__eqp_8h_1a1b8074313bdc2176203d0c0e9ea87c24>`(control, data, status)

	function :ref:`eqp_solve_qp<doxid-galahad__eqp_8h_1abf97ed5ee46d2b3fd9a6f75023a95c3d>`(
		data,
		status,
		n,
		m,
	...
	function :ref:`eqp_solve_sldqp<doxid-galahad__eqp_8h_1aaadb310c329e4857b3ad373bcee69e6f>`(data, status, n, m, w, x0, g, f, a_ne, A_val, c, x, y)
	function :ref:`eqp_resolve_qp<doxid-galahad__eqp_8h_1abde96724e9b4b13c5cce1aae5cf93d8f>`(data, status, n, m, g, f, c, x, y)
	function :ref:`eqp_information<doxid-galahad__eqp_8h_1aba10933446f1856fc435ecfbd98371d6>`(data, inform, status)
	function :ref:`eqp_terminate<doxid-galahad__eqp_8h_1a237e3d3e43c6819205b3f303418324e0>`(data, control, inform)
...
.. list-table::
	...
	*
		...
		- is a struct containing control information (see :ref:`eqp_control_type <doxid-structeqp__control__type>`)
...
.. list-table::
	...
	*
		...
		- is a struct whose members provide control paramters for the remaining prcedures (see :ref:`eqp_control_type <doxid-structeqp__control__type>`)
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of size m and type double, that holds the linear term :math:`c` in the constraints. The i-th component of c, i = 0, ... , m-1, contains :math:`c_i`.
	...
	*
		...
		- is a one-dimensional array of size n and type double, that holds the values :math:`y` of the Lagrange multipliers for the linear constraints. The j-th component of y, i = 0, ... , m-1, contains :math:`y_i`.
