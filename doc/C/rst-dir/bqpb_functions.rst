...
Thus a call to ``bqpb_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void bqpb_initialize_s_64(void **data, struct :ref:`bqpb_control_type_s_64<doxid-structbqpb__control__type>`* control, 
                             int64_t *status)
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of type char that specifies the :ref:`symmetric storage scheme<details-bqpb_storage__sym>` used for the Hessian, $H$. It should be one of 'coordinate', 'sparse_by_rows', 'dense', 'diagonal', 'scaled_identity', 'identity', 'zero' or 'none', the latter pair if $H=0$; lower or upper case variants are allowed.
