...
Thus a call to ``bgo_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void bgo_initialize_s_64(void **data, struct :ref:`bgo_control_type_s_64<doxid-structbgo__control__type>`* control, 
                             int64_t *status)
