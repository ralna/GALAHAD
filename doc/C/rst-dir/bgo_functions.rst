...
.. ref-code-block:: lua
	...
	:ref:`bgo_control_type<doxid-structbgo__control__type>`
	:ref:`bgo_inform_type<doxid-structbgo__inform__type>`
	:ref:`bgo_time_type<doxid-structbgo__time__type>`

	-- functions

	function :ref:`bgo_initialize<doxid-galahad__bgo_8h_1a5d2b6e10b7c04279d6037e9abd32e19f>`(data, control, status)
	function :ref:`bgo_read_specfile<doxid-galahad__bgo_8h_1a7a9e6738996809b7fd96a6e9bee6e467>`(control, specfile)

	function :ref:`bgo_import<doxid-galahad__bgo_8h_1a5902cb8c7c213954de6b963a507f3a4b>`(
		control,
		data,
		status,
		n,
	...
	function :ref:`bgo_reset_control<doxid-galahad__bgo_8h_1acd46c656b1551f4659d725e65b70e1e6>`(control, data, status)

	function :ref:`bgo_solve_with_mat<doxid-galahad__bgo_8h_1ab9193a994bd19d94aa97156e83345bd4>`(
		data,
		userdata,
		status,
		n,
	...
	function :ref:`bgo_solve_without_mat<doxid-galahad__bgo_8h_1aeaa490762fe0950e577509ade6ae36d5>`(
		data,
		userdata,
		status,
		n,
	...
	function :ref:`bgo_solve_reverse_with_mat<doxid-galahad__bgo_8h_1af99998a6921ff67b79e6558fb2a27f2f>`(
		data,
		status,
		eval_status,
		n,
	...
	function :ref:`bgo_solve_reverse_without_mat<doxid-galahad__bgo_8h_1a84e69267132736f46cb7b5970a24b772>`(
		data,
		status,
		eval_status,
		n,
	...
	function :ref:`bgo_information<doxid-galahad__bgo_8h_1a96c2a39622f5c497a4286f5e8ebc4ddc>`(data, inform, status)
	function :ref:`bgo_terminate<doxid-galahad__bgo_8h_1ae41275e1234f0e01ff2aae00746d94d6>`(data, control, inform)
...
.. ref-code-block:: lua
	...
	function bgo_solve_reverse_with_mat(
		data,
		status,
		eval_status,
		n,
