...
.. toctree::
	...
	struct_tru_control_type.rst
	struct_tru_inform_type.rst
	struct_tru_time_type.rst
...
.. ref-code-block:: cpp
	...
	struct :ref:`tru_control_type<doxid-structtru__control__type>`;
	struct :ref:`tru_inform_type<doxid-structtru__inform__type>`;
	struct :ref:`tru_time_type<doxid-structtru__time__type>`;

	// function calls

	void :ref:`tru_initialize<doxid-galahad__tru_8h_1af7def0657e11fee556d3006fb64fe267>`(void **data, struct :ref:`tru_control_type<doxid-structtru__control__type>`* control, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status);
	void :ref:`tru_read_specfile<doxid-galahad__tru_8h_1a870a28132f2747e12d7c93c9ce6ffd01>`(struct :ref:`tru_control_type<doxid-structtru__control__type>`* control, const char specfile[]);

	void :ref:`tru_import<doxid-galahad__tru_8h_1a8175a402569a69faa351e2dcd3c48b94>`(
		struct :ref:`tru_control_type<doxid-structtru__control__type>`* control,
		void **data,
	...
	void :ref:`tru_reset_control<doxid-galahad__tru_8h_1a97ce8d0956fdb4165504433a93714495>`(
		struct :ref:`tru_control_type<doxid-structtru__control__type>`* control,
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status
	);

	void :ref:`tru_solve_with_mat<doxid-galahad__tru_8h_1a638a31d7027eaf1ae39aa7278e7c5c5a>`(
		void **data,
		void *userdata,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
	...
	void :ref:`tru_solve_without_mat<doxid-galahad__tru_8h_1aaa508227d17d8da723bb0401023acd96>`(
		void **data,
		void *userdata,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
	...
	void :ref:`tru_solve_reverse_with_mat<doxid-galahad__tru_8h_1a804863856294e362b724fca8953300d5>`(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
	...
	void :ref:`tru_solve_reverse_without_mat<doxid-galahad__tru_8h_1a97252b83eaab0b4d5d3ac53e6b317206>`(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *eval_status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
	...
	void :ref:`tru_information<doxid-galahad__tru_8h_1a7c756ce759b44ddbd1ffac77bf497e5a>`(void **data, struct :ref:`tru_inform_type<doxid-structtru__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status);

	void :ref:`tru_terminate<doxid-galahad__tru_8h_1aa38f8880b4f63e610ae1f269353ac46e>`(
		void **data,
		struct :ref:`tru_control_type<doxid-structtru__control__type>`* control,
		struct :ref:`tru_inform_type<doxid-structtru__inform__type>`* inform
	);
...
Thus a call to ``tru_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void tru_initialize_s_64(void **data, struct :ref:`tru_control_type_s_64<doxid-structtru__control__type>`* control, 
                             int64_t *status)
...
.. ref-code-block:: cpp
	...
	void tru_initialize(void **data, struct :ref:`tru_control_type<doxid-structtru__control__type>`* control, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status)
...
.. ref-code-block:: cpp
	...
	void tru_read_specfile(struct :ref:`tru_control_type<doxid-structtru__control__type>`* control, const char specfile[])
...
\$GALAHAD/src/tru/TRU.template. 
See also Table 2.1 in the Fortran documentation provided in 
\$GALAHAD/doc/tru.pdf for a list of how these keywords 
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of type char that specifies the :ref:`symmetric storage scheme<details-tru_storage__sym>` used for the Hessian. It should be one of 'coordinate', 'sparse_by_rows', 'dense', 'diagonal' or 'absent', the latter if access to the Hessian is via matrix-vector products; lower or upper case variants are allowed
...
.. list-table::
	...
	*
		...
		- 
		  ...
		  The nonzeros of the Hessian $H = \nabla_{xx}f(x)$ of the objective function evaluated at x= $x$ must be assigned to h in the same order as presented to tru_import, and the function return value set to 0. If the evaluation is impossible at x, return should be set to a nonzero value. Data may be passed into ``eval_h`` via the structure ``userdata``.
...
.. ref-code-block:: cpp
	...
	void tru_solve_reverse_without_mat(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *eval_status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
...
.. ref-code-block:: cpp
	...
	void tru_information(void **data, struct :ref:`tru_inform_type<doxid-structtru__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status)
