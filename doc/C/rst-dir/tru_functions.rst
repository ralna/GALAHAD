...
.. ref-code-block:: lua
	...
	:ref:`tru_control_type<doxid-structtru__control__type>`
	:ref:`tru_inform_type<doxid-structtru__inform__type>`
	:ref:`tru_time_type<doxid-structtru__time__type>`

	-- functions

	function :ref:`tru_initialize<doxid-galahad__tru_8h_1af7def0657e11fee556d3006fb64fe267>`(data, control, status)
	function :ref:`tru_read_specfile<doxid-galahad__tru_8h_1a870a28132f2747e12d7c93c9ce6ffd01>`(control, specfile)
	function :ref:`tru_import<doxid-galahad__tru_8h_1a8175a402569a69faa351e2dcd3c48b94>`(control, data, status, n, H_type, ne, H_row, H_col, H_ptr)
	function :ref:`tru_reset_control<doxid-galahad__tru_8h_1a97ce8d0956fdb4165504433a93714495>`(control, data, status)

	function :ref:`tru_solve_with_mat<doxid-galahad__tru_8h_1a638a31d7027eaf1ae39aa7278e7c5c5a>`(
		data,
		userdata,
		status,
		n,
	...
	function :ref:`tru_solve_without_mat<doxid-galahad__tru_8h_1aaa508227d17d8da723bb0401023acd96>`(
		data,
		userdata,
		status,
		n,
	...
	function :ref:`tru_solve_reverse_with_mat<doxid-galahad__tru_8h_1a804863856294e362b724fca8953300d5>`(
		data,
		status,
		eval_status,
		n,
	...
	function :ref:`tru_solve_reverse_without_mat<doxid-galahad__tru_8h_1a97252b83eaab0b4d5d3ac53e6b317206>`(
		data,
		status,
		eval_status,
		n,
	...
	function :ref:`tru_information<doxid-galahad__tru_8h_1a7c756ce759b44ddbd1ffac77bf497e5a>`(data, inform, status)
	function :ref:`tru_terminate<doxid-galahad__tru_8h_1aa38f8880b4f63e610ae1f269353ac46e>`(data, control, inform)
...
.. ref-code-block:: lua
	...
	function tru_solve_without_mat(
		data,
		userdata,
		status,
		n,
...
.. ref-code-block:: lua
	...
	function tru_solve_reverse_with_mat(
		data,
		status,
		eval_status,
		n,
...
.. ref-code-block:: lua
	...
	function tru_solve_reverse_without_mat(
		data,
		status,
		eval_status,
		n,
