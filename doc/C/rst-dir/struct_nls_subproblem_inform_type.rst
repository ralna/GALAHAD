...
.. ref-code-block:: cpp
	...
	struct nls_subproblem_inform_type {
		...
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`status<doxid-structnls__subproblem__inform__type_status>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`alloc_status<doxid-structnls__subproblem__inform__type_alloc_status>`;
		char :ref:`bad_alloc<doxid-structnls__subproblem__inform__type_bad_alloc>`[81];
		char :ref:`bad_eval<doxid-structnls__subproblem__inform__type_bad_eval>`[13];
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`iter<doxid-structnls__subproblem__inform__type_iter>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`cg_iter<doxid-structnls__subproblem__inform__type_cg_iter>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`c_eval<doxid-structnls__subproblem__inform__type_c_eval>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`j_eval<doxid-structnls__subproblem__inform__type_j_eval>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`h_eval<doxid-structnls__subproblem__inform__type_h_eval>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`factorization_max<doxid-structnls__subproblem__inform__type_factorization_max>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`factorization_status<doxid-structnls__subproblem__inform__type_factorization_status>`;
		int64_t :ref:`max_entries_factors<doxid-structnls__subproblem__inform__type_max_entries_factors>`;
		int64_t :ref:`factorization_integer<doxid-structnls__subproblem__inform__type_factorization_integer>`;
		int64_t :ref:`factorization_real<doxid-structnls__subproblem__inform__type_factorization_real>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`factorization_average<doxid-structnls__subproblem__inform__type_factorization_average>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`obj<doxid-structnls__subproblem__inform__type_obj>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`norm_c<doxid-structnls__subproblem__inform__type_norm_c>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`norm_g<doxid-structnls__subproblem__inform__type_norm_g>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight<doxid-structnls__subproblem__inform__type_weight>`;
		struct :ref:`nls_time_type<doxid-structnls__time__type>` :ref:`time<doxid-structnls__subproblem__inform__type_time>`;
		struct :ref:`rqs_inform_type<doxid-structrqs__inform__type>` :ref:`rqs_inform<doxid-structnls__subproblem__inform__type_rqs_inform>`;
		struct :ref:`glrt_inform_type<doxid-structglrt__inform__type>` :ref:`glrt_inform<doxid-structnls__subproblem__inform__type_glrt_inform>`;
		struct :ref:`psls_inform_type<doxid-structpsls__inform__type>` :ref:`psls_inform<doxid-structnls__subproblem__inform__type_psls_inform>`;
		struct :ref:`bsc_inform_type<doxid-structbsc__inform__type>` :ref:`bsc_inform<doxid-structnls__subproblem__inform__type_bsc_inform>`;
		struct :ref:`roots_inform_type<doxid-structroots__inform__type>` :ref:`roots_inform<doxid-structnls__subproblem__inform__type_roots_inform>`;
	};
