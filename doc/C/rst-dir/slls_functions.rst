...
.. ref-code-block:: cpp
	...
	void :ref:`slls_information<doxid-galahad__slls_8h_1a457b8ee7c630715bcb43427f254b555f>`(void** data, struct :ref:`slls_inform_type<doxid-structslls__inform__type>`* inform, int* status);
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of size Ao_ne and type double, that holds the values of the entries in the design matrix $A_o$ in any of the available storage schemes.
...
.. ref-code-block:: cpp
	...
	void slls_information(void** data, struct :ref:`slls_inform_type<doxid-structslls__inform__type>`* inform, int* status)
