...
Thus a call to ``sils_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sils_initialize_s_64(void **data, struct :ref:`sils_control_type_s_64<doxid-structsils__control__type>`* control, 
                             int64_t *status)
