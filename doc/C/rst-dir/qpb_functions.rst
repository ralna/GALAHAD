...
.. ref-code-block:: lua
	...
	:ref:`qpb_control_type<doxid-structqpb__control__type>`
	:ref:`qpb_inform_type<doxid-structqpb__inform__type>`
	:ref:`qpb_time_type<doxid-structqpb__time__type>`

	-- functions

	function :ref:`qpb_initialize<doxid-galahad__qpb_8h_1afdfb45debf15ddcc3d6e0feea4e34784>`(data, control, status)
	function :ref:`qpb_read_specfile<doxid-galahad__qpb_8h_1a162514dc80468d390e80c620890c8710>`(control, specfile)

	function :ref:`qpb_import<doxid-galahad__qpb_8h_1a36559bb33d97b61e94e0c7dfa73b67d8>`(
		control,
		data,
		status,
		n,
	...
	function :ref:`qpb_reset_control<doxid-galahad__qpb_8h_1a42484e4b1aafb880fcdb215d5683a652>`(control, data, status)

	function :ref:`qpb_solve_qp<doxid-galahad__qpb_8h_1ac83f8c83e64a7f130fb247f162169472>`(
		data,
		status,
		n,
		m,
	...
	function :ref:`qpb_information<doxid-galahad__qpb_8h_1a2b77d21a6c613462657e8b7f51b6b1d2>`(data, inform, status)
	function :ref:`qpb_terminate<doxid-galahad__qpb_8h_1a35596f23213b063f1f8abfc6f796bc77>`(data, control, inform)
