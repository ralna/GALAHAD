...
Thus a call to ``lhs_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void lhs_initialize_s_64(void **data, struct :ref:`lhs_control_type_s_64<doxid-structlhs__control__type>`* control, 
                             int64_t *status)
