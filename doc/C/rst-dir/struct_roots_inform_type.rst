...
.. ref-code-block:: cpp
	...
	struct roots_inform_type {
		...
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`status<doxid-structroots__inform__type_status>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`alloc_status<doxid-structroots__inform__type_alloc_status>`;
		char :ref:`bad_alloc<doxid-structroots__inform__type_bad_alloc>`[81];
	};
