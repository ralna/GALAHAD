...
.. list-table::
	...
	*
		...
		- is a scalar of type double, that holds the order of regularisation, $p$, used. power must be no smaller than 2.

	*
		- weight

		- is a scalar of type double, that holds the regularisation weight, $\sigma$, used. weight must be strictly positive.
