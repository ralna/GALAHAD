...
Thus a call to ``bllsb_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void bllsb_initialize_s_64(void **data, struct :ref:`bllsb_control_type_s_64<doxid-structbllsb__control__type>`* control, 
                             int64_t *status)
