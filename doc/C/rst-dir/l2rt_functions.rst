...
Thus a call to ``l2rt_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void l2rt_initialize_s_64(void **data, struct :ref:`l2rt_control_type_s_64<doxid-structl2rt__control__type>`* control, 
                             int64_t *status)
