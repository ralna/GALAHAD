...
Thus a call to ``cro_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void cro_initialize_s_64(void **data, struct :ref:`cro_control_type_s_64<doxid-structcro__control__type>`* control, 
                             int64_t *status)
