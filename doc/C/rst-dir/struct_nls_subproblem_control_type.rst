...
.. ref-code-block:: cpp
	...
	struct nls_subproblem_control_type {
		...
		int :ref:`error<doxid-structnls__subproblem__control__type_1a11614f44ef4d939bdd984953346a7572>`;
		int :ref:`out<doxid-structnls__subproblem__control__type_1aa8000eda101cade7c6c4b913fce0cc9c>`;
		int :ref:`print_level<doxid-structnls__subproblem__control__type_1a12dae630bd8f5d2d00f6a86d652f5c81>`;
		int :ref:`start_print<doxid-structnls__subproblem__control__type_1ae0eb21dc79b53664e45ce07c9109b3aa>`;
		int :ref:`stop_print<doxid-structnls__subproblem__control__type_1a9a3d9960a04602d2a18009c82ae2124e>`;
		int :ref:`print_gap<doxid-structnls__subproblem__control__type_1a31edaef6b722ef2721633484405a649b>`;
		int :ref:`maxit<doxid-structnls__subproblem__control__type_1ab717630b215f0362699acac11fb3652c>`;
		int :ref:`alive_unit<doxid-structnls__subproblem__control__type_1a3fc6359d77a53a63d57ea600b51eac13>`;
		char :ref:`alive_file<doxid-structnls__subproblem__control__type_1ac631699a26f321b14dbed37115f3c006>`[31];
		int :ref:`jacobian_available<doxid-structnls__subproblem__control__type_1a331884a4968f11decfca0a687fc59dde>`;
		int :ref:`hessian_available<doxid-structnls__subproblem__control__type_1ae665ac50d8c985bf502ba2b90363826a>`;
		int :ref:`model<doxid-structnls__subproblem__control__type_1a027a1f1731d22465c926ce57be2364c3>`;
		int :ref:`norm<doxid-structnls__subproblem__control__type_1a5b6da5fd1d9c6f86967fa0b4197e3498>`;
		int :ref:`non_monotone<doxid-structnls__subproblem__control__type_1a856b2df558071805c217b6d72a1e215b>`;
		int :ref:`weight_update_strategy<doxid-structnls__subproblem__control__type_1a91395480b85edaac83529fc7f1605289>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`stop_c_absolute<doxid-structnls__subproblem__control__type_1add1b86a6f37634dcbf1e5f55807eac2b>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`stop_c_relative<doxid-structnls__subproblem__control__type_1a8e60a718c9c3b3bf9daf2e2be3c7dd68>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`stop_g_absolute<doxid-structnls__subproblem__control__type_1a6182fed3e6c11b9aa39e1460c1def7f8>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`stop_g_relative<doxid-structnls__subproblem__control__type_1aeb89f1dc942cea0814ee1e8d645467d3>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`stop_s<doxid-structnls__subproblem__control__type_1a56612668b00bf042745379f43166cd27>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`power<doxid-structnls__subproblem__control__type_1aa8611d2e53cef87afe803f0e486f3c98>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`initial_weight<doxid-structnls__subproblem__control__type_1aa8b73dcc65ae7dc7b3331980f77c5fb4>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`minimum_weight<doxid-structnls__subproblem__control__type_1a044b125f7d2b5409dde4253030798367>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`initial_inner_weight<doxid-structnls__subproblem__control__type_1ab32efd2263e7fbebfe87846bc977f1ab>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`eta_successful<doxid-structnls__subproblem__control__type_1ac0774abb09bb59381960d771cb38b8ef>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`eta_very_successful<doxid-structnls__subproblem__control__type_1a5e55cf3fe7846b0f9b23919b0f95469e>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`eta_too_successful<doxid-structnls__subproblem__control__type_1a6af4c9666b9342fa75b665bfb8cef524>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`weight_decrease_min<doxid-structnls__subproblem__control__type_1a481b6aeef2f3d9a0078665db1e512c85>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`weight_decrease<doxid-structnls__subproblem__control__type_1a46e8590e1c6ebb8c2a673d854762424d>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`weight_increase<doxid-structnls__subproblem__control__type_1a92d59bc5d9b2899fbb318ea033e85540>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`weight_increase_max<doxid-structnls__subproblem__control__type_1a43230e4cfd494bbdcb897074b0b9768b>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`reduce_gap<doxid-structnls__subproblem__control__type_1a462c383f8c4b96b23d585f292bd5e0e2>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`tiny_gap<doxid-structnls__subproblem__control__type_1a28c746bfd481575683553dc28abe3e30>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`large_root<doxid-structnls__subproblem__control__type_1a7abb4c844c9fddec04f47c856f4a2383>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`switch_to_newton<doxid-structnls__subproblem__control__type_1a3e388718674f5243006272b3911fae22>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`cpu_time_limit<doxid-structnls__subproblem__control__type_1a52f14ff3f85e6805f2373eef5d0f3dfd>`;
		:ref:`real_wp_<doxid-galahad__precision_8h_1ab82133d435678ff159433d2e50cf295e>` :ref:`clock_time_limit<doxid-structnls__subproblem__control__type_1ab05d7c2b06d3a9fb085fa3739501d1c8>`;
