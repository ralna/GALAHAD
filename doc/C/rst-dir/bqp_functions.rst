...
.. ref-code-block:: lua
	...
	:ref:`bqp_control_type<doxid-structbqp__control__type>`
	:ref:`bqp_inform_type<doxid-structbqp__inform__type>`
	:ref:`bqp_time_type<doxid-structbqp__time__type>`

	-- functions

	function :ref:`bqp_initialize<doxid-galahad__bqp_8h_1a4466621895dd2314f1b3c21b4bc7f615>`(data, control, status)
	function :ref:`bqp_read_specfile<doxid-galahad__bqp_8h_1a0e3ffdd29be95753292694c7619a43e6>`(control, specfile)
	function :ref:`bqp_import<doxid-galahad__bqp_8h_1a0cfa65e832fd80e3dfcf9e0c65a69e56>`(control, data, status, n, H_type, ne, H_row, H_col, H_ptr)
	function :ref:`bqp_import_without_h<doxid-galahad__bqp_8h_1a9a99d880b3bfbcfb7b093756019c5f0e>`(control, data, status, n)
	function :ref:`bqp_reset_control<doxid-galahad__bqp_8h_1a315ce83042f67a466cfdd868c27a2850>`(control, data, status)

	function :ref:`bqp_solve_given_h<doxid-galahad__bqp_8h_1acb5ad644890efe38b7cf7048d6297308>`(
		data,
		status,
		n,
		h_ne,
	...
	function :ref:`bqp_solve_reverse_h_prod<doxid-galahad__bqp_8h_1a116b9b4ff28b9e2d18be0f0900ce2755>`(
		data,
		status,
		n,
		g,
	...
	function :ref:`bqp_information<doxid-galahad__bqp_8h_1a75b662635f281148e9c19e12e0788362>`(data, inform, status)
	function :ref:`bqp_terminate<doxid-galahad__bqp_8h_1a34db499197d1fd6fb78b294473796fbc>`(data, control, inform)
