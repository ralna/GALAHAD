.. index:: pair: struct; bllsb_inform_type
.. _doxid-structbllsb__inform__type:
...
.. ref-code-block:: cpp
	...
	struct bllsb_inform_type {
		...
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`status<doxid-structbllsb__inform__type_status>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`alloc_status<doxid-structbllsb__inform__type_alloc_status>`;
		char :ref:`bad_alloc<doxid-structbllsb__inform__type_bad_alloc>`[81];
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`iter<doxid-structbllsb__inform__type_iter>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`factorization_status<doxid-structbllsb__inform__type_factorization_status>`;
		int64_t :ref:`factorization_integer<doxid-structbllsb__inform__type_factorization_integer>`;
		int64_t :ref:`factorization_real<doxid-structbllsb__inform__type_factorization_real>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`nfacts<doxid-structbllsb__inform__type_nfacts>`;
		...
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`checkpointsTime<doxid-structbllsb__inform__type_checkpointsTime>`[16];
		struct :ref:`bllsb_time_type<doxid-structbllsb__time__type>` :ref:`time<doxid-structbllsb__inform__type_time>`;
		struct :ref:`fdc_inform_type<doxid-structfdc__inform__type>` :ref:`fdc_inform<doxid-structbllsb__inform__type_fdc_inform>`;
		struct :ref:`sbls_inform_type<doxid-structsbls__inform__type>` :ref:`sbls_inform<doxid-structbllsb__inform__type_sbls_inform>`;
		struct :ref:`fit_inform_type<doxid-structfit__inform__type>` :ref:`fit_inform<doxid-structbllsb__inform__type_fit_inform>`;
		struct :ref:`roots_inform_type<doxid-structroots__inform__type>` :ref:`roots_inform<doxid-structbllsb__inform__type_roots_inform>`;
		struct :ref:`cro_inform_type<doxid-structcro__inform__type>` :ref:`cro_inform<doxid-structbllsb__inform__type_cro_inform>`;
		struct :ref:`rpd_inform_type<doxid-structrpd__inform__type>` :ref:`rpd_inform<doxid-structbllsb__inform__type_rpd_inform>`;
	};
...
.. _doxid-structbllsb__inform__type_status:
...
.. _doxid-structbllsb__inform__type_alloc_status:
...
.. _doxid-structbllsb__inform__type_bad_alloc:
...
.. _doxid-structbllsb__inform__type_iter:
...
.. _doxid-structbllsb__inform__type_factorization_status:
...
.. _doxid-structbllsb__inform__type_factorization_integer:
...
.. _doxid-structbllsb__inform__type_factorization_real:
...
.. _doxid-structbllsb__inform__type_nfacts:
...
.. _doxid-structbllsb__inform__type_nbacts:
...
.. _doxid-structbllsb__inform__type_threads:
...
.. _doxid-structbllsb__inform__type_obj:
...
.. _doxid-structbllsb__inform__type_dual_infeasibility:
...
.. _doxid-structbllsb__inform__type_complementary_slackness:
...
.. _doxid-structbllsb__inform__type_non_negligible_pivot:
...
.. _doxid-structbllsb__inform__type_feasible:
...
.. _doxid-structbllsb__inform__type_checkpointsIter:
...
.. _doxid-structbllsb__inform__type_checkpointsTime:
...
.. _doxid-structbllsb__inform__type_time:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	struct :ref:`bllsb_time_type<doxid-structbllsb__time__type>` time

timings (see above)

.. index:: pair: variable; fdc_inform
.. _doxid-structbllsb__inform__type_fdc_inform:
...
.. _doxid-structbllsb__inform__type_fit_inform:
...
.. _doxid-structbllsb__inform__type_roots_inform:
...
.. _doxid-structbllsb__inform__type_cro_inform:
...
.. _doxid-structbllsb__inform__type_rpd_inform:
