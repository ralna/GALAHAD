...
Thus a call to ``sls_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sls_initialize_s_64(void **data, struct :ref:`sls_control_type_s_64<doxid-structsls__control__type>`* control, 
                             int64_t *status)
