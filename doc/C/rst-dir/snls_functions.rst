...
.. toctree::
	...
	struct_snls_control_type.rst
	struct_snls_inform_type.rst
	struct_snls_time_type.rst
...
.. ref-code-block:: cpp
	...
	struct :ref:`snls_control_type<doxid-structsnls__control__type>`;
	struct :ref:`snls_inform_type<doxid-structsnls__inform__type>`;
	struct :ref:`snls_time_type<doxid-structsnls__time__type>`;

	// function calls

	void :ref:`snls_initialize<doxid-galahad__snls_8h_1aa344bb15b74ab3b3ee6afb2de072b19f>`(
		void **data,
		struct :ref:`snls_control_type<doxid-structsnls__control__type>`* control,
		struct :ref:`snls_inform_type<doxid-structsnls__inform__type>`* inform
	);

	void :ref:`snls_read_specfile<doxid-galahad__snls_8h_1adf9db7eff2fce137ae2abd2e013c47b3>`(struct :ref:`snls_control_type<doxid-structsnls__control__type>`* control, const char specfile[]);

	void :ref:`snls_import<doxid-galahad__snls_8h_1a3f0eb83fd31ee4108156f2e84176389d>`(
		struct :ref:`snls_control_type<doxid-structsnls__control__type>`* control,
		void **data,
	...
	void :ref:`snls_import_withot_jac<doxid-galahad__snls_8h_1a3f0eb83fd31ee4108156f2e84176390d>`(
		struct :ref:`snls_control_type<doxid-structsnls__control__type>`* control,
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
	...
	void :ref:`snls_reset_control<doxid-galahad__snls_8h_1a07f0857c9923ad0f92d51ed00833afda>`(
		struct :ref:`snls_control_type<doxid-structsnls__control__type>`* control,
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status
	);

	void :ref:`snls_solve_with_jac<doxid-galahad__snls_8h_1ae923c2e6afabb3563fe0998d45b715c4>`(
		void **data,
		void *userdata,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
	...
	void :ref:`snls_solve_with_jacprod<doxid-galahad__snls_8h_1a692ecbfaa428584e60aa4c33d7278a64>`(
		void **data,
		void *userdata,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
	...
	void :ref:`snls_solve_reverse_with_jac<doxid-galahad__snls_8h_1a9ad89605640c53c33ddd5894b5e3edd1>`(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
	...
	void :ref:`snls_solve_reverse_with_jacprod<doxid-galahad__snls_8h_1a6dddd928c19adec0abf76bdb2d75da17>`(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *eval_status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
	...
	void :ref:`snls_information<doxid-galahad__snls_8h_1a765da96b0a1f3d07dab53cc3400c22d8>`(void **data, struct :ref:`snls_inform_type<doxid-structsnls__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status);

	void :ref:`snls_terminate<doxid-galahad__snls_8h_1a7babe9112dfad1eb7b57b70135704ab0>`(
		void **data,
		struct :ref:`snls_control_type<doxid-structsnls__control__type>`* control,
		struct :ref:`snls_inform_type<doxid-structsnls__inform__type>`* inform
	);
...
.. ref-code-block:: cpp
	...
	void snls_initialize_s_64(void **data, struct :ref:`snls_control_type_s_64<doxid-structsnls__control__type>`* control, 
                             int64_t *status)
...
.. index:: pair: function; snls_initialize
.. _doxid-galahad__snls_8h_1aa344bb15b74ab3b3ee6afb2de072b19f:
...
.. list-table::
	...
	*
		...
		- is a struct containing control information (see :ref:`snls_control_type <doxid-structsnls__control__type>`)

	*
		- inform

		- is a struct containing output information (see :ref:`snls_inform_type <doxid-structsnls__inform__type>`)

.. index:: pair: function; snls_read_specfile
.. _doxid-galahad__snls_8h_1adf9db7eff2fce137ae2abd2e013c47b3:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void snls_read_specfile(struct :ref:`snls_control_type<doxid-structsnls__control__type>`* control, const char specfile[])
...
with associated default values is provided in \$GALAHAD/src/snls/SNLS.template. 
See also Table 2.1 in the Fortran documentation provided in 
\$GALAHAD/doc/snls.pdf for a list of how these keywords 
...
.. index:: pair: function; snls_import
.. _doxid-galahad__snls_8h_1a3f0eb83fd31ee4108156f2e84176389d:
...
.. list-table::
	...
	*
		...
		- is a struct whose members provide control paramters for the remaining prcedures (see :ref:`snls_control_type <doxid-structsnls__control__type>`)
	...
	*
		...
		- is a one-dimensional array of type char that specifies the :ref:`unsymmetric storage scheme<details-snls_storage__unsym>` used for the Jacobian, $J_r$. It should be one of 'coordinate', 'sparse_by_rows', 'dense' or 'absent', the latter if access to the Jacobian is via matrix-vector products; lower or upper case variants are allowed.
...
.. index:: pair: function; snls_import_without_jac
...
.. index:: pair: function; snls_reset_control
.. _doxid-galahad__snls_8h_1a07f0857c9923ad0f92d51ed00833afda:
...
.. index:: pair: function; snls_solve_with_jac
.. _doxid-galahad__snls_8h_1ae923c2e6afabb3563fe0998d45b715c4:
...
.. index:: pair: function; snls_solve_with_jacprod
.. _doxid-galahad__snls_8h_1a692ecbfaa428584e60aa4c33d7278a64:
...
.. index:: pair: function; snls_solve_reverse_with_jac
.. _doxid-galahad__snls_8h_1a9ad89605640c53c33ddd5894b5e3edd1:
...
.. list-table::
	...
	*
		...
		- 
		  ...
		  * **3**
                    ...
                    of $J_r$ in the earlier call to snls_import
	...
	*
		...
		- is a one-dimensional array of size m_r and type :ref:`rpc_<doxid-galahad__rpc_8h_>` that holds the values $w$ of the weights on the residuals in the least-squares objective function. It need not be set if the weights are all ones, and in this case can be NULL.
.. index:: pair: function; snls_solve_reverse_with_jacprod
.. _doxid-galahad__snls_8h_1a6dddd928c19adec0abf76bdb2d75da17:
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of size m_r and type :ref:`rpc_<doxid-galahad__rpc_8h_>` that holds the values $w$ of the weights on the residuals in the least-squares objective function. It need not be set if the weights are all ones, and in this case can be NULL.
.. index:: pair: function; snls_information
.. _doxid-galahad__snls_8h_1a765da96b0a1f3d07dab53cc3400c22d8:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void snls_information(void **data, struct :ref:`snls_inform_type<doxid-structsnls__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status)
...
.. index:: pair: function; snls_terminate
.. _doxid-galahad__snls_8h_1a7babe9112dfad1eb7b57b70135704ab0:
