...
.. ref-code-block:: cpp
	...
	struct nls_control_type {
		...
		bool :ref:`f_indexing<doxid-structnls__control__type_f_indexing>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`error<doxid-structnls__control__type_error>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`out<doxid-structnls__control__type_out>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`print_level<doxid-structnls__control__type_print_level>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`start_print<doxid-structnls__control__type_start_print>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`stop_print<doxid-structnls__control__type_stop_print>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`print_gap<doxid-structnls__control__type_print_gap>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`maxit<doxid-structnls__control__type_maxit>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`alive_unit<doxid-structnls__control__type_alive_unit>`;
		char :ref:`alive_file<doxid-structnls__control__type_alive_file>`[31];
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`jacobian_available<doxid-structnls__control__type_jacobian_available>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`hessian_available<doxid-structnls__control__type_hessian_available>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`model<doxid-structnls__control__type_model>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`norm<doxid-structnls__control__type_norm>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`non_monotone<doxid-structnls__control__type_non_monotone>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`weight_update_strategy<doxid-structnls__control__type_weight_update_strategy>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_c_absolute<doxid-structnls__control__type_stop_c_absolute>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_c_relative<doxid-structnls__control__type_stop_c_relative>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_g_absolute<doxid-structnls__control__type_stop_g_absolute>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_g_relative<doxid-structnls__control__type_stop_g_relative>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_s<doxid-structnls__control__type_stop_s>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`power<doxid-structnls__control__type_power>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`initial_weight<doxid-structnls__control__type_initial_weight>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`minimum_weight<doxid-structnls__control__type_minimum_weight>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`initial_inner_weight<doxid-structnls__control__type_initial_inner_weight>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`eta_successful<doxid-structnls__control__type_eta_successful>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`eta_very_successful<doxid-structnls__control__type_eta_very_successful>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`eta_too_successful<doxid-structnls__control__type_eta_too_successful>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_decrease_min<doxid-structnls__control__type_weight_decrease_min>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_decrease<doxid-structnls__control__type_weight_decrease>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_increase<doxid-structnls__control__type_weight_increase>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_increase_max<doxid-structnls__control__type_weight_increase_max>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`reduce_gap<doxid-structnls__control__type_reduce_gap>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`tiny_gap<doxid-structnls__control__type_tiny_gap>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`large_root<doxid-structnls__control__type_large_root>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`switch_to_newton<doxid-structnls__control__type_switch_to_newton>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`cpu_time_limit<doxid-structnls__control__type_cpu_time_limit>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`clock_time_limit<doxid-structnls__control__type_clock_time_limit>`;
		bool :ref:`subproblem_direct<doxid-structnls__control__type_subproblem_direct>`;
		bool :ref:`renormalize_weight<doxid-structnls__control__type_renormalize_weight>`;
		bool :ref:`magic_step<doxid-structnls__control__type_magic_step>`;
		bool :ref:`print_obj<doxid-structnls__control__type_print_obj>`;
		bool :ref:`space_critical<doxid-structnls__control__type_space_critical>`;
		bool :ref:`deallocate_error_fatal<doxid-structnls__control__type_deallocate_error_fatal>`;
		char :ref:`prefix<doxid-structnls__control__type_prefix>`[31];
		struct :ref:`rqs_control_type<doxid-structrqs__control__type>` :ref:`rqs_control<doxid-structnls__control__type_rqs_control>`;
		struct :ref:`glrt_control_type<doxid-structglrt__control__type>` :ref:`glrt_control<doxid-structnls__control__type_glrt_control>`;
		struct :ref:`psls_control_type<doxid-structpsls__control__type>` :ref:`psls_control<doxid-structnls__control__type_psls_control>`;
		struct :ref:`bsc_control_type<doxid-structbsc__control__type>` :ref:`bsc_control<doxid-structnls__control__type_bsc_control>`;
		struct :ref:`roots_control_type<doxid-structroots__control__type>` :ref:`roots_control<doxid-structnls__control__type_roots_control>`;
		struct :ref:`nls_subproblem_control_type<doxid-structnls__subproblem__control__type>` :ref:`subproblem_control<doxid-structnls__control__type_subproblem_control>`;
	};
