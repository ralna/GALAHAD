...
Thus a call to ``glrt_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void glrt_initialize_s_64(void **data, struct :ref:`glrt_control_type_s_64<doxid-structglrt__control__type>`* control, 
                             int64_t *status)
