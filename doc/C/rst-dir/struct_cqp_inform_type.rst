...
.. ref-code-block:: cpp
	...
	struct cqp_inform_type {
		...
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`status<doxid-structcqp__inform__type_status>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`alloc_status<doxid-structcqp__inform__type_alloc_status>`;
		char :ref:`bad_alloc<doxid-structcqp__inform__type_bad_alloc>`[81];
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`iter<doxid-structcqp__inform__type_iter>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`factorization_status<doxid-structcqp__inform__type_factorization_status>`;
		int64_t :ref:`factorization_integer<doxid-structcqp__inform__type_factorization_integer>`;
		int64_t :ref:`factorization_real<doxid-structcqp__inform__type_factorization_real>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`nfacts<doxid-structcqp__inform__type_nfacts>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`nbacts<doxid-structcqp__inform__type_nbacts>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`threads<doxid-structcqp__inform__type_threads>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`obj<doxid-structcqp__inform__type_obj>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`primal_infeasibility<doxid-structcqp__inform__type_primal_infeasibility>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`dual_infeasibility<doxid-structcqp__inform__type_dual_infeasibility>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`complementary_slackness<doxid-structcqp__inform__type_complementary_slackness>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`init_primal_infeasibility<doxid-structcqp__inform__type_init_primal_infeasibility>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`init_dual_infeasibility<doxid-structcqp__inform__type_init_dual_infeasibility>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`init_complementary_slackness<doxid-structcqp__inform__type_init_complementary_slackness>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`potential<doxid-structcqp__inform__type_potential>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`non_negligible_pivot<doxid-structcqp__inform__type_non_negligible_pivot>`;
		bool :ref:`feasible<doxid-structcqp__inform__type_feasible>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`checkpointsIter<doxid-structcqp__inform__type_checkpointsIter>`[16];
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`checkpointsTime<doxid-structcqp__inform__type_checkpointsTime>`[16];
		struct :ref:`cqp_time_type<doxid-structcqp__time__type>` :ref:`time<doxid-structcqp__inform__type_time>`;
		struct :ref:`fdc_inform_type<doxid-structfdc__inform__type>` :ref:`fdc_inform<doxid-structcqp__inform__type_fdc_inform>`;
		struct :ref:`sbls_inform_type<doxid-structsbls__inform__type>` :ref:`sbls_inform<doxid-structcqp__inform__type_sbls_inform>`;
		struct :ref:`fit_inform_type<doxid-structfit__inform__type>` :ref:`fit_inform<doxid-structcqp__inform__type_fit_inform>`;
		struct :ref:`roots_inform_type<doxid-structroots__inform__type>` :ref:`roots_inform<doxid-structcqp__inform__type_roots_inform>`;
		struct :ref:`cro_inform_type<doxid-structcro__inform__type>` :ref:`cro_inform<doxid-structcqp__inform__type_cro_inform>`;
		struct :ref:`rpd_inform_type<doxid-structrpd__inform__type>` :ref:`rpd_inform<doxid-structcqp__inform__type_rpd_inform>`;
	};
