...
Thus a call to ``rpd_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void rpd_initialize_s_64(void **data, struct :ref:`rpd_control_type_s_64<doxid-structrpd__control__type>`* control, 
                             int64_t *status)
