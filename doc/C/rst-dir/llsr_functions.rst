...
.. list-table::
	...
	*
		...
		- is a scalar of type double, that holds the regularization power, $p$, used. power must be greater than or equal to two.

	*
		- weight

		- is a scalar of type double, that holds the regularization power, $\sigma$, used. weight must be strictly positive
