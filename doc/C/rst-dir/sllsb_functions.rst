...
.. toctree::
	...
	struct_sllsb_control_type.rst
	struct_sllsb_inform_type.rst
	struct_sllsb_time_type.rst
...
.. ref-code-block:: cpp
	...
	struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`;
	struct :ref:`sllsb_inform_type<doxid-structsllsb__inform__type>`;
	struct :ref:`sllsb_time_type<doxid-structsllsb__time__type>`;

	// function calls

	void :ref:`sllsb_initialize<doxid-galahad__sllsb_8h_1a782387ad9cccc5f2e2da9df9016fb923>`(void **data, struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status);
	void :ref:`sllsb_read_specfile<doxid-galahad__sllsb_8h_1ade439e5e06c2852fcb089bb39a667a74>`(struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control, const char specfile[]);

	void :ref:`sllsb_import<doxid-galahad__sllsb_8h_1a6a2be17b6f871df80bbac93940b83af3>`(
		struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control,
		void **data,
	...
	void :ref:`sllsb_reset_control<doxid-galahad__sllsb_8h_1a9f7ccb0cffa909a2be7556edda430190>`(
		struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control,
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status
	);

	void :ref:`sllsb_solve_given_a<doxid-galahad__sllsb_8h_1ac2d720ee7b719bf63c3fa208d37f1bc1>`(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` o,
	...
	void :ref:`sllsb_information<doxid-galahad__sllsb_8h_1adfb7589696e4e07fdb65f02bc42c5daf>`(void **data, struct :ref:`sllsb_inform_type<doxid-structsllsb__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status);

	void :ref:`sllsb_terminate<doxid-galahad__sllsb_8h_1a84e12e9e546f51762d305333dce68e2b>`(
		void **data,
		struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control,
		struct :ref:`sllsb_inform_type<doxid-structsllsb__inform__type>`* inform
	);
...
Thus a call to ``sllsb_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sllsb_initialize_s_64(void **data, struct :ref:`sllsb_control_type_s_64<doxid-structsllsb__control__type>`* control, 
                             int64_t *status)
...
.. index:: pair: function; sllsb_initialize
.. _doxid-galahad__sllsb_8h_1a782387ad9cccc5f2e2da9df9016fb923:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sllsb_initialize(void **data, struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status)
...
.. list-table::
	...
	*
		...
		- is a struct containing control information (see :ref:`sllsb_control_type <doxid-structsllsb__control__type>`)
...
.. index:: pair: function; sllsb_read_specfile
.. _doxid-galahad__sllsb_8h_1ade439e5e06c2852fcb089bb39a667a74:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sllsb_read_specfile(struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control, const char specfile[])
...
with associated default values is provided in \$GALAHAD/src/sllsb/SLLSB.template. 
See also Table 2.1 in the Fortran documentation provided in 
\$GALAHAD/doc/sllsb.pdf for a list of how these keywords 
...
.. index:: pair: function; sllsb_import
.. _doxid-galahad__sllsb_8h_1a6a2be17b6f871df80bbac93940b83af3:
...
.. list-table::
	...
	*
		...
		- is a struct whose members provide control paramters for the remaining prcedures (see :ref:`sllsb_control_type <doxid-structsllsb__control__type>`)
	...
	*
		...
		- is a scalar variable of type :ref:`ipc_<doxid-galahad__ipc_8h_>`, that holds the number of cohorts; this will be ignored if cohort (see later) is None.

	*
		- Ao_type

		- is a one-dimensional array of type char that specifies the :ref:`unsymmetric storage scheme<details-sllsb_storage__unsym>` used for the objective design matrix, $A_o$. It should be one of 'coordinate', 'sparse_by_rows', 'sparse_by_columns', 'dense' or 'dense_by_columns'; lower or upper case variants are allowed.
	...
	*
		...
		- is a one-dimensional array of size n and type :ref:`ipc_<doxid-galahad__ipc_8h_>`, that specifies which cohort each variable is associated with. If variable $x_j$ is associated with cohort $\cal C_i$, $0 \leq i \leq m-1$, cohort[j] should be set to i, while if $x_j$ is unconstrained cohort[j] < 0 should be assigned. At least one value cohort[j] for $j = 0,\ldots\,n-1$ is expected to take the value $i$ for every $0 \leq i \leq m-1$, that is no empty cohorts are allowed. If all the variables lie in a single cohort, cohort can be NULL.
...
.. index:: pair: function; sllsb_solve_sllsb
.. _doxid-galahad__sllsb_8h_1ac2d720ee7b719bf63c3fa208d37f1bc1:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sllsb_solve_given_a(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` o,
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of size m and type :ref:`rpc_<doxid-galahad__rpc_8h_>`, that holds the values $y$ of the Lagrange multipliers for the simplex equality constraints. The i-th component of y, i = 0, ... , m-1, contains $y_i$.
...
.. index:: pair: function; sllsb_information
.. _doxid-galahad__sllsb_8h_1adfb7589696e4e07fdb65f02bc42c5daf:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sllsb_information(void **data, struct :ref:`sllsb_inform_type<doxid-structsllsb__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status)
...
.. list-table::
	...
	*
		...
		- is a struct containing output information (see :ref:`sllsb_inform_type <doxid-structsllsb__inform__type>`)
...
.. index:: pair: function; sllsb_terminate
.. _doxid-galahad__sllsb_8h_1a84e12e9e546f51762d305333dce68e2b:

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void sllsb_terminate(
		void **data,
		struct :ref:`sllsb_control_type<doxid-structsllsb__control__type>`* control,
		struct :ref:`sllsb_inform_type<doxid-structsllsb__inform__type>`* inform
	)
