...
Thus a call to ``gltr_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void gltr_initialize_s_64(void **data, struct :ref:`gltr_control_type_s_64<doxid-structgltr__control__type>`* control, 
                             int64_t *status)
