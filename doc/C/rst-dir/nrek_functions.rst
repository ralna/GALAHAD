...
.. toctree::
	...
	struct_nrek_control_type.rst
	struct_nrek_time_type.rst
	struct_nrek_inform_type.rst
...
.. ref-code-block:: cpp
	...
	struct :ref:`nrek_control_type<doxid-structnrek__control__type>`;
	struct :ref:`nrek_time_type<doxid-structnrek__time__type>`;
	struct :ref:`nrek_inform_type<doxid-structnrek__inform__type>`;

	// global functions

	void :ref:`nrek_initialize<doxid-galahad__nrek_8h_1acb066d992c4ec394402bc7b7317e1163>`(void **data, struct :ref:`nrek_control_type<doxid-structnrek__control__type>`* control, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status);
	void :ref:`nrek_read_specfile<doxid-galahad__nrek_8h_1adc7c56e7be2f7cc9d32921582d379b13>`(struct :ref:`nrek_control_type<doxid-structnrek__control__type>`* control, const char specfile[]);

	void :ref:`nrek_import<doxid-galahad__nrek_8h_1a4becded30e9b95fe7028b7799292c0af>`(
		struct :ref:`nrek_control_type<doxid-structnrek__control__type>`* control,
		void **data,
	...
	void :ref:`nrek_import_s<doxid-galahad__nrek_8h_1a427420b6025d522bb7b3c652e8c2be48>`(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
		const char S_type[],
	...
	void :ref:`nrek_reset_control<doxid-galahad__nrek_8h_1aae677e64bacb35354f49326815b694c3>`(
		struct :ref:`nrek_control_type<doxid-structnrek__control__type>`* control,
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status
	);

	void :ref:`nrek_solve_problem<doxid-galahad__nrek_8h_1aadb8a751c29efcef663bf9560a1f9a8e>`(
		void **data,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` *status,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` n,
		:ref:`ipc_<doxid-galahad__ipc_8h_>` H_ne,
	...
	void :ref:`nrek_information<doxid-galahad__nrek_8h_1a3dda24010e564e2d6536cc7ea518451e>`(void **data, struct :ref:`nrek_inform_type<doxid-structnrek__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status);

	void :ref:`nrek_terminate<doxid-galahad__nrek_8h_1ab5cf0077db0631814fdd03599a585376>`(
		void **data,
		struct :ref:`nrek_control_type<doxid-structnrek__control__type>`* control,
		struct :ref:`nrek_inform_type<doxid-structnrek__inform__type>`* inform
	);
...
.. ref-code-block:: cpp
	...
	void nrek_initialize_s_64(void **data, struct :ref:`nrek_control_type_s_64<doxid-structnrek__control__type>`* control, 
                             int64_t *status)
...
.. ref-code-block:: cpp
	...
	void nrek_initialize(void **data, struct :ref:`nrek_control_type<doxid-structnrek__control__type>`* control, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status)
...
.. list-table::
	...
	*
		...
		- is a struct containing control information (see :ref:`nrek_control_type <doxid-structnrek__control__type>`)
...
.. ref-code-block:: cpp
	...
	void nrek_read_specfile(struct :ref:`nrek_control_type<doxid-structnrek__control__type>`* control, const char specfile[])
...
\$GALAHAD/src/nrek/NREK.template. 
See also Table 2.1 in the Fortran documentation provided in 
\$GALAHAD/doc/nrek.pdf for a list of how these keywords 
...
.. list-table::
	...
	*
		...
		- is a struct whose members provide control paramters for the remaining prcedures (see :ref:`nrek_control_type <doxid-structnrek__control__type>`)
	...
	*
		...
		- is a one-dimensional array of type char that specifies the :ref:`symmetric storage scheme<details-nrek_storage__sym>` used for the Hessian, $H$. It should be one of 'coordinate', 'sparse_by_rows', 'dense', 'diagonal', 'scaled-identity', 'identity', 'zero' or 'none'; lower or upper case variants are allowed.
...
.. index:: pair: function; nrek_import_s
...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of type char that specifies the :ref:`symmetric storage scheme<details-nrek_storage__sym>` used for the scaling matrix, $S$. It should be one of 'coordinate', 'sparse_by_rows', 'dense', or 'diagonal'; lower or upper case variants are allowed.
...
.. list-table::
		...
		- 
		  ...
		  * **-18**
                  ...
                  * **-31**
                    ...
                    (see control.new_weight and control.new_values).
	...
	*
		...
		- is a scalar of type :ref:`rpc_<doxid-galahad__rpc_8h_>`, that holds the regularization power, $p$, used. power must be strictly larger than two

	*
		- weight

		- is a scalar of type :ref:`rpc_<doxid-galahad__rpc_8h_>`, that holds the regularization weight, $\sigma$, used. weight must be strictly positive
...
.. ref-code-block:: cpp
	...
	void nrek_information(void **data, struct :ref:`nrek_inform_type<doxid-structnrek__inform__type>`* inform, :ref:`ipc_<doxid-galahad__ipc_8h_>` *status)
...
.. list-table::
	...
	*
		...
		- is a struct containing output information (see :ref:`nrek_inform_type <doxid-structnrek__inform__type>`)
