...
Thus a call to ``ugo_initialize`` below will instead be

.. ref-code-block:: cpp
	:class: doxyrest-title-code-block

	void ugo_initialize_s_64(void **data, struct :ref:`ugo_control_type_s_64<doxid-structugo__control__type>`* control, 
                             int64_t *status)
