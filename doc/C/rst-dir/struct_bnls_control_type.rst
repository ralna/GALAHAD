...
.. ref-code-block:: cpp
	...
	struct bnls_control_type {
		// components
	
		bool :ref:`f_indexing<doxid-structbnls__control__type_f_indexing>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`error<doxid-structbnls__control__type_error>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`out<doxid-structbnls__control__type_out>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`print_level<doxid-structbnls__control__type_print_level>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`start_print<doxid-structbnls__control__type_start_print>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`stop_print<doxid-structbnls__control__type_stop_print>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`print_gap<doxid-structbnls__control__type_print_gap>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`maxit<doxid-structbnls__control__type_maxit>`;
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`alive_unit<doxid-structbnls__control__type_alive_unit>`;
		char :ref:`alive_file<doxid-structbnls__control__type_alive_file>`[31];
		:ref:`ipc_<doxid-galahad__ipc_8h_>` :ref:`jacobian_available<doxid-structbnls__control__type_jacobian_available>`;
		...
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_pg_relative<doxid-structbnls__control__type_stop_pg_relative>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_s<doxid-structbnls__control__type_stop_s>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`stop_pg_switch<doxid-structbnls__control__type_stop_pg_switch>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`initial_weight<doxid-structbnls__control__type_initial_weight>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`minimum_weight<doxid-structbnls__control__type_minimum_weight>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`eta_successful<doxid-structbnls__control__type_eta_successful>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`eta_very_successful<doxid-structbnls__control__type_eta_very_successful>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`eta_too_successful<doxid-structbnls__control__type_eta_too_successful>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_decrease_min<doxid-structbnls__control__type_weight_decrease_min>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_decrease<doxid-structbnls__control__type_weight_decrease>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_increase<doxid-structbnls__control__type_weight_increase>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`weight_increase_max<doxid-structbnls__control__type_weight_increase_max>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`switch_to_newton<doxid-structbnls__control__type_switch_to_newton>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`cpu_time_limit<doxid-structbnls__control__type_cpu_time_limit>`;
		:ref:`rpc_<doxid-galahad__rpc_8h_>` :ref:`clock_time_limit<doxid-structbnls__control__type_clock_time_limit>`;
		bool :ref:`newton_acceleration<doxid-structbnls__control__type_newton_acceleration>`;
		bool :ref:`magic_step<doxid-structbnls__control__type_magic_step>`;
		bool :ref:`print_obj<doxid-structbnls__control__type_print_obj>`;
		bool :ref:`space_critical<doxid-structbnls__control__type_space_critical>`;
		bool :ref:`deallocate_error_fatal<doxid-structbnls__control__type_deallocate_error_fatal>`;
		char :ref:`prefix<doxid-structbnls__control__type_prefix>`[31];
		struct :ref:`blls_control_type<doxid-structblls__control__type>` :ref:`blls_control<doxid-structbnls__control__type_blls_control>`;
		struct :ref:`bllsb_control_type<doxid-structbllsb__control__type>` :ref:`bllsb_control<doxid-structbnls__control__type_bllsb_control>`;
	};
