...
---------
   ...
   .. function:: cqp.load(n, m, H_type, H_ne, H_row, H_col, H_ptr, A_type, A_ne, A_row, A_col, A_ptr, options=None)
   ...
   .. function:: cqp.solve_qp(n, m, f, g, h_ne, H_val, a_ne, A_val, c_l, c_u, x_l, x_u)
   ...
   .. function:: cqp.solve_sldqp(n, m, f, g, w, x0, a_ne, A_val, c_l, c_u, x_l, x_u)
   ...
   .. function:: [optional] cqp.information()
      ...
      inform : dict
         dictionary containing output information:
          ...
          obj : float
             ...
             of the solution determined by CQP_solve.
          ...
          init_primal_infeasibility : float
             these values at the initial point (needed by ``ccqp``).
...
.. include:: ../../src/cqp/Python/test_cqp.py
   :code: python

This example code is available in $GALAHAD/src/cqp/Python/test_cqp.py .
