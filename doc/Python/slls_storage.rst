...
will hold the value $A_{o\,ij}$ for $0 \leq i \leq o-1$, $0 \leq j \leq n-1$.
...
its row index i, column index j and value $A_{o\,ij}$,
...
$A_{o\,ij}$ of the  nonzero entries in the i-th row are stored in components
...
The row indices i, $0 \leq i \leq o-1$, and values $A_{o\,ij}$
