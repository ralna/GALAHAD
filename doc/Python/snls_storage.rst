...
will hold the value $J_{ij}$ for $0 \leq i \leq m_r-1$, $0 \leq j \leq n-1$.
...
For the $l$-th entry, $0 \leq l \leq ne-1$, of $J_r$,
its row index i, column index j and value $J_{ij}$,
$0 \leq i \leq m_r-1$,  $0 \leq j \leq n-1$,  are stored as
the $l$-th components of the integer arrays Jr_row and
Jr_col and real array Jr_val, respectively, while the number of nonzeros
is recorded as Jr_ne = $ne$.
...
l = Jr_ptr(i), $\ldots$, Jr_ptr(i+1)-1,  $0 \leq i \leq m_r-1$,
...
The row indices i, $0 \leq i \leq m_r-1$, and values $J_{ij}$
of the  nonzero entries in the j-th columnsare stored in components
l = Jr_ptr(j), $\ldots$, Jr_ptr(j+1)-1, $0 \leq j \leq n-1$,
