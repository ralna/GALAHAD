...
.. include:: bllsb_intro.rst

.. include:: bllsb_storage.rst

functions
---------

   .. function:: bllsb.initialize()
   ...
   .. function:: bllsb.load(n, o, Ao_type, Ao_ne, Ao_row, Ao_col, Ao_ptr_ne, Ao_ptr, options=None)
   ...
   .. function:: [optional] bllsb.information()
      ...
      inform : dict
         dictionary containing output information:
          ...
          init_primal_infeasibility : float
             these values at the initial point (needed by ``cbllsb``).
...
.. include:: ../../src/bllsb/Python/test_bllsb.py
   :code: python
