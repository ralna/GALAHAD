...
---------
   ...
   .. function:: snls.load(n, m, J_type, J_ne, J_row, J_col, J_ptr, H_type, H_ne,                          H_row, H_col, H_ptr, P_type, P_ne, P_row, P_col, P_ptr, w, options=None)
   ...
   .. function:: snls.solve(n, m, x, eval_c, J_ne, eval_j, H_ne, eval_h, P_ne, eval_hprod)
      ...
      **Parameters:**
      ...
      eval_h : callable, optional
          ...
          same order as specified in the sparsity pattern in ``snls.load``.
      P_ne : int, optional
