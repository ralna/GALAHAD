...
.. include:: nrek_intro.rst

.. include:: nrek_storage.rst

functions
---------

   .. function:: nrek.initialize()
      ...
      **Returns:**
      ...
      options : dict
        dictionary containing default control options:
          ...
          increase : float
             the value of the increase factor for a suggested subsequent 
             regularization weight, see control['next_weight']. The suggested
             weight will be ``increase`` times the current weight.
          stop_residual : float
          ...
          new_weight : bool
             ...
             and $c$, but with a new, larger weight.
          new_values : bool
   ...
   .. function:: nrek.load(n, H_type, H_ne, H_row, H_col, H_ptr, options=None)
      ...
      **Parameters:**
      ...
      options : dict, optional
          dictionary of control options (see ``nrek.initialize``).

   .. function:: [optional] nrek.load_s(n, S_type, S_ne, S_row, S_col, S_ptr, options=None)
   ...
   .. function:: [optional] nrek.reset_options(options)
   ...
   .. function:: nrek.solve_problem(n, H_ne, H_val, c, power, weight, S_ne, S_val)
      ...
      **Parameters:**
      ...
      power : float
          holds the regularization power, $p > 2$.
      weight : float
      ...
      S_val : ndarray(S_ne)
          ...
          ``nrek.load_s`` if needed. Otherwise it should be None.
   ...
   .. function:: [optional] nrek.information()
      ...
      inform : dict
         dictionary containing output information:
          status : int
            ...
            * **-3**
              The restriction n > 0, power > 2, weight > 0,
            ...
            * **-31** 
              ...
              options['new_weight'] and options['new_values']).
          ...
          obj : float
             ...
             $f + c^T x + \frac{1}{2} x^T H x$
          obj_regularization : float
          ...
          weight : float
             the current regularization weight
          next_weight : float
             the  proposed next regularization weight to be used
          error : float
...
.. include:: ../../src/nrek/Python/test_nrek.py
   :code: python

This example code is available in $GALAHAD/src/nrek/Python/test_nrek.py .
