...
.. include:: clls_intro.rst

.. include:: clls_storage.rst

functions
---------

   .. function:: clls.initialize()
      ...
      inform : dict
         dictionary containing output information:
          ...
          init_primal_infeasibility : float
             these values at the initial point (needed by ``cclls``).
...
.. include:: ../../src/clls/Python/test_clls.py
   :code: python

This example code is available in $GALAHAD/src/clls/Python/test_clls.py .
