...
---------
        ...
        dictionary containing default control options:
          ...
          indicator_type : int
             ...
             * **1**
               ...
               primal indicator: a variable is active if and only
               if  the distance to its nearest bound <= ``indicator_p_tol``.

             * **2**

               primal-dual indicator: a variable is active if and only if the
               distance to its nearest bound <= ``indicator_tol_pd`` times the
               size of the corresponding multiplier.

             * **3**

               primal-dual indicator: a variable is active if and
          ...
          identical_bounds_tol : float
             any pair of variable bounds $(x_l,x_u)$
          ...
          reduced_pounce_system : bool
             if ``reduced_pounce_system`` is True, eliminate fixed variables 
             when solving the linear system required by the attempted pounce 
             to the solution
          space_critical : bool
          ...
          sls_pounce_options : dict
             default control options for the SLS pounce 
             (see ``sls.initialize``).
          fit_options : dict
   ...
   .. function:: sllsb.load(n, o, m, Ao_type, Ao_ne, Ao_row, Ao_col, Ao_ptr_ne, Ao_ptr, cohort, options=None)
      ...
      **Parameters:**
      ...
      options : dict, optional
          dictionary of control options (see ``sllsb.initialize``).

   .. function:: sllsb.solve(n, o, m, Ao_ne, Ao_val, b, sigma, x, y, z, w, x_s)

      Find a solution to the simplex-constrained (regularized) linear 
      ...
      **Parameters:**
      ...
      Ao_val : ndarray(Ao_ne)
          ...
          specified in the sparsity pattern in ``sllsb.load``.
      b : ndarray(m)
      ...
      y : ndarray(m)
          ...
          associated with the simplex equality constraints, if known.
          This is not crucial, and if no suitable value is known, then any
          value, such as $y=0$, suffices and will be adjusted accordingly.
      z : ndarray(n)
          holds the initial estimate of the dual variables $z$
          associated with the nonnegativity constraints, if known.
          This is not crucial, and if no suitable value is known, then any
      ...
      **Returns:**
      ...
      y : ndarray(m)
          ...
          simplex equality constraints.
      z : ndarray(n)
          holds the values of the dual variables associated with the 
          simple bound constraints.
      r : ndarray(o)
          holds the values of the residuals $r(x) = A_o x-b$.
      x_stat : ndarray(n)
   ...
   .. function:: [optional] sllsb.information()
      ...
      inform : dict
         dictionary containing output information:
          ...
          obj : float
             ...
             best estimate of the solution determined by SLLSB_solve.
          ls_obj : float
          ...
          init_primal_infeasibility : float
             these values at the initial point (needed by ``csllsb``).
          ...
          sls_pounce_inform : dict
             inform parameters for the SLS pounce (see ``sbls.information``).
          fit_inform : dict
...
.. include:: ../../src/sllsb/Python/test_sllsb.py
   :code: python

This example code is available in $GALAHAD/src/sllsb/Python/test_sllsb.py .
