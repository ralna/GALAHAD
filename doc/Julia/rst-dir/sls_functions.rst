...
.. list-table::
	...
	*
		...
		- is a one-dimensional array of type Vararg{Cchar} that specifies the :ref:`solver package<details-sls__solvers>` that should be used to factorize the matrix $A$. It should be one of 'sils', 'ma27', 'ma57', 'ma77', 'ma86', 'ma87', 'ma97', 'slblt', 'mumps', 'pardiso', 'mkl pardiso', 'pastix', 'wsmp', 'potr', 'sytr' or 'pbtr'; lower or upper case variants are allowed.
