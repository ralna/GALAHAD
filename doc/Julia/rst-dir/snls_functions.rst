...
.. list-table::
	...
	*
		...
		- is a structure containing control information (see :ref:`snls_control_type <doxid-structsnls__control__type>`)

	*
		- inform

		- is a structure containing output information (see :ref:`snls_inform_type <doxid-structsnls__inform__type>`)
...
\$GALAHAD/src/snls/SNLS.template.  See also Table 2.1 in the Fortran
documentation provided in \$GALAHAD/doc/snls.pdf for a list of how these
...
.. list-table::
	...
	*
		...
		- is a structure whose members provide control parameters for the remaining procedures (see :ref:`snls_control_type <doxid-structsnls__control__type>`)
	...
	*
		...
		- is a scalar variable of type INT that gives the
		  ...
		  * **3**
                    ...
                    of $J_r$ in the earlier call to snls_import should be
