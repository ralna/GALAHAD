...
.. list-table::
	...
	*
		...
		- is a structure containing control information (see :ref:`ssls_control_type <doxid-structssls__control__type>`)
...
\$GALAHAD/src/ssls/SSLS.template.  See also Table 2.1 in the Fortran
documentation provided in \$GALAHAD/doc/ssls.pdf for a list of how these
...
.. list-table::
	...
	*
		...
		- is a structure whose members provide control parameters for the remaining procedures (see :ref:`ssls_control_type <doxid-structssls__control__type>`)
...
.. list-table::
	...
	*
		...
		- is a structure containing output information (see :ref:`ssls_inform_type <doxid-structssls__inform__type>`)
