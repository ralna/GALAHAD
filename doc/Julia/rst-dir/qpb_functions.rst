...
.. ref-code-block:: julia
	:class: doxyrest-title-code-block
        ...
        function qpb_read_specfile(T, INT, control, specfile)
...
\$GALAHAD/src/qpb/QPB.template.  See also Table 2.1 in the Fortran
documentation provided in \$GALAHAD/doc/qpb.pdf for a list of how these
...
.. ref-code-block:: julia
	:class: doxyrest-title-code-block
        ...
        function qpb_import(T, INT, control, data, status, n, m, 
...
.. list-table::
	...
	*
		...
		- is a structure whose members provide control parameters for the remaining procedures (see :ref:`qpb_control_type <doxid-structqpb__control__type>`)
...
.. ref-code-block:: julia
	:class: doxyrest-title-code-block
        ...
        function qpb_solve_qp(T, INT, data, status, n, m, h_ne, H_val, g, f, 
...
.. ref-code-block:: julia
	:class: doxyrest-title-code-block
        ...
        function qpb_terminate(T, INT, data, control, inform)
