...
* :ref:`llsr_import_scaling <doxid-galahad__llsr_8h_1a75f3108d65fc8100776af18f6adf4c2c>` (optional) - set up problem data structures for :math:`S` if required
...
(with the additional suffix ``_s``, e.g., ``llsr_initialize_s``) 
...
the code is available in $GALAHAD/src/llsr/Julia/test_llsr.jl .
A variety of supported Hessian and constraint matrix storage formats are shown.

.. include :: ../../../src/llsr/Julia/test_llsr.jl
   :code: julia
