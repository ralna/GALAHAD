...
\$GALAHAD/src/dgo/DGO.template.  See also Table 2.1 in the Fortran
documentation provided in \$GALAHAD/doc/dgo.pdf for a list of how these
...
.. list-table::
	...
	*
		...
		- is a structure whose members provide control parameters for the remaining procedures (see :ref:`dgo_control_type <doxid-structdgo__control__type>`)
