...
* :ref:`expo_import <doxid-galahad__expo_8h_1a3f0eb83fd31ee4108156f2e84176389d>` - import structural data and set up data structures prior to solution
...
* :ref:`expo_solve_hessian_direct <doxid-galahad__expo_8h_1ae923c2e6afabb3563fe0998d45b715c4>` - solve the problem using function calls to evaluate function, gradient and Hessian values
...
.. include :: struct_expo_subproblem_control_type.rst

.. include :: struct_expo_control_type.rst

.. include :: struct_expo_time_type.rst

.. include :: struct_expo_subproblem_inform_type.rst
...
problem; the code is available in $GALAHAD/src/expo/Julia/test_expo.jl .
A variety of supported Hessian and constraint matrix storage formats are shown.

.. include :: ../../../src/forthcoming/expo/Julia/test_expo.jl
   :code: julia
