...
(with the additional suffix ``_s``, e.g., ``dgo_initialize_s``) 
...
objective; the code is available in $GALAHAD/src/dgo/Julia/test_dgo.jl .
A variety of supported Hessian and constraint matrix storage formats are shown.

.. include :: ../../../src/dgo/Julia/test_dgo.jl
   :code: julia
