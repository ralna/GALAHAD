...
.. list-table::
	...
	*
		...
		- is a structure containing control information (see :ref:`trek_control_type <doxid-structtrek__control__type>`)
...
\$GALAHAD/src/trek/TREK.template.  See also Table 2.1 in the Fortran
documentation provided in \$GALAHAD/doc/trek.pdf for a list of how these
...
.. list-table::
	...
	*
		...
		- is a structure whose members provide control parameters for the remaining procedures (see :ref:`trek_control_type <doxid-structtrek__control__type>`)
...
.. index:: pair: function; trek_import_m
		...
		- is a scalar variable of type INT that gives the
		  ...
		  * **-18**
                  ...
                  * **-31** 
                    ...
                    control.new_radius and control.new_values).
...
.. list-table::
	...
	*
		...
		- is a structure containing output information (see :ref:`trek_inform_type <doxid-structtrek__inform__type>`)
