...
void spral_ssids_default_control_s(struct ssids_control_type_s *control);
void spral_ssids_default_control_s_64(struct ssids_control_type_s_64 *control);
void spral_ssids_analyse_s(bool check, int32_t n, int32_t *order, int64_t *ptr, int32_t *row, float *val, void **akeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_analyse_s_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, float *val, void **akeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
void spral_ssids_analyse_ptr32_s(bool check, int32_t n, int32_t *order, int32_t *ptr, int32_t *row, float *val, void **akeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_analyse_ptr32_s_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, float *val, void **akeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
void spral_ssids_analyse_coord_s(int32_t n, int32_t *order, int64_t ne, int32_t *row, int32_t *col, float *val, void **akeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_analyse_coord_s_64(int64_t n, int64_t *order, int64_t ne, int64_t *row, int64_t *col, float *val, void **akeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
void spral_ssids_factor_s(bool posdef, int64_t *ptr, int32_t *row, float *val, float *scale, void *akeep, void **fkeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_factor_s_64(bool posdef, int64_t *ptr, int64_t *row, float *val, float *scale, void *akeep, void **fkeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
void spral_ssids_factor_ptr32_s(bool posdef, int32_t *ptr, int32_t *row, float *val, float *scale, void *akeep, void **fkeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_factor_ptr32_s_64(bool posdef, int64_t *ptr, int64_t *row, float *val, float *scale, void *akeep, void **fkeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
void spral_ssids_solve1_s(int32_t job, float *x1, void *akeep, void *fkeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_solve1_s_64(int64_t job, float *x1, void *akeep, void *fkeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
void spral_ssids_solve_s(int32_t job, int32_t nrhs, float *x, int32_t ldx, void *akeep, void *fkeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_solve_s_64(int64_t job, int64_t nrhs, float *x, int64_t ldx, void *akeep, void *fkeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
...
void spral_ssids_enquire_posdef_s(void *akeep, void *fkeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform, float *d);
void spral_ssids_enquire_posdef_s_64(void *akeep, void *fkeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform, float *d);
void spral_ssids_enquire_indef_s(void *akeep, void *fkeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform, int32_t *piv_order, float *d);
void spral_ssids_enquire_indef_s_64(void *akeep, void *fkeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform, int64_t *piv_order, float *d);
void spral_ssids_alter_s(float *d, void *akeep, void *fkeep, struct ssids_control_type_s *control, struct ssids_inform_type_s *inform);
void spral_ssids_alter_s_64(float *d, void *akeep, void *fkeep, struct ssids_control_type_s_64 *control, struct ssids_inform_type_s_64 *inform);
