...
void ssids_default_control_s(control::Ptr{ssids_control_type});
void ssids_default_control_s_64(control::Ptr{ssids_control_type});
void ssids_analyse_s(bool check, int32_t n, int32_t *order, int64_t *ptr, int32_t *row, float *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_s_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, float *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_ptr32_s(bool check, int32_t n, int32_t *order, int32_t *ptr, int32_t *row, float *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_ptr32_s_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, float *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_coord_s(int32_t n, int32_t *order, int64_t ne, int32_t *row, int32_t *col, float *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_coord_s_64(int64_t n, int64_t *order, int64_t ne, int64_t *row, int64_t *col, float *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor_s(bool posdef, int64_t *ptr, int32_t *row, float *val, float *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor_s_64(bool posdef, int64_t *ptr, int64_t *row, float *val, float *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor_ptr32_s(bool posdef, int32_t *ptr, int32_t *row, float *val, float *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor_ptr32_s_64(bool posdef, int64_t *ptr, int64_t *row, float *val, float *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve1_s(int32_t job, float *x1, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve1_s_64(int64_t job, float *x1, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve_s(int32_t job, int32_t nrhs, float *x, int32_t ldx, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve_s_64(int64_t job, int64_t nrhs, float *x, int64_t ldx, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
...
void ssids_enquire_posdef_s(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, float *d);
void ssids_enquire_posdef_s_64(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, float *d);
void ssids_enquire_indef_s(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, int32_t *piv_order, float *d);
void ssids_enquire_indef_s_64(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, int64_t *piv_order, float *d);
void ssids_alter_s(float *d, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_alter_s_64(float *d, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
