 ...
 *
 * tru_solve_with_h, a trust-region method for finding a local minimizer of a
 ...
 *
 * tru_solve_without_h, a trust-region method for finding a local minimizer of
 ...
 *
 * tru_solve_reverse_with_h, a trust-region method for finding a local minimizer
 ...
 *
 * tru_solve_reverse_without_h, a trust-region method for finding a local 
 *   minimizer of a given function where the variables are constrained to 
 *   lie in a "box"
 *
 *   This call is for the case where access to H is provided by Hessian-vector
