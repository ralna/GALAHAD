 ...
 *
 *  History -
 *   originally released GALAHAD Version 4.0. June 13th 2023
 *
...
\endmanonly
  ...
  this is not the case, the GALAHAD package \c LSRT may be preferred.

  \subsection llsr_authors Authors

  N. I. M. Gould, STFC-Rutherford Appleton Laboratory, England.

  C interface, additionally J. Fowkes, STFC-Rutherford Appleton Laboratory.

  \subsection llsr_date Originally released
...
\endmanonly
  ...
  \subsection llsr_call_order Call order

  To solve a given problem, functions from the llsr package must be called
  in the following order:

  - \link llsr_initialize \endlink - provide default control parameters and
      set up initial data structures
  - \link llsr_read_specfile \endlink (optional) - override control values
  ...
  - \link llsr_solve_problem \endlink - solve the regularization problem
  - \link llsr_information \endlink (optional) - recover information about
    the solution and solution process
  - \link llsr_terminate \endlink - deallocate data structures
...
void llsr_import( struct llsr_control_type *control,
                 void **data,
                 ipc_ *status,
                 ipc_ m,
                 ipc_ n,
...
void llsr_import_scaling( struct llsr_control_type *control,
                          void **data,
                          ipc_ *status,
                          ipc_ n,
                          const char S_type[],
...
void llsr_reset_control( struct llsr_control_type *control,
                         void **data,
                         ipc_ *status );
...
void llsr_solve_problem( void **data,
                         ipc_ *status,
                         ipc_ m,
                         ipc_ n,
                         const rpc_ power,
...
/*!<
 ...
 @param[in] power is a scalar of type rpc_, that
    holds the regularization power, \f$p\f$, used. power must be
    greater than or equal to two.

 @param[in] weight is a scalar of type rpc_, that
    holds the regularization power, \f$\sigma\f$, used. weight must be
    strictly positive
...
void llsr_information( void **data,
