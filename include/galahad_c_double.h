...
void ssids_default_control(control::Ptr{ssids_control_type});
void ssids_default_control_64(control::Ptr{ssids_control_type});
void ssids_analyse(bool check, int32_t n, int32_t *order, int64_t *ptr, int32_t *row, double *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, double *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_ptr32(bool check, int32_t n, int32_t *order, int32_t *ptr, int32_t *row, double *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_ptr32_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, double *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_coord(int32_t n, int32_t *order, int64_t ne, int32_t *row, int32_t *col, double *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_analyse_coord_64(int64_t n, int64_t *order, int64_t ne, int64_t *row, int64_t *col, double *val, void **akeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor(bool posdef, int64_t *ptr, int32_t *row, double *val, double *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor_64(bool posdef, int64_t *ptr, int64_t *row, double *val, double *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor_ptr32(bool posdef, int32_t *ptr, int32_t *row, double *val, double *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_factor_ptr32_64(bool posdef, int64_t *ptr, int64_t *row, double *val, double *scale, void *akeep, void **fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve1(int32_t job, double *x1, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve1_64(int64_t job, double *x1, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve(int32_t job, int32_t nrhs, double *x, int32_t ldx, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_solve_64(int64_t job, int64_t nrhs, double *x, int64_t ldx, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
...
void ssids_enquire_posdef(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, double *d);
void ssids_enquire_posdef_64(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, double *d);
void ssids_enquire_indef(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, int32_t *piv_order, double *d);
void ssids_enquire_indef_64(void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type}, int64_t *piv_order, double *d);
void ssids_alter(double *d, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
void ssids_alter_64(double *d, void *akeep, void *fkeep, control::Ptr{ssids_control_type}, inform::Ptr{ssids_inform_type});
