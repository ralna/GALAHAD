...
/*! \mainpage GALAHAD C package clls

  \section clls_intro Introduction

  \subsection clls_purpose Purpose
...
\endmanonly
  ...
  \subsection clls_references Reference
  ...
  - \link clls_initialize \endlink - provide default control parameters and
      set up initial data structures
  - \link clls_read_specfile \endlink (optional) - override control values
      by reading replacement values from a file
  - \link clls_import \endlink - set up problem data structures and fixed
      values
...
// include guard
#ifndef GALAHAD_CLLS_H
#define GALAHAD_CLLS_H
...
/*!<
  ...
  By default, the spcification file will be named RUNCLLS.SPC and
  lie in the current directory.
  Refer to Table 2.1 in the fortran documentation provided in
  $GALAHAD/doc/clls.pdf for a list of keywords that may be set.
...
/*!<
 ...
 @param[in] control is a struct whose members provide control
  paramters for the remaining prcedures (see clls_control_type)
 ...
 @param[in]  A_ptr_ne is a scalar variable of type ipc_, that holds the
