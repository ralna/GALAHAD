...
/*
 * THIS VERSION: GALAHAD 4.1 - 2022-05-18 AT 09:00 GMT.
 *
 *-*-*-*-*-*-*-*-*-  GALAHAD_CCQP C INTERFACE  *-*-*-*-*-*-*-*-*-*-
 *
...
/*! \mainpage GALAHAD C package ccqp

  \section ccqp_intro Introduction

  \subsection ccqp_purpose Purpose
...
\endmanonly
  ...
  \subsection ccqp_authors Authors
  ...
  \subsection ccqp_date Originally released

  November 2010, C interface September 2021.

  \subsection ccqp_terminology Terminology
...
\endmanonly
  ...
  \subsection ccqp_references Reference
  ...
  \subsection ccqp_call_order Call order
  To solve a given problem, functions from the ccqp package must be called
  in the following order:

  - \link ccqp_initialize \endlink - provide default control parameters and
      set up initial data structures
  - \link ccqp_read_specfile \endlink (optional) - override control values
      by reading replacement values from a file
  - \link ccqp_import \endlink - set up problem data structures and fixed
      values
  - \link ccqp_reset_control \endlink (optional) - possibly change control
      parameters if a sequence of problems are being solved
  - solve the problem by calling one of
     - \link ccqp_solve_qp \endlink - solve the quadratic program
     - \link ccqp_solve_sldqp \endlink - solve the shifted least-distance problem
  - \link ccqp_information \endlink (optional) - recover information about
    the solution and solution process
  - \link ccqp_terminate \endlink - deallocate data structures
...
// include guard
#ifndef GALAHAD_CCQP_H
#define GALAHAD_CCQP_H
...
void ccqp_initialize( void **data,
...
void ccqp_read_specfile( struct ccqp_control_type *control,
                         const char specfile[] );

/*!<
  Read the content of a specification file, and assign values associated
  with given keywords to the corresponding control parameters.
  By default, the spcification file will be named RUNCCQP.SPC and
  lie in the current directory.
  Refer to Table 2.1 in the fortran documentation provided in
  $GALAHAD/doc/ccqp.pdf for a list of keywords that may be set.
...
void ccqp_import( struct ccqp_control_type *control,
                  void **data,
                  int *status,
                  int n,
                  int m,
...
/*!<
 ...
 @param[in] control is a struct whose members provide control
  paramters for the remaining prcedures (see ccqp_control_type)
...
void ccqp_reset_control( struct ccqp_control_type *control,
                         void **data,
                         int *status );
...
void ccqp_solve_sldqp( void **data,
                       int *status,
                       int n,
                       int m,
                       const real_wp_ w[],
...
void ccqp_information( void **data,
