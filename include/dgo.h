/*
 * THIS VERSION: GALAHAD 3.3 - 10/08/2021 AT 16:00 GMT.
 *
 ...
 *
 * dgo_solve_without_mat, a stochastic multistart method that aims to find
 *   the global minimizer of a given function where the variables are 
 *   constrained to lie in a "box"
 *
 ...
 *
 * dgo_solve_reverse_with_mat, a stochastic multistart method that aims to find
 *   the global minimizer of a given function where the variables are 
 *   constrained to lie in a "box"
 *
 ...
 *
 * dgo_solve_reverse_without_mat, a stochastic multistart method that aims to
 ...
 *
 * dgo_information fills the output information structure inform 
 * (see dgo_inform_type above)
 */
