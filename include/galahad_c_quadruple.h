...
struct spral_ssids_options_q_64 {
    int64_t array_base;
    int64_t print_level;
    int64_t unit_diagnostics;
    int64_t unit_error;
...
struct spral_ssids_inform_q_64 {
    int64_t flag;
    int64_t matrix_dup;
    int64_t matrix_missing_diag;
    int64_t matrix_outrange;
...
struct sls_inform_type_q {
    ...
    struct spral_ssids_inform_q ssids_inform;
    struct nodend_inform_type_q nodend_inform;
...
struct sls_inform_type_q_64 {
    ...
    struct spral_ssids_inform_q_64 ssids_inform;
    struct nodend_inform_type_q_64 nodend_inform;
