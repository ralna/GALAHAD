...
// Callbacks
typedef int32_t galahad_f_q(int32_t n, const _Float128 x[], _Float128 *f, const void *userdata);
typedef int32_t galahad_g_q(int32_t n, const _Float128 x[], _Float128 g[], const void *userdata);
typedef int32_t galahad_h_q(int32_t n, int32_t ne, const _Float128 x[], _Float128 h[], const void *userdata);
typedef int32_t galahad_prec_q(int32_t n, const _Float128 x[], _Float128 u[], const _Float128 v[], const void *userdata);
typedef int32_t galahad_hprod_q(int32_t n, const _Float128 x[], _Float128 u[], const _Float128 v[], bool got_h, const void *userdata);
typedef int32_t galahad_shprod_q(int32_t n, const _Float128 x[], int32_t nnz_v, const int32_t index_nz_v[], const _Float128 v[], int32_t *nnz_u, int32_t index_nz_u[], _Float128 u[], bool got_h, const void *userdata);
typedef int32_t galahad_constant_prec_q(int32_t n, const _Float128 v[], _Float128 p[], const void *userdata);
typedef int32_t galahad_r_q(int32_t n, int32_t m, const _Float128 x[], _Float128 r[], const void *userdata);
typedef int32_t galahad_jr_q(int32_t n, int32_t m, int32_t jne, const _Float128 x[], _Float128 jr[], const void *userdata);
typedef int32_t galahad_hr_q(int32_t n, int32_t m, int32_t hne, const _Float128 x[], const _Float128 y[], _Float128 hr[], const void *userdata);
typedef int32_t galahad_jrprod_q(int32_t n, int32_t m, const _Float128 x[], const bool transpose, _Float128 u[], const _Float128 v[], bool got_j, const void *userdata);
typedef int32_t galahad_hrprod_q(int32_t n, int32_t m, const _Float128 x[], const _Float128 y[], _Float128 u[], const _Float128 v[], bool got_h, const void *userdata);
typedef int32_t galahad_shrprod_q(int32_t n, int32_t m, int32_t pne, const _Float128 x[], const _Float128 v[], _Float128 pval[], bool got_h, const void *userdata);
typedef int32_t galahad_fc_q(int32_t n, int32_t m, const _Float128 x[], _Float128 *f, _Float128 c[], const void *userdata);
typedef int32_t galahad_gj_q(int32_t n, int32_t m, int32_t jne, const _Float128 x[], _Float128 g[], _Float128 j[], const void *userdata);
typedef int32_t galahad_hl_q(int32_t n, int32_t m, int32_t hne, const _Float128 x[], const _Float128 y[], _Float128 h[], const void *userdata);
typedef int32_t galahad_fgh_q(_Float128 x, _Float128 *f, _Float128 *g, _Float128 *h, const void *userdata);

typedef int64_t galahad_f_q_64(int64_t n, const _Float128 x[], _Float128 *f, const void *userdata);
typedef int64_t galahad_g_q_64(int64_t n, const _Float128 x[], _Float128 g[], const void *userdata);
typedef int64_t galahad_h_q_64(int64_t n, int64_t ne, const _Float128 x[], _Float128 h[], const void *userdata);
typedef int64_t galahad_prec_q_64(int64_t n, const _Float128 x[], _Float128 u[], const _Float128 v[], const void *userdata);
typedef int64_t galahad_hprod_q_64(int64_t n, const _Float128 x[], _Float128 u[], const _Float128 v[], bool got_h, const void *userdata);
typedef int64_t galahad_shprod_q_64(int64_t n, const _Float128 x[], int64_t nnz_v, const int64_t index_nz_v[], const _Float128 v[], int64_t *nnz_u, int64_t index_nz_u[], _Float128 u[], bool got_h, const void *userdata);
typedef int64_t galahad_constant_prec_q_64(int64_t n, const _Float128 v[], _Float128 p[], const void *userdata);
typedef int64_t galahad_r_q_64(int64_t n, int64_t m, const _Float128 x[], _Float128 r[], const void *userdata);
typedef int64_t galahad_jr_q_64(int64_t n, int64_t m, int64_t jne, const _Float128 x[], _Float128 jr[], const void *userdata);
typedef int64_t galahad_hr_q_64(int64_t n, int64_t m, int64_t hne, const _Float128 x[], const _Float128 y[], _Float128 hr[], const void *userdata);
typedef int64_t galahad_jrprod_q_64(int64_t n, int64_t m, const _Float128 x[], const bool transpose, _Float128 u[], const _Float128 v[], bool got_j, const void *userdata);
typedef int64_t galahad_hrprod_q_64(int64_t n, int64_t m, const _Float128 x[], const _Float128 y[], _Float128 u[], const _Float128 v[], bool got_h, const void *userdata);
typedef int64_t galahad_shrprod_q_64(int64_t n, int64_t m, int64_t pne, const _Float128 x[], const _Float128 v[], _Float128 pval[], bool got_h, const void *userdata);
typedef int64_t galahad_fc_q_64(int64_t n, int64_t m, const _Float128 x[], _Float128 *f, _Float128 c[], const void *userdata);
typedef int64_t galahad_gj_q_64(int64_t n, int64_t m, int64_t jne, const _Float128 x[], _Float128 g[], _Float128 j[], const void *userdata);
typedef int64_t galahad_hl_q_64(int64_t n, int64_t m, int64_t hne, const _Float128 x[], const _Float128 y[], _Float128 h[], const void *userdata);
typedef int64_t galahad_fgh_q_64(_Float128 x, _Float128 *f, _Float128 *g, _Float128 *h, const void *userdata);
...
void bsc_form_s_q(void **data, int32_t *status, int32_t m, int32_t n, int32_t a_ne, _Float128 *A_val, int32_t s_ne, int32_t *S_row, int32_t *S_col, int32_t *S_ptr, _Float128 *S_val, _Float128 *D);
void bsc_form_s_q_64(void **data, int64_t *status, int64_t m, int64_t n, int64_t a_ne, _Float128 *A_val, int64_t s_ne, int64_t *S_row, int64_t *S_col, int64_t *S_ptr, _Float128 *S_val, _Float128 *D);
...
struct glrt_control_type_q {
    ...
    _Float128 stop_relative;
    _Float128 stop_absolute;
    _Float128 fraction_opt;
    _Float128 rminvr_zero;
    _Float128 f_0;
    bool unitm;
    bool impose_descent;
    bool space_critical;
...
struct glrt_inform_type_q {
    ...
    int32_t iter_pass2;
    _Float128 obj;
    _Float128 obj_regularized;
    _Float128 multiplier;
    _Float128 xpo_norm;
    _Float128 leftmost;
...
void glrt_solve_problem_q(void **data, int32_t *status, int32_t n, _Float128 power, _Float128 weight, _Float128 *x, _Float128 *r, _Float128 *vector);
void glrt_solve_problem_q_64(void **data, int64_t *status, int64_t n, _Float128 power, _Float128 weight, _Float128 *x, _Float128 *r, _Float128 *vector);
...
void gltr_solve_problem_q(void **data, int32_t *status, int32_t n, _Float128 radius, _Float128 *x, _Float128 *r, _Float128 *vector);
void gltr_solve_problem_q_64(void **data, int64_t *status, int64_t n, _Float128 radius, _Float128 *x, _Float128 *r, _Float128 *vector);
...
struct ma57_control_q {
    ...
    _Float128 reduce;
    _Float128 u;
    _Float128 static_tolerance;
    _Float128 static_level;
    _Float128 tolerance;
    _Float128 convergence;
    _Float128 consist;
    int32_t lp;
    int32_t wp;
    int32_t mp;
...
struct ma87_control_q {
    ...
    int32_t nb;
    int32_t pool_size;
    _Float128 diag_zero_minus;
    _Float128 diag_zero_plus;
    char unused[40];
};
...
struct mi20_control_q {
    ...
    _Float128 reduction;
    int32_t st_method;
    _Float128 st_parameter;
    int32_t testing;
    _Float128 trunc_parameter;
...
struct mi28_control_q {
    ...
    int32_t maxshift;
    bool rrt;
    _Float128 shift_factor;
    _Float128 shift_factor2;
    _Float128 small;
    _Float128 tau1;
    _Float128 tau2;
    int32_t unit_error;
...
struct mi28_info_q {
    ...
    int32_t nshift;
    int32_t oor;
    _Float128 profile_before;
    _Float128 profile_after;
    int64_t size_r;
    int32_t stat;
    _Float128 alpha;
};
...
struct ir_control_type_q {
    ...
    int32_t print_level;
    int32_t itref_max;
    _Float128 acceptable_residual_relative;
    _Float128 acceptable_residual_absolute;
    _Float128 required_residual_relative;
...
struct ir_inform_type_q {
    ...
    int32_t alloc_status;
    char bad_alloc[81];
    _Float128 norm_initial_residual;
    _Float128 norm_final_residual;
};
...
void l2rt_solve_problem_q(void **data, int32_t *status, int32_t m, int32_t n, _Float128 power, _Float128 weight, _Float128 shift, _Float128 *x, _Float128 *u, _Float128 *v);
void l2rt_solve_problem_q_64(void **data, int64_t *status, int64_t m, int64_t n, _Float128 power, _Float128 weight, _Float128 shift, _Float128 *x, _Float128 *u, _Float128 *v);
...
struct lms_time_type_q {
    ...
    _Float128 apply;
    _Float128 clock_total;
    _Float128 clock_setup;
    _Float128 clock_form;
    _Float128 clock_apply;
};
...
void lsrt_solve_problem_q(void **data, int32_t *status, int32_t m, int32_t n, _Float128 power, _Float128 weight, _Float128 *x, _Float128 *u, _Float128 *v);
void lsrt_solve_problem_q_64(void **data, int64_t *status, int64_t m, int64_t n, _Float128 power, _Float128 weight, _Float128 *x, _Float128 *u, _Float128 *v);
...
void lstr_solve_problem_q(void **data, int32_t *status, int32_t m, int32_t n, _Float128 radius, _Float128 *x, _Float128 *u, _Float128 *v);
void lstr_solve_problem_q_64(void **data, int64_t *status, int64_t m, int64_t n, _Float128 radius, _Float128 *x, _Float128 *u, _Float128 *v);
...
struct presolve_control_type_q {
    ...
    _Float128 c_accuracy;
    _Float128 z_accuracy;
    _Float128 infinity;
    int32_t out;
    int32_t errout;
    int32_t print_level;
    ...
    _Float128 pivot_tol;
    _Float128 min_rel_improve;
    _Float128 max_growth_factor;
};
...
void presolve_import_problem_q(struct presolve_control_type_q *control, void **data, int32_t *status, int32_t n, int32_t m, char *H_type, int32_t H_ne, int32_t *H_row, int32_t *H_col, int32_t *H_ptr, _Float128 *H_val, _Float128 *g, _Float128 f, char *A_type, int32_t A_ne, int32_t *A_row, int32_t *A_col, int32_t *A_ptr, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, int32_t *n_out, int32_t *m_out, int32_t *H_ne_out, int32_t *A_ne_out);
void presolve_import_problem_q_64(struct presolve_control_type_q_64 *control, void **data, int64_t *status, int64_t n, int64_t m, char *H_type, int64_t H_ne, int64_t *H_row, int64_t *H_col, int64_t *H_ptr, _Float128 *H_val, _Float128 *g, _Float128 f, char *A_type, int64_t A_ne, int64_t *A_row, int64_t *A_col, int64_t *A_ptr, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, int64_t *n_out, int64_t *m_out, int64_t *H_ne_out, int64_t *A_ne_out);
void presolve_transform_problem_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t H_ne, int32_t *H_col, int32_t *H_ptr, _Float128 *H_val, _Float128 *g, _Float128 *f, int32_t A_ne, int32_t *A_col, int32_t *A_ptr, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *y_l, _Float128 *y_u, _Float128 *z_l, _Float128 *z_u);
void presolve_transform_problem_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t H_ne, int64_t *H_col, int64_t *H_ptr, _Float128 *H_val, _Float128 *g, _Float128 *f, int64_t A_ne, int64_t *A_col, int64_t *A_ptr, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *y_l, _Float128 *y_u, _Float128 *z_l, _Float128 *z_u);
void presolve_restore_solution_q(void **data, int32_t *status, int32_t n_in, int32_t m_in, _Float128 *x_in, _Float128 *c_in, _Float128 *y_in, _Float128 *z_in, int32_t n, int32_t m, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z);
void presolve_restore_solution_q_64(void **data, int64_t *status, int64_t n_in, int64_t m_in, _Float128 *x_in, _Float128 *c_in, _Float128 *y_in, _Float128 *z_in, int64_t n, int64_t m, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z);
...
void rpd_get_g_q(void **data, int32_t *status, int32_t n, _Float128 *g);
void rpd_get_g_q_64(void **data, int64_t *status, int64_t n, _Float128 *g);
void rpd_get_f_q(void **data, int32_t *status, _Float128 *f);
void rpd_get_f_q_64(void **data, int64_t *status, _Float128 *f);
void rpd_get_xlu_q(void **data, int32_t *status, int32_t n, _Float128 *x_l, _Float128 *x_u);
void rpd_get_xlu_q_64(void **data, int64_t *status, int64_t n, _Float128 *x_l, _Float128 *x_u);
void rpd_get_clu_q(void **data, int32_t *status, int32_t m, _Float128 *c_l, _Float128 *c_u);
void rpd_get_clu_q_64(void **data, int64_t *status, int64_t m, _Float128 *c_l, _Float128 *c_u);
void rpd_get_h_q(void **data, int32_t *status, int32_t h_ne, int32_t *h_row, int32_t *h_col, _Float128 *h_val);
void rpd_get_h_q_64(void **data, int64_t *status, int64_t h_ne, int64_t *h_row, int64_t *h_col, _Float128 *h_val);
void rpd_get_a_q(void **data, int32_t *status, int32_t a_ne, int32_t *a_row, int32_t *a_col, _Float128 *a_val);
void rpd_get_a_q_64(void **data, int64_t *status, int64_t a_ne, int64_t *a_row, int64_t *a_col, _Float128 *a_val);
void rpd_get_h_c_q(void **data, int32_t *status, int32_t h_c_ne, int32_t *h_c_ptr, int32_t *h_c_row, int32_t *h_c_col, _Float128 *h_c_val);
void rpd_get_h_c_q_64(void **data, int64_t *status, int64_t h_c_ne, int64_t *h_c_ptr, int64_t *h_c_row, int64_t *h_c_col, _Float128 *h_c_val);
...
void rpd_get_x_q(void **data, int32_t *status, int32_t n, _Float128 *x);
void rpd_get_x_q_64(void **data, int64_t *status, int64_t n, _Float128 *x);
void rpd_get_y_q(void **data, int32_t *status, int32_t m, _Float128 *y);
void rpd_get_y_q_64(void **data, int64_t *status, int64_t m, _Float128 *y);
void rpd_get_z_q(void **data, int32_t *status, int32_t n, _Float128 *z);
void rpd_get_z_q_64(void **data, int64_t *status, int64_t n, _Float128 *z);
...
struct sha_inform_type_q {
    ...
    int32_t bad_row;
    _Float128 max_off_diagonal_difference;
    char bad_alloc[81];
};
...
void sha_recover_matrix_q(void **data, int32_t *status, int32_t ne, int32_t m, int32_t ls1, int32_t ls2, _Float128 **strans, int32_t ly1, int32_t ly2, _Float128 **ytrans, _Float128 *val, int32_t *precedence);
void sha_recover_matrix_q_64(void **data, int64_t *status, int64_t ne, int64_t m, int64_t ls1, int64_t ls2, _Float128 **strans, int64_t ly1, int64_t ly2, _Float128 **ytrans, _Float128 *val, int64_t *precedence);
...
struct ugo_control_type_q {
    ...
    int32_t alive_unit;
    char alive_file[31];
    _Float128 stop_length;
    _Float128 small_g_for_newton;
    _Float128 small_g;
    _Float128 obj_sufficient;
    _Float128 global_lipschitz_constant;
    _Float128 reliability_parameter;
    _Float128 lipschitz_lower_bound;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
...
void ugo_import_q(struct ugo_control_type_q *control, void **data, int32_t *status, _Float128 *x_l, _Float128 *x_u);
void ugo_import_q_64(struct ugo_control_type_q_64 *control, void **data, int64_t *status, _Float128 *x_l, _Float128 *x_u);
...
void ugo_solve_direct_q(void **data, void *userdata, int32_t *status, _Float128 *x, _Float128 *f, _Float128 *g, _Float128 *h, galahad_fgh_q *eval_fgh);
void ugo_solve_direct_q_64(void **data, void *userdata, int64_t *status, _Float128 *x, _Float128 *f, _Float128 *g, _Float128 *h, galahad_fgh_q_64 *eval_fgh);
void ugo_solve_reverse_q(void **data, int32_t *status, int32_t *eval_status, _Float128 *x, _Float128 *f, _Float128 *g, _Float128 *h);
void ugo_solve_reverse_q_64(void **data, int64_t *status, int64_t *eval_status, _Float128 *x, _Float128 *f, _Float128 *g, _Float128 *h);
...
void ssids_analyse_q(bool check, int32_t n, int32_t *order, int64_t *ptr, int32_t *row, _Float128 *val, void **akeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_analyse_q_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, _Float128 *val, void **akeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
void ssids_analyse_ptr32_q(bool check, int32_t n, int32_t *order, int32_t *ptr, int32_t *row, _Float128 *val, void **akeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_analyse_ptr32_q_64(bool check, int64_t n, int64_t *order, int64_t *ptr, int64_t *row, _Float128 *val, void **akeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
void ssids_analyse_coord_q(int32_t n, int32_t *order, int64_t ne, int32_t *row, int32_t *col, _Float128 *val, void **akeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_analyse_coord_q_64(int64_t n, int64_t *order, int64_t ne, int64_t *row, int64_t *col, _Float128 *val, void **akeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
void ssids_factor_q(bool posdef, int64_t *ptr, int32_t *row, _Float128 *val, _Float128 *scale, void *akeep, void **fkeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_factor_q_64(bool posdef, int64_t *ptr, int64_t *row, _Float128 *val, _Float128 *scale, void *akeep, void **fkeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
void ssids_factor_ptr32_q(bool posdef, int32_t *ptr, int32_t *row, _Float128 *val, _Float128 *scale, void *akeep, void **fkeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_factor_ptr32_q_64(bool posdef, int64_t *ptr, int64_t *row, _Float128 *val, _Float128 *scale, void *akeep, void **fkeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
void ssids_solve1_q(int32_t job, _Float128 *x1, void *akeep, void *fkeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_solve1_q_64(int64_t job, _Float128 *x1, void *akeep, void *fkeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
void ssids_solve_q(int32_t job, int32_t nrhs, _Float128 *x, int32_t ldx, void *akeep, void *fkeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_solve_q_64(int64_t job, int64_t nrhs, _Float128 *x, int64_t ldx, void *akeep, void *fkeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
...
void ssids_enquire_posdef_q(void *akeep, void *fkeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform, _Float128 *d);
void ssids_enquire_posdef_q_64(void *akeep, void *fkeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform, _Float128 *d);
void ssids_enquire_indef_q(void *akeep, void *fkeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform, int32_t *piv_order, _Float128 *d);
void ssids_enquire_indef_q_64(void *akeep, void *fkeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform, int64_t *piv_order, _Float128 *d);
void ssids_alter_q(_Float128 *d, void *akeep, void *fkeep, struct ssids_control_type_q *control, struct ssids_inform_type_q *inform);
void ssids_alter_q_64(_Float128 *d, void *akeep, void *fkeep, struct ssids_control_type_q_64 *control, struct ssids_inform_type_q_64 *inform);
...
struct sls_control_type_q {
    ...
    _Float128 array_increase_factor;
    _Float128 array_decrease_factor;
    ...
    int32_t scaling;
    int32_t scale_maxit;
    _Float128 scale_thresh;
    _Float128 relative_pivot_tolerance;
    _Float128 minimum_pivot_tolerance;
    _Float128 absolute_pivot_tolerance;
    _Float128 zero_tolerance;
    _Float128 zero_pivot_tolerance;
    _Float128 negative_pivot_tolerance;
    _Float128 static_pivot_tolerance;
    _Float128 static_level_switch;
    _Float128 consistency_tolerance;
...
struct sls_time_type_q {
    ...
    _Float128 factorize;
    _Float128 solve;
    _Float128 order_external;
    _Float128 analyse_external;
    _Float128 factorize_external;
    _Float128 solve_external;
    _Float128 clock_total;
    _Float128 clock_analyse;
    _Float128 clock_factorize;
    _Float128 clock_solve;
    _Float128 clock_order_external;
    _Float128 clock_analyse_external;
    _Float128 clock_factorize_external;
    _Float128 clock_solve_external;
};
...
struct sls_inform_type_q {
    ...
    int64_t flops_blas;
    _Float128 largest_modified_pivot;
    _Float128 minimum_scaling_factor;
    _Float128 maximum_scaling_factor;
    _Float128 condition_number_1;
    _Float128 condition_number_2;
    _Float128 backward_error_1;
    _Float128 backward_error_2;
    _Float128 forward_error;
    bool alternative;
    char solver[21];
...
void sls_factorize_matrix_q(void **data, int32_t *status, int32_t ne, _Float128 *val);
void sls_factorize_matrix_q_64(void **data, int64_t *status, int64_t ne, _Float128 *val);
void sls_solve_system_q(void **data, int32_t *status, int32_t n, _Float128 *sol);
void sls_solve_system_q_64(void **data, int64_t *status, int64_t n, _Float128 *sol);
void sls_partial_solve_system_q(char *part, void **data, int32_t *status, int32_t n, _Float128 *sol);
void sls_partial_solve_system_q_64(char *part, void **data, int64_t *status, int64_t n, _Float128 *sol);
...
struct rqs_control_type_q {
    ...
    _Float128 initial_multiplier;
    _Float128 lower;
    _Float128 upper;
    _Float128 stop_normal;
    _Float128 stop_hard;
    _Float128 start_invit_tol;
    _Float128 start_invitmax_tol;
...
void rqs_solve_problem_q(void **data, int32_t *status, int32_t n, _Float128 power, _Float128 weight, _Float128 f, _Float128 *c, int32_t H_ne, _Float128 *H_val, _Float128 *x, int32_t M_ne, _Float128 *M_val, int32_t m, int32_t A_ne, _Float128 *A_val, _Float128 *y);
void rqs_solve_problem_q_64(void **data, int64_t *status, int64_t n, _Float128 power, _Float128 weight, _Float128 f, _Float128 *c, int64_t H_ne, _Float128 *H_val, _Float128 *x, int64_t M_ne, _Float128 *M_val, int64_t m, int64_t A_ne, _Float128 *A_val, _Float128 *y);
...
struct dps_control_type_q {
    ...
    _Float128 upper;
    _Float128 stop_normal;
    _Float128 stop_absolute_normal;
    bool goldfarb;
    bool space_critical;
    bool deallocate_error_fatal;
    char problem_file[31];
...
void dps_solve_tr_problem_q(void **data, int32_t *status, int32_t n, int32_t ne, _Float128 *H_val, _Float128 *c, _Float128 f, _Float128 radius, _Float128 *x);
void dps_solve_tr_problem_q_64(void **data, int64_t *status, int64_t n, int64_t ne, _Float128 *H_val, _Float128 *c, _Float128 f, _Float128 radius, _Float128 *x);
void dps_solve_rq_problem_q(void **data, int32_t *status, int32_t n, int32_t ne, _Float128 *H_val, _Float128 *c, _Float128 f, _Float128 power, _Float128 weight, _Float128 *x);
void dps_solve_rq_problem_q_64(void **data, int64_t *status, int64_t n, int64_t ne, _Float128 *H_val, _Float128 *c, _Float128 f, _Float128 power, _Float128 weight, _Float128 *x);
void dps_resolve_tr_problem_q(void **data, int32_t *status, int32_t n, _Float128 *c, _Float128 f, _Float128 radius, _Float128 *x);
void dps_resolve_tr_problem_q_64(void **data, int64_t *status, int64_t n, _Float128 *c, _Float128 f, _Float128 radius, _Float128 *x);
void dps_resolve_rq_problem_q(void **data, int32_t *status, int32_t n, _Float128 *c, _Float128 f, _Float128 power, _Float128 weight, _Float128 *x);
void dps_resolve_rq_problem_q_64(void **data, int64_t *status, int64_t n, _Float128 *c, _Float128 f, _Float128 power, _Float128 weight, _Float128 *x);
...
struct psls_inform_type_q {
    ...
    int32_t neg2;
    bool perturbed;
    _Float128 fill_in_ratio;
    _Float128 norm_residual;
    char bad_alloc[81];
    int32_t mc61_info[10];
    _Float128 mc61_rinfo[15];
...
void psls_form_preconditioner_q(void **data, int32_t *status, int32_t ne, _Float128 *val);
void psls_form_preconditioner_q_64(void **data, int64_t *status, int64_t ne, _Float128 *val);
void psls_form_subset_preconditioner_q(void **data, int32_t *status, int32_t ne, _Float128 *val, int32_t n_sub, int32_t *sub);
void psls_form_subset_preconditioner_q_64(void **data, int64_t *status, int64_t ne, _Float128 *val, int64_t n_sub, int64_t *sub);
void psls_update_preconditioner_q(void **data, int32_t *status, int32_t ne, _Float128 *val, int32_t n_del, int32_t *del);
void psls_update_preconditioner_q_64(void **data, int64_t *status, int64_t ne, _Float128 *val, int64_t n_del, int64_t *del);
void psls_apply_preconditioner_q(void **data, int32_t *status, int32_t n, _Float128 *sol);
void psls_apply_preconditioner_q_64(void **data, int64_t *status, int64_t n, _Float128 *sol);
...
struct arc_control_type_q {
    ...
    _Float128 stop_g_absolute;
    _Float128 stop_g_relative;
    _Float128 stop_s;
    _Float128 initial_weight;
    _Float128 minimum_weight;
    _Float128 reduce_gap;
    _Float128 tiny_gap;
    _Float128 large_root;
    _Float128 eta_successful;
    _Float128 eta_very_successful;
    _Float128 eta_too_successful;
    _Float128 weight_decrease_min;
    _Float128 weight_decrease;
    _Float128 weight_increase;
    _Float128 weight_increase_max;
    _Float128 obj_unbounded;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
...
struct arc_inform_type_q {
    ...
    int64_t factorization_integer;
    int64_t factorization_real;
    _Float128 factorization_average;
    _Float128 obj;
    _Float128 norm_g;
    _Float128 weight;
...
void arc_solve_with_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, int32_t ne, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_h_q *eval_h, galahad_prec_q *eval_prec);
void arc_solve_with_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, int64_t ne, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_h_q_64 *eval_h, galahad_prec_q_64 *eval_prec);
void arc_solve_without_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_hprod_q *eval_hprod, galahad_prec_q *eval_prec);
void arc_solve_without_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_hprod_q_64 *eval_hprod, galahad_prec_q_64 *eval_prec);
void arc_solve_reverse_with_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, int32_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void arc_solve_reverse_with_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, int64_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void arc_solve_reverse_without_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v);
void arc_solve_reverse_without_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v);
...
void trs_solve_problem_q(void **data, int32_t *status, int32_t n, _Float128 radius, _Float128 f, _Float128 *c, int32_t H_ne, _Float128 *H_val, _Float128 *x, int32_t M_ne, _Float128 *M_val, int32_t m, int32_t A_ne, _Float128 *A_val, _Float128 *y);
void trs_solve_problem_q_64(void **data, int64_t *status, int64_t n, _Float128 radius, _Float128 f, _Float128 *c, int64_t H_ne, _Float128 *H_val, _Float128 *x, int64_t M_ne, _Float128 *M_val, int64_t m, int64_t A_ne, _Float128 *A_val, _Float128 *y);
...
struct trb_control_type_q {
    ...
    int32_t advanced_start;
    _Float128 infinity;
    _Float128 stop_pg_absolute;
    _Float128 stop_pg_relative;
    _Float128 stop_s;
    _Float128 initial_radius;
    _Float128 maximum_radius;
    _Float128 stop_rel_cg;
    _Float128 eta_successful;
    _Float128 eta_very_successful;
    _Float128 eta_too_successful;
    _Float128 radius_increase;
    _Float128 radius_reduce;
    _Float128 radius_reduce_max;
    _Float128 obj_unbounded;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
    bool hessian_available;
...
void trb_solve_with_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *g, int32_t ne, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_h_q *eval_h, galahad_prec_q *eval_prec);
void trb_solve_with_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *g, int64_t ne, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_h_q_64 *eval_h, galahad_prec_q_64 *eval_prec);
void trb_solve_without_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *g, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_hprod_q *eval_hprod, galahad_shprod_q *eval_shprod, galahad_prec_q *eval_prec);
void trb_solve_without_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *g, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_hprod_q_64 *eval_hprod, galahad_shprod_q_64 *eval_shprod, galahad_prec_q_64 *eval_prec);
void trb_solve_reverse_with_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 f, _Float128 *g, int32_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void trb_solve_reverse_with_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 f, _Float128 *g, int64_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void trb_solve_reverse_without_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v, int32_t *index_nz_v, int32_t *nnz_v, int32_t *index_nz_u, int32_t nnz_u);
void trb_solve_reverse_without_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v, int64_t *index_nz_v, int64_t *nnz_v, int64_t *index_nz_u, int64_t nnz_u);
...
struct bgo_time_type_q {
    ...
    _Float128 clock_total;
    _Float128 clock_univariate_global;
    _Float128 clock_multivariate_local;
};
...
void bgo_import_q(struct bgo_control_type_q *control, void **data, int32_t *status, int32_t n, _Float128 *x_l, _Float128 *x_u, char *H_type, int32_t ne, int32_t *H_row, int32_t *H_col, int32_t *H_ptr);
void bgo_import_q_64(struct bgo_control_type_q_64 *control, void **data, int64_t *status, int64_t n, _Float128 *x_l, _Float128 *x_u, char *H_type, int64_t ne, int64_t *H_row, int64_t *H_col, int64_t *H_ptr);
...
void bgo_solve_with_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, int32_t ne, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_h_q *eval_h, galahad_hprod_q *eval_hprod, galahad_prec_q *eval_prec);
void bgo_solve_with_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, int64_t ne, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_h_q_64 *eval_h, galahad_hprod_q_64 *eval_hprod, galahad_prec_q_64 *eval_prec);
void bgo_solve_without_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_hprod_q *eval_hprod, galahad_shprod_q *eval_shprod, galahad_prec_q *eval_prec);
void bgo_solve_without_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_hprod_q_64 *eval_hprod, galahad_shprod_q_64 *eval_shprod, galahad_prec_q_64 *eval_prec);
void bgo_solve_reverse_with_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, int32_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void bgo_solve_reverse_with_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, int64_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void bgo_solve_reverse_without_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v, int32_t *index_nz_v, int32_t *nnz_v, int32_t *index_nz_u, int32_t nnz_u);
void bgo_solve_reverse_without_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v, int64_t *index_nz_v, int64_t *nnz_v, int64_t *index_nz_u, int64_t nnz_u);
...
struct uls_control_type_q {
    ...
    _Float128 array_increase_factor;
    _Float128 switch_to_full_code_density;
    _Float128 array_decrease_factor;
    _Float128 relative_pivot_tolerance;
    _Float128 absolute_pivot_tolerance;
    _Float128 zero_tolerance;
...
void uls_factorize_matrix_q(struct uls_control_type_q *control, void **data, int32_t *status, int32_t m, int32_t n, char *type, int32_t ne, _Float128 *val, int32_t *row, int32_t *col, int32_t *ptr);
void uls_factorize_matrix_q_64(struct uls_control_type_q_64 *control, void **data, int64_t *status, int64_t m, int64_t n, char *type, int64_t ne, _Float128 *val, int64_t *row, int64_t *col, int64_t *ptr);
...
void uls_solve_system_q(void **data, int32_t *status, int32_t m, int32_t n, _Float128 *sol, bool trans);
void uls_solve_system_q_64(void **data, int64_t *status, int64_t m, int64_t n, _Float128 *sol, bool trans);
...
struct sbls_control_type_q {
    ...
    int32_t ordering;
    _Float128 pivot_tol;
    _Float128 pivot_tol_for_basis;
    _Float128 zero_pivot;
    _Float128 static_tolerance;
    _Float128 static_level;
    _Float128 min_diagonal;
    _Float128 stop_absolute;
...
void sbls_factorize_matrix_q(void **data, int32_t *status, int32_t n, int32_t h_ne, _Float128 *H_val, int32_t a_ne, _Float128 *A_val, int32_t c_ne, _Float128 *C_val, _Float128 *D);
void sbls_factorize_matrix_q_64(void **data, int64_t *status, int64_t n, int64_t h_ne, _Float128 *H_val, int64_t a_ne, _Float128 *A_val, int64_t c_ne, _Float128 *C_val, _Float128 *D);
void sbls_solve_system_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *sol);
void sbls_solve_system_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *sol);
...
struct blls_control_type_q {
    ...
    _Float128 infinity;
    _Float128 stop_d;
    _Float128 identical_bounds_tol;
    _Float128 stop_cg_relative;
    _Float128 stop_cg_absolute;
    _Float128 alpha_max;
    _Float128 alpha_initial;
    _Float128 alpha_reduction;
    _Float128 arcsearch_acceptance_tol;
    _Float128 stabilisation_weight;
    _Float128 cpu_time_limit;
...
void blls_solve_given_a_q(void **data, void *userdata, int32_t *status, int32_t n, int32_t o, int32_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int32_t *x_stat, _Float128 *w, galahad_constant_prec_q *eval_prec);
void blls_solve_given_a_q_64(void **data, void *userdata, int64_t *status, int64_t n, int64_t o, int64_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int64_t *x_stat, _Float128 *w, galahad_constant_prec_q_64 *eval_prec);
void blls_solve_reverse_a_prod_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, int32_t o, _Float128 *b, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int32_t *x_stat, _Float128 *v, _Float128 *p, int32_t *nz_v, int32_t *nz_v_start, int32_t *nz_v_end, int32_t *nz_p, int32_t nz_p_end, _Float128 *w);
void blls_solve_reverse_a_prod_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, int64_t o, _Float128 *b, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int64_t *x_stat, _Float128 *v, _Float128 *p, int64_t *nz_v, int64_t *nz_v_start, int64_t *nz_v_end, int64_t *nz_p, int64_t nz_p_end, _Float128 *w);
...
void bqp_solve_given_h_q(void **data, int32_t *status, int32_t n, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int32_t *x_stat);
void bqp_solve_given_h_q_64(void **data, int64_t *status, int64_t n, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int64_t *x_stat);
void bqp_solve_reverse_h_prod_q(void **data, int32_t *status, int32_t n, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int32_t *x_stat, _Float128 *v, _Float128 *prod, int32_t *nz_v, int32_t *nz_v_start, int32_t *nz_v_end, int32_t *nz_prod, int32_t nz_prod_end);
void bqp_solve_reverse_h_prod_q_64(void **data, int64_t *status, int64_t n, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int64_t *x_stat, _Float128 *v, _Float128 *prod, int64_t *nz_v, int64_t *nz_v_start, int64_t *nz_v_end, int64_t *nz_prod, int64_t nz_prod_end);
...
struct fdc_inform_type_q {
    ...
    int64_t factorization_integer;
    int64_t factorization_real;
    _Float128 non_negligible_pivot;
...
void fdc_find_dependent_rows_q(struct fdc_control_type_q *control, void **data, struct fdc_inform_type_q *inform, int32_t *status, int32_t m, int32_t n, int32_t A_ne, int32_t *A_col, int32_t *A_ptr, _Float128 *A_val, _Float128 *b, int32_t *n_depen, int32_t *depen);
void fdc_find_dependent_rows_q_64(struct fdc_control_type_q_64 *control, void **data, struct fdc_inform_type_q_64 *inform, int64_t *status, int64_t m, int64_t n, int64_t A_ne, int64_t *A_col, int64_t *A_ptr, _Float128 *A_val, _Float128 *b, int64_t *n_depen, int64_t *depen);
...
struct cro_control_type_q {
    ...
    _Float128 infinity;
    _Float128 feasibility_tolerance;
    bool check_io;
...
void cro_crossover_solution_q(void **data, struct cro_control_type_q *control, struct cro_inform_type_q *inform, int32_t n, int32_t m, int32_t m_equal, int32_t h_ne, _Float128 *H_val, int32_t *H_col, int32_t *H_ptr, int32_t a_ne, _Float128 *A_val, int32_t *A_col, int32_t *A_ptr, _Float128 *g, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void cro_crossover_solution_q_64(void **data, struct cro_control_type_q_64 *control, struct cro_inform_type_q_64 *inform, int64_t n, int64_t m, int64_t m_equal, int64_t h_ne, _Float128 *H_val, int64_t *H_col, int64_t *H_ptr, int64_t a_ne, _Float128 *A_val, int64_t *A_col, int64_t *A_ptr, _Float128 *g, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
struct bqpb_control_type_q {
    ...
    _Float128 infinity;
    _Float128 stop_abs_p;
    _Float128 stop_rel_p;
    _Float128 stop_abs_d;
    _Float128 stop_rel_d;
    _Float128 stop_abs_c;
    _Float128 stop_rel_c;
    _Float128 perturb_h;
    _Float128 prfeas;
    _Float128 dufeas;
    _Float128 muzero;
    ...
    _Float128 gamma_c;
    _Float128 gamma_f;
    _Float128 reduce_infeas;
    _Float128 obj_unbounded;
    _Float128 potential_unbounded;
    _Float128 identical_bounds_tol;
    _Float128 mu_pounce;
    _Float128 indicator_tol_p;
    _Float128 indicator_tol_pd;
    _Float128 indicator_tol_tapia;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
    bool remove_dependencies;
...
struct bqpb_time_type_q {
    _Float128 total;
    _Float128 preprocess;
    _Float128 find_dependent;
    _Float128 analyse;
    _Float128 factorize;
    _Float128 solve;
    _Float128 clock_total;
    _Float128 clock_preprocess;
    _Float128 clock_find_dependent;
    _Float128 clock_analyse;
    _Float128 clock_factorize;
    _Float128 clock_solve;
};
...
struct bqpb_inform_type_q {
    ...
    int32_t threads;
    _Float128 obj;
    _Float128 primal_infeasibility;
    _Float128 dual_infeasibility;
    _Float128 complementary_slackness;
    _Float128 init_primal_infeasibility;
    _Float128 init_dual_infeasibility;
    _Float128 init_complementary_slackness;
    _Float128 potential;
    _Float128 non_negligible_pivot;
    bool feasible;
    int32_t checkpointsIter[16];
    _Float128 checkpointsTime[16];
...
void bqpb_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int32_t *x_stat);
void bqpb_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int64_t *x_stat);
void bqpb_solve_sldqp_q(void **data, int32_t *status, int32_t n, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int32_t *x_stat);
void bqpb_solve_sldqp_q_64(void **data, int64_t *status, int64_t n, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *z, int64_t *x_stat);
...
void ccqp_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void ccqp_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
void ccqp_solve_sldqp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void ccqp_solve_sldqp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
void cqp_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void cqp_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
void cqp_solve_sldqp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void cqp_solve_sldqp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
void clls_solve_clls_q(void **data, int32_t *status, int32_t n, int32_t o, int32_t m, int32_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 regularization_weight, int32_t A_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *r, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat, _Float128 *w);
void clls_solve_clls_q_64(void **data, int64_t *status, int64_t n, int64_t o, int64_t m, int64_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 regularization_weight, int64_t A_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *r, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat, _Float128 *w);
...
struct dgo_control_type_q {
    ...
    _Float128 infinity;
    _Float128 lipschitz_lower_bound;
    _Float128 lipschitz_reliability;
    _Float128 lipschitz_control;
    _Float128 stop_length;
    _Float128 stop_f;
    _Float128 obj_unbounded;
    _Float128 cpu_time_limit;
...
void dgo_import_q(struct dgo_control_type_q *control, void **data, int32_t *status, int32_t n, _Float128 *x_l, _Float128 *x_u, char *H_type, int32_t ne, int32_t *H_row, int32_t *H_col, int32_t *H_ptr);
void dgo_import_q_64(struct dgo_control_type_q_64 *control, void **data, int64_t *status, int64_t n, _Float128 *x_l, _Float128 *x_u, char *H_type, int64_t ne, int64_t *H_row, int64_t *H_col, int64_t *H_ptr);
...
void dgo_solve_with_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, int32_t ne, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_h_q *eval_h, galahad_hprod_q *eval_hprod, galahad_prec_q *eval_prec);
void dgo_solve_with_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, int64_t ne, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_h_q_64 *eval_h, galahad_hprod_q_64 *eval_hprod, galahad_prec_q_64 *eval_prec);
void dgo_solve_without_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_hprod_q *eval_hprod, galahad_shprod_q *eval_shprod, galahad_prec_q *eval_prec);
void dgo_solve_without_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_hprod_q_64 *eval_hprod, galahad_shprod_q_64 *eval_shprod, galahad_prec_q_64 *eval_prec);
void dgo_solve_reverse_with_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, int32_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void dgo_solve_reverse_with_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, int64_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void dgo_solve_reverse_without_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v, int32_t *index_nz_v, int32_t *nnz_v, int32_t *index_nz_u, int32_t nnz_u);
void dgo_solve_reverse_without_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v, int64_t *index_nz_v, int64_t *nnz_v, int64_t *index_nz_u, int64_t nnz_u);
...
struct dqp_control_type_q {
    ...
    _Float128 stop_cg_relative;
    _Float128 stop_cg_absolute;
    _Float128 cg_zero_curvature;
    _Float128 max_growth;
    _Float128 identical_bounds_tol;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
    _Float128 initial_perturbation;
    _Float128 perturbation_reduction;
    _Float128 final_perturbation;
...
void dqp_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void dqp_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
void dqp_solve_sldqp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void dqp_solve_sldqp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
struct eqp_control_type_q {
    ...
    _Float128 pivot_tol_for_basis;
    _Float128 zero_pivot;
    _Float128 inner_fraction_opt;
    _Float128 radius;
    _Float128 min_diagonal;
    _Float128 max_infeasibility_relative;
    _Float128 max_infeasibility_absolute;
    _Float128 inner_stop_relative;
    _Float128 inner_stop_absolute;
    _Float128 inner_stop_inter;
    bool find_basis_by_transpose;
    bool remove_dependencies;
    bool space_critical;
    bool deallocate_error_fatal;
...
void eqp_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c, _Float128 *x, _Float128 *y);
void eqp_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c, _Float128 *x, _Float128 *y);
void eqp_solve_sldqp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c, _Float128 *x, _Float128 *y);
void eqp_solve_sldqp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c, _Float128 *x, _Float128 *y);
void eqp_resolve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *g, _Float128 f, _Float128 *c, _Float128 *x, _Float128 *y);
void eqp_resolve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *g, _Float128 f, _Float128 *c, _Float128 *x, _Float128 *y);
...
struct lpa_control_type_q {
    ...
    _Float128 feas_tol;
    _Float128 relative_pivot_tolerance;
    _Float128 growth_limit;
    _Float128 zero_tolerance;
    _Float128 change_tolerance;
    _Float128 identical_bounds_tol;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
    bool scale;
...
void lpa_solve_lp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void lpa_solve_lp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
void lpb_solve_lp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void lpb_solve_lp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
struct lsqp_control_type_q {
    ...
    _Float128 potential_unbounded;
    _Float128 pivot_tol;
    _Float128 pivot_tol_for_dependencies;
    _Float128 zero_pivot;
    _Float128 identical_bounds_tol;
    _Float128 mu_min;
    _Float128 indicator_tol_p;
...
void lsqp_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void lsqp_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *w, _Float128 *x0, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
struct nls_subproblem_control_type_q {
    ...
    _Float128 stop_c_absolute;
    _Float128 stop_c_relative;
    _Float128 stop_g_absolute;
    _Float128 stop_g_relative;
    _Float128 stop_s;
    _Float128 power;
    _Float128 initial_weight;
    _Float128 minimum_weight;
    _Float128 initial_inner_weight;
    _Float128 eta_successful;
    _Float128 eta_very_successful;
    _Float128 eta_too_successful;
    _Float128 weight_decrease_min;
...
void nls_import_q(struct nls_control_type_q *control, void **data, int32_t *status, int32_t n, int32_t m, char *J_type, int32_t J_ne, int32_t *J_row, int32_t *J_col, int32_t *J_ptr, char *H_type, int32_t H_ne, int32_t *H_row, int32_t *H_col, int32_t *H_ptr, char *P_type, int32_t P_ne, int32_t *P_row, int32_t *P_col, int32_t *P_ptr, _Float128 *w);
void nls_import_q_64(struct nls_control_type_q_64 *control, void **data, int64_t *status, int64_t n, int64_t m, char *J_type, int64_t J_ne, int64_t *J_row, int64_t *J_col, int64_t *J_ptr, char *H_type, int64_t H_ne, int64_t *H_row, int64_t *H_col, int64_t *H_ptr, char *P_type, int64_t P_ne, int64_t *P_row, int64_t *P_col, int64_t *P_ptr, _Float128 *w);
...
void nls_solve_with_mat_q(void **data, void *userdata, int32_t *status, int32_t n, int32_t m, _Float128 *x, _Float128 *c, _Float128 *g, galahad_r_q *eval_r, int32_t j_ne, galahad_jr_q *eval_jr, int32_t h_ne, galahad_hr_q *eval_hr, int32_t p_ne, galahad_shrprod_q *eval_shrprod);
void nls_solve_with_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, int64_t m, _Float128 *x, _Float128 *c, _Float128 *g, galahad_r_q_64 *eval_r, int64_t j_ne, galahad_jr_q_64 *eval_jr, int64_t h_ne, galahad_hr_q_64 *eval_hr, int64_t p_ne, galahad_shrprod_q_64 *eval_shrprod);
void nls_solve_without_mat_q(void **data, void *userdata, int32_t *status, int32_t n, int32_t m, _Float128 *x, _Float128 *c, _Float128 *g, galahad_r_q *eval_r, galahad_jrprod_q *eval_jrprod, galahad_hrprod_q *eval_hrprod, int32_t p_ne, galahad_shrprod_q *eval_shrprod);
void nls_solve_without_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, int64_t m, _Float128 *x, _Float128 *c, _Float128 *g, galahad_r_q_64 *eval_r, galahad_jrprod_q_64 *eval_jrprod, galahad_hrprod_q_64 *eval_hrprod, int64_t p_ne, galahad_shrprod_q_64 *eval_shrprod);
void nls_solve_reverse_with_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, int32_t m, _Float128 *x, _Float128 *c, _Float128 *g, int32_t j_ne, _Float128 *J_val, _Float128 *y, int32_t h_ne, _Float128 *H_val, _Float128 *v, int32_t p_ne, _Float128 *P_val);
void nls_solve_reverse_with_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, int64_t m, _Float128 *x, _Float128 *c, _Float128 *g, int64_t j_ne, _Float128 *J_val, _Float128 *y, int64_t h_ne, _Float128 *H_val, _Float128 *v, int64_t p_ne, _Float128 *P_val);
void nls_solve_reverse_without_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, int32_t m, _Float128 *x, _Float128 *c, _Float128 *g, bool *transpose, _Float128 *u, _Float128 *v, _Float128 *y, int32_t p_ne, _Float128 *P_val);
void nls_solve_reverse_without_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, int64_t m, _Float128 *x, _Float128 *c, _Float128 *g, bool *transpose, _Float128 *u, _Float128 *v, _Float128 *y, int64_t p_ne, _Float128 *P_val);
...
struct qpa_control_type_q {
    ...
    _Float128 feas_tol;
    _Float128 obj_unbounded;
    _Float128 increase_rho_g_factor;
    _Float128 infeas_g_improved_by_factor;
    _Float128 increase_rho_b_factor;
    _Float128 infeas_b_improved_by_factor;
    _Float128 pivot_tol;
    _Float128 pivot_tol_for_dependencies;
    _Float128 zero_pivot;
    _Float128 inner_stop_relative;
    _Float128 inner_stop_absolute;
    _Float128 multiplier_tol;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
    bool treat_zero_bounds_as_general;
    bool solve_qp;
...
void qpa_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void qpa_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
void qpa_solve_l1qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 rho_g, _Float128 rho_b, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void qpa_solve_l1qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 rho_g, _Float128 rho_b, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
void qpa_solve_bcl1qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 rho_g, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void qpa_solve_bcl1qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, _Float128 rho_g, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
struct qpb_time_type_q {
    ...
    _Float128 factorize;
    _Float128 solve;
    _Float128 phase1_total;
    _Float128 phase1_analyse;
    _Float128 phase1_factorize;
    _Float128 phase1_solve;
    _Float128 clock_total;
    _Float128 clock_preprocess;
    _Float128 clock_find_dependent;
    _Float128 clock_analyse;
    _Float128 clock_factorize;
    _Float128 clock_solve;
    _Float128 clock_phase1_total;
    _Float128 clock_phase1_analyse;
    _Float128 clock_phase1_factorize;
    _Float128 clock_phase1_solve;
};
...
void qpb_solve_qp_q(void **data, int32_t *status, int32_t n, int32_t m, int32_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int32_t *x_stat, int32_t *c_stat);
void qpb_solve_qp_q_64(void **data, int64_t *status, int64_t n, int64_t m, int64_t h_ne, _Float128 *H_val, _Float128 *g, _Float128 f, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y, _Float128 *z, int64_t *x_stat, int64_t *c_stat);
...
void slls_solve_given_a_q(void **data, void *userdata, int32_t *status, int32_t n, int32_t o, int32_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int32_t *x_stat, galahad_constant_prec_q *eval_prec);
void slls_solve_given_a_q_64(void **data, void *userdata, int64_t *status, int64_t n, int64_t o, int64_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int64_t *x_stat, galahad_constant_prec_q_64 *eval_prec);
void slls_solve_reverse_a_prod_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, int32_t o, _Float128 *b, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int32_t *x_stat, _Float128 *v, _Float128 *p, int32_t *nz_v, int32_t *nz_v_start, int32_t *nz_v_end, int32_t *nz_p, int32_t nz_p_end);
void slls_solve_reverse_a_prod_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, int64_t o, _Float128 *b, _Float128 *x, _Float128 *z, _Float128 *r, _Float128 *g, int64_t *x_stat, _Float128 *v, _Float128 *p, int64_t *nz_v, int64_t *nz_v_start, int64_t *nz_v_end, int64_t *nz_p, int64_t nz_p_end);
...
void tru_solve_with_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, int32_t ne, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_h_q *eval_h, galahad_prec_q *eval_prec);
void tru_solve_with_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, int64_t ne, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_h_q_64 *eval_h, galahad_prec_q_64 *eval_prec);
void tru_solve_without_mat_q(void **data, void *userdata, int32_t *status, int32_t n, _Float128 *x, _Float128 *g, galahad_f_q *eval_f, galahad_g_q *eval_g, galahad_hprod_q *eval_hprod, galahad_prec_q *eval_prec);
void tru_solve_without_mat_q_64(void **data, void *userdata, int64_t *status, int64_t n, _Float128 *x, _Float128 *g, galahad_f_q_64 *eval_f, galahad_g_q_64 *eval_g, galahad_hprod_q_64 *eval_hprod, galahad_prec_q_64 *eval_prec);
void tru_solve_reverse_with_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, int32_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void tru_solve_reverse_with_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, int64_t ne, _Float128 *H_val, _Float128 *u, _Float128 *v);
void tru_solve_reverse_without_mat_q(void **data, int32_t *status, int32_t *eval_status, int32_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v);
void tru_solve_reverse_without_mat_q_64(void **data, int64_t *status, int64_t *eval_status, int64_t n, _Float128 *x, _Float128 f, _Float128 *g, _Float128 *u, _Float128 *v);
...
struct wcp_control_type_q {
    ...
    _Float128 dufeas;
    _Float128 mu_target;
    _Float128 mu_accept_fraction;
    _Float128 mu_increase_factor;
    _Float128 required_infeas_reduction;
    _Float128 implicit_tol;
    _Float128 pivot_tol;
    _Float128 pivot_tol_for_dependencies;
    _Float128 zero_pivot;
    _Float128 perturb_start;
    _Float128 alpha_scale;
    _Float128 identical_bounds_tol;
    _Float128 reduce_perturb_factor;
    _Float128 reduce_perturb_multiplier;
    _Float128 insufficiently_feasible;
    _Float128 perturbation_small;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
    bool remove_dependencies;
    bool treat_zero_bounds_as_general;
...
void wcp_find_wcp_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *g, int32_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y_l, _Float128 *y_u, _Float128 *z_l, _Float128 *z_u, int32_t *x_stat, int32_t *c_stat);
void wcp_find_wcp_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *g, int64_t a_ne, _Float128 *A_val, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *c, _Float128 *y_l, _Float128 *y_u, _Float128 *z_l, _Float128 *z_u, int64_t *x_stat, int64_t *c_stat);
...
void llsr_solve_problem_q(void **data, int32_t *status, int32_t m, int32_t n, _Float128 power, _Float128 weight, int32_t A_ne, _Float128 *A_val, _Float128 *b, _Float128 *x, int32_t S_ne, _Float128 *S_val);
void llsr_solve_problem_q_64(void **data, int64_t *status, int64_t m, int64_t n, _Float128 power, _Float128 weight, int64_t A_ne, _Float128 *A_val, _Float128 *b, _Float128 *x, int64_t S_ne, _Float128 *S_val);
...
void llst_solve_problem_q(void **data, int32_t *status, int32_t m, int32_t n, _Float128 radius, int32_t A_ne, _Float128 *A_val, _Float128 *b, _Float128 *x, int32_t S_ne, _Float128 *S_val);
void llst_solve_problem_q_64(void **data, int64_t *status, int64_t m, int64_t n, _Float128 radius, int64_t A_ne, _Float128 *A_val, _Float128 *b, _Float128 *x, int64_t S_ne, _Float128 *S_val);
...
void bllsb_solve_blls_q(void **data, int32_t *status, int32_t n, int32_t o, int32_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 regularization_weight, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *r, _Float128 *z, int32_t *x_stat, _Float128 *w);
void bllsb_solve_blls_q_64(void **data, int64_t *status, int64_t n, int64_t o, int64_t Ao_ne, _Float128 *Ao_val, _Float128 *b, _Float128 regularization_weight, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *r, _Float128 *z, int64_t *x_stat, _Float128 *w);
...
void ssls_factorize_matrix_q(void **data, int32_t *status, int32_t h_ne, _Float128 *H_val, int32_t a_ne, _Float128 *A_val, int32_t c_ne, _Float128 *C_val);
void ssls_factorize_matrix_q_64(void **data, int64_t *status, int64_t h_ne, _Float128 *H_val, int64_t a_ne, _Float128 *A_val, int64_t c_ne, _Float128 *C_val);
void ssls_solve_system_q(void **data, int32_t *status, int32_t n, int32_t m, _Float128 *sol);
void ssls_solve_system_q_64(void **data, int64_t *status, int64_t n, int64_t m, _Float128 *sol);
...
struct expo_control_type_q {
    ...
    _Float128 update_multipliers_tol;
    _Float128 infinity;
    _Float128 stop_abs_p;
    _Float128 stop_rel_p;
    _Float128 stop_abs_d;
    ...
    _Float128 stop_rel_c;
    _Float128 stop_s;
    _Float128 stop_subproblem_rel;
    _Float128 initial_mu;
    _Float128 mu_reduce;
    _Float128 obj_unbounded;
    _Float128 try_advanced_start;
    _Float128 try_sqp_start;
    _Float128 stop_advanced_start;
    _Float128 cpu_time_limit;
    _Float128 clock_time_limit;
    bool hessian_available;
    bool subproblem_direct;
...
void expo_solve_hessian_direct_q(void **data, void *userdata, int32_t *status, int32_t n, int32_t m, int32_t J_ne, int32_t H_ne, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *y, _Float128 *z, _Float128 *c, _Float128 *gl, galahad_fc_q *eval_fc, galahad_gj_q *eval_gj, galahad_hl_q *eval_hl);
void expo_solve_hessian_direct_q_64(void **data, void *userdata, int64_t *status, int64_t n, int64_t m, int64_t J_ne, int64_t H_ne, _Float128 *c_l, _Float128 *c_u, _Float128 *x_l, _Float128 *x_u, _Float128 *x, _Float128 *y, _Float128 *z, _Float128 *c, _Float128 *gl, galahad_fc_q_64 *eval_fc, galahad_gj_q_64 *eval_gj, galahad_hl_q_64 *eval_hl);
...
void nrek_solve_problem_q(void **data, int32_t *status, int32_t n, int32_t H_ne, _Float128 *H_val, _Float128 *c, _Float128 power, _Float128 weight, _Float128 *x, int32_t S_ne, _Float128 *S_val);
void nrek_solve_problem_q_64(void **data, int64_t *status, int64_t n, int64_t H_ne, _Float128 *H_val, _Float128 *c, _Float128 power, _Float128 weight, _Float128 *x, int64_t S_ne, _Float128 *S_val);
...
void trek_solve_problem_q(void **data, int32_t *status, int32_t n, int32_t H_ne, _Float128 *H_val, _Float128 *c, _Float128 radius, _Float128 *x, int32_t S_ne, _Float128 *S_val);
void trek_solve_problem_q_64(void **data, int64_t *status, int64_t n, int64_t H_ne, _Float128 *H_val, _Float128 *c, _Float128 radius, _Float128 *x, int64_t S_ne, _Float128 *S_val);
